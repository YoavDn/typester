...
.contract-trigger:before {
  width: 200%;
  height: 200%;
}`,l?r.prepend(e.css):o.head.appendChild(e.css))}var d=e.create(e.w.config.series,{});if(!d)return t(e);e.mount(d).then(function(){typeof e.w.config.chart.events.mounted=="function"&&e.w.config.chart.events.mounted(e,e.w),e.events.fireEvent("mounted",[e,e.w]),t(d)}).catch(function(p){i(p)})}else i(new Error("Element not found"))})}},{key:"create",value:function(e,t){var i=this.w;new So(this).initModules();var a=this.w.globals;if(a.noData=!1,a.animationEnded=!1,this.responsive.checkResponsiveConfig(t),i.config.xaxis.convertedCatToNumeric&&new ht(i.config).convertCatToNumericXaxis(i.config,this.ctx),this.el===null||(this.core.setupElements(),i.config.chart.type==="treemap"&&(i.config.grid.show=!1,i.config.yaxis[0].show=!1),a.svgWidth===0))return a.animationEnded=!0,null;var r=ce.checkComboSeries(e);a.comboCharts=r.comboCharts,a.comboBarCount=r.comboBarCount;var l=e.every(function(x){return x.data&&x.data.length===0});(e.length===0||l)&&this.series.handleNoData(),this.events.setupEventHandlers(),this.data.parseData(e),this.theme.init(),new Be(this).setGlobalMarkerSize(),this.formatters.setLabelFormatters(),this.titleSubtitle.draw(),a.noData&&a.collapsedSeries.length!==a.series.length&&!i.config.legend.showForSingleSeries||this.legend.init(),this.series.hasAllSeriesEqualX(),a.axisCharts&&(this.core.coreCalculations(),i.config.xaxis.type!=="category"&&this.formatters.setLabelFormatters(),this.ctx.toolbar.minX=i.globals.minX,this.ctx.toolbar.maxX=i.globals.maxX),this.formatters.heatmapLabelFormatters(),new ce(this).getLargestMarkerSize(),this.dimensions.plotCoords();var o=this.core.xySettings();this.grid.createGridMask();var h=this.core.plotChartType(e,o),d=new Te(this);d.bringForward(),i.config.dataLabels.background.enabled&&d.dataLabelsBackground(),this.core.shiftGraphPosition();var p={plot:{left:i.globals.translateX,top:i.globals.translateY,width:i.globals.gridWidth,height:i.globals.gridHeight}};return{elGraph:h,xyRatios:o,elInner:i.globals.dom.elGraphical,dimensions:p}}},{key:"mount",value:function(){var e=this,t=arguments.length>0&&arguments[0]!==void 0?arguments[0]:null,i=this,a=i.w;return new Promise(function(r,l){if(i.el===null)return l(new Error("Not enough data to display or target element not found"));(t===null||a.globals.allSeriesCollapsed)&&i.series.handleNoData(),a.config.chart.type!=="treemap"&&i.axes.drawAxis(a.config.chart.type,t.xyRatios),i.grid=new D(i);var o=i.grid.drawGrid();i.annotations=new ye(i),i.annotations.drawImageAnnos(),i.annotations.drawTextAnnos(),a.config.grid.position==="back"&&o&&a.globals.dom.elGraphical.add(o.el);var h=new Ee(e.ctx),d=new ae(e.ctx);if(o!==null&&(h.xAxisLabelCorrections(o.xAxisTickWidth),d.setYAxisTextAlignments(),a.config.yaxis.map(function(b,y){a.globals.ignoreYAxisIndexes.indexOf(y)===-1&&d.yAxisTitleRotate(y,b.opposite)})),a.config.annotations.position==="back"&&(a.globals.dom.Paper.add(a.globals.dom.elAnnotations),i.annotations.drawAxesAnnotations()),Array.isArray(t.elGraph))for(var p=0;p<t.elGraph.length;p++)a.globals.dom.elGraphical.add(t.elGraph[p]);else a.globals.dom.elGraphical.add(t.elGraph);if(a.config.grid.position==="front"&&o&&a.globals.dom.elGraphical.add(o.el),a.config.xaxis.crosshairs.position==="front"&&i.crosshairs.drawXCrosshairs(),a.config.yaxis[0].crosshairs.position==="front"&&i.crosshairs.drawYCrosshairs(),a.config.annotations.position==="front"&&(a.globals.dom.Paper.add(a.globals.dom.elAnnotations),i.annotations.drawAxesAnnotations()),!a.globals.noData){if(a.config.tooltip.enabled&&!a.globals.noData&&i.w.globals.tooltip.drawTooltip(t.xyRatios),a.globals.axisCharts&&(a.globals.isXNumeric||a.config.xaxis.convertedCatToNumeric||a.globals.isRangeBar))(a.config.chart.zoom.enabled||a.config.chart.selection&&a.config.chart.selection.enabled||a.config.chart.pan&&a.config.chart.pan.enabled)&&i.zoomPanSelection.init({xyRatios:t.xyRatios});else{var x=a.config.chart.toolbar.tools;["zoom","zoomin","zoomout","selection","pan","reset"].forEach(function(b){x[b]=!1})}a.config.chart.toolbar.show&&!a.globals.allSeriesCollapsed&&i.toolbar.createToolbar()}a.globals.memory.methodsToExec.length>0&&a.globals.memory.methodsToExec.forEach(function(b){b.method(b.params,!1,b.context)}),a.globals.axisCharts||a.globals.noData||i.core.resizeNonAxisCharts(),r(i)})}},{key:"destroy",value:function(){var e,t;window.removeEventListener("resize",this.windowResizeHandler),this.el.parentNode,e=this.parentResizeHandler,(t=Pr.get(e))&&(t.disconnect(),Pr.delete(e));var i=this.w.config.chart.id;i&&Apex._chartInstances.forEach(function(a,r){a.id===T.escapeString(i)&&Apex._chartInstances.splice(r,1)}),new Co(this.ctx).clear({isUpdating:!1})}},{key:"updateOptions",value:function(e){var t=this,i=arguments.length>1&&arguments[1]!==void 0&&arguments[1],a=!(arguments.length>2&&arguments[2]!==void 0)||arguments[2],r=!(arguments.length>3&&arguments[3]!==void 0)||arguments[3],l=!(arguments.length>4&&arguments[4]!==void 0)||arguments[4],o=this.w;return o.globals.selection=void 0,e.series&&(this.series.resetSeries(!1,!0,!1),e.series.length&&e.series[0].data&&(e.series=e.series.map(function(h,d){return t.updateHelpers._extendSeries(h,d)})),this.updateHelpers.revertDefaultAxisMinMax()),e.xaxis&&(e=this.updateHelpers.forceXAxisUpdate(e)),e.yaxis&&(e=this.updateHelpers.forceYAxisUpdate(e)),o.globals.collapsedSeriesIndices.length>0&&this.series.clearPreviousPaths(),e.theme&&(e=this.theme.updateThemeOptions(e)),this.updateHelpers._updateOptions(e,i,a,r,l)}},{key:"updateSeries",value:function(){var e=arguments.length>0&&arguments[0]!==void 0?arguments[0]:[],t=!(arguments.length>1&&arguments[1]!==void 0)||arguments[1],i=!(arguments.length>2&&arguments[2]!==void 0)||arguments[2];return this.series.resetSeries(!1),this.updateHelpers.revertDefaultAxisMinMax(),this.updateHelpers._updateSeries(e,t,i)}},{key:"appendSeries",value:function(e){var t=!(arguments.length>1&&arguments[1]!==void 0)||arguments[1],i=!(arguments.length>2&&arguments[2]!==void 0)||arguments[2],a=this.w.config.series.slice();return a.push(e),this.series.resetSeries(!1),this.updateHelpers.revertDefaultAxisMinMax(),this.updateHelpers._updateSeries(a,t,i)}},{key:"appendData",value:function(e){var t=!(arguments.length>1&&arguments[1]!==void 0)||arguments[1],i=this;i.w.globals.dataChanged=!0,i.series.getPreviousPaths();for(var a=i.w.config.series.slice(),r=0;r<a.length;r++)if(e[r]!==null&&e[r]!==void 0)for(var l=0;l<e[r].data.length;l++)a[r].data.push(e[r].data[l]);return i.w.config.series=a,t&&(i.w.globals.initialSeries=T.clone(i.w.config.series)),this.update()}},{key:"update",value:function(e){var t=this;return new Promise(function(i,a){new Co(t.ctx).clear({isUpdating:!0});var r=t.create(t.w.config.series,e);if(!r)return i(t);t.mount(r).then(function(){typeof t.w.config.chart.events.updated=="function"&&t.w.config.chart.events.updated(t,t.w),t.events.fireEvent("updated",[t,t.w]),t.w.globals.isDirty=!0,i(t)}).catch(function(l){a(l)})})}},{key:"getSyncedCharts",value:function(){var e=this.getGroupedCharts(),t=[this];return e.length&&(t=[],e.forEach(function(i){t.push(i)})),t}},{key:"getGroupedCharts",value:function(){var e=this;return Apex._chartInstances.filter(function(t){if(t.group)return!0}).map(function(t){return e.w.config.chart.group===t.group?t.chart:e})}},{key:"toggleSeries",value:function(e){return this.series.toggleSeries(e)}},{key:"highlightSeriesOnLegendHover",value:function(e,t){return this.series.toggleSeriesOnHover(e,t)}},{key:"showSeries",value:function(e){this.series.showSeries(e)}},{key:"hideSeries",value:function(e){this.series.hideSeries(e)}},{key:"resetSeries",value:function(){var e=!(arguments.length>0&&arguments[0]!==void 0)||arguments[0],t=!(arguments.length>1&&arguments[1]!==void 0)||arguments[1];this.series.resetSeries(e,t)}},{key:"addEventListener",value:function(e,t){this.events.addEventListener(e,t)}},{key:"removeEventListener",value:function(e,t){this.events.removeEventListener(e,t)}},{key:"addXaxisAnnotation",value:function(e){var t=!(arguments.length>1&&arguments[1]!==void 0)||arguments[1],i=arguments.length>2&&arguments[2]!==void 0?arguments[2]:void 0,a=this;i&&(a=i),a.annotations.addXaxisAnnotationExternal(e,t,a)}},{key:"addYaxisAnnotation",value:function(e){var t=!(arguments.length>1&&arguments[1]!==void 0)||arguments[1],i=arguments.length>2&&arguments[2]!==void 0?arguments[2]:void 0,a=this;i&&(a=i),a.annotations.addYaxisAnnotationExternal(e,t,a)}},{key:"addPointAnnotation",value:function(e){var t=!(arguments.length>1&&arguments[1]!==void 0)||arguments[1],i=arguments.length>2&&arguments[2]!==void 0?arguments[2]:void 0,a=this;i&&(a=i),a.annotations.addPointAnnotationExternal(e,t,a)}},{key:"clearAnnotations",value:function(){var e=arguments.length>0&&arguments[0]!==void 0?arguments[0]:void 0,t=this;e&&(t=e),t.annotations.clearAnnotations(t)}},{key:"removeAnnotation",value:function(e){var t=arguments.length>1&&arguments[1]!==void 0?arguments[1]:void 0,i=this;t&&(i=t),i.annotations.removeAnnotation(i,e)}},{key:"getChartArea",value:function(){return this.w.globals.dom.baseEl.querySelector(".apexcharts-inner")}},{key:"getSeriesTotalXRange",value:function(e,t){return this.coreUtils.getSeriesTotalsXRange(e,t)}},{key:"getHighestValueInSeries",value:function(){var e=arguments.length>0&&arguments[0]!==void 0?arguments[0]:0,t=new $(this.ctx);return t.getMinYMaxY(e).highestY}},{key:"getLowestValueInSeries",value:function(){var e=arguments.length>0&&arguments[0]!==void 0?arguments[0]:0,t=new $(this.ctx);return t.getMinYMaxY(e).lowestY}},{key:"getSeriesTotal",value:function(){return this.w.globals.seriesTotals}},{key:"toggleDataPointSelection",value:function(e,t){return this.updateHelpers.toggleDataPointSelection(e,t)}},{key:"zoomX",value:function(e,t){this.ctx.toolbar.zoomUpdateOptions(e,t)}},{key:"setLocale",value:function(e){this.localization.setCurrentLocaleValues(e)}},{key:"dataURI",value:function(e){return new Pe(this.ctx).dataURI(e)}},{key:"exportToCSV",value:function(){var e=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{},t=new Pe(this.ctx);return t.exportToCSV(e)}},{key:"paper",value:function(){return this.w.globals.dom.Paper}},{key:"_parentResizeCallback",value:function(){this.w.globals.animationEnded&&this.w.config.chart.redrawOnParentResize&&this._windowResize()}},{key:"_windowResize",value:function(){var e=this;clearTimeout(this.w.globals.resizeTimer),this.w.globals.resizeTimer=window.setTimeout(function(){e.w.globals.resized=!0,e.w.globals.dataChanged=!1,e.ctx.update()},150)}},{key:"_windowResizeHandler",value:function(){var e=this.w.config.chart.redrawOnWindowResize;typeof e=="function"&&(e=e()),e&&this._windowResize()}}],[{key:"getChartByID",value:function(e){var t=T.escapeString(e),i=Apex._chartInstances.filter(function(a){return a.id===t})[0];return i&&i.chart}},{key:"initOnLoad",value:function(){for(var e=document.querySelectorAll("[data-apexcharts]"),t=0;t<e.length;t++)new L(e[t],JSON.parse(e[t].getAttribute("data-options"))).render()}},{key:"exec",value:function(e,t){var i=this.getChartByID(e);if(i){i.w.globals.isExecCalled=!0;var a=null;if(i.publicMethods.indexOf(t)!==-1){for(var r=arguments.length,l=new Array(r>2?r-2:0),o=2;o<r;o++)l[o-2]=arguments[o];a=i[t].apply(i,l)}return a}}},{key:"merge",value:function(e,t){return T.extend(e,t)}}]),L}();s.exports=Vu}(Ea,Ea.exports)),Ea.exports}(function(s){s.exports=function(n){var c={};function u(g){if(c[g])return c[g].exports;var m=c[g]={i:g,l:!1,exports:{}};return n[g].call(m.exports,m,m.exports,u),m.l=!0,m.exports}return u.m=n,u.c=c,u.d=function(g,m,w){u.o(g,m)||Object.defineProperty(g,m,{enumerable:!0,get:w})},u.r=function(g){typeof Symbol<"u"&&Symbol.toStringTag&&Object.defineProperty(g,Symbol.toStringTag,{value:"Module"}),Object.defineProperty(g,"__esModule",{value:!0})},u.t=function(g,m){if(m&1&&(g=u(g)),m&8||m&4&&typeof g=="object"&&g&&g.__esModule)return g;var w=Object.create(null);if(u.r(w),Object.defineProperty(w,"default",{enumerable:!0,value:g}),m&2&&typeof g!="string")for(var k in g)u.d(w,k,function(P){return g[P]}.bind(null,k));return w},u.n=function(g){var m=g&&g.__esModule?function(){return g.default}:function(){return g};return u.d(m,"a",m),m},u.o=function(g,m){return Object.prototype.hasOwnProperty.call(g,m)},u.p="",u(u.s="fb15")}({8875:function(n,c,u){var g,m,w;(function(k,P){m=[],g=P,w=typeof g=="function"?g.apply(c,m):g,w!==void 0&&(n.exports=w)})(typeof self<"u"?self:this,function(){function k(){var P=Object.getOwnPropertyDescriptor(document,"currentScript");if(!P&&"currentScript"in document&&document.currentScript||P&&P.get!==k&&document.currentScript)return document.currentScript;try{throw new Error}catch(Z){var I=/.*at [^(]*\((.*):(.+):(.+)\)$/ig,O=/@([^@]*):(\d+):(\d+)\s*$/ig,N=I.exec(Z.stack)||O.exec(Z.stack),z=N&&N[1]||!1,W=N&&N[2]||!1,q=document.location.href.replace(document.location.hash,""),K,J,V,T=document.getElementsByTagName("script");z===q&&(K=document.documentElement.outerHTML,J=new RegExp("(?:[^\\n]+?\\n){0,"+(W-2)+"}[^<]*<script>([\\d\\D]*?)<\\/script>[\\d\\D]*","i"),V=K.replace(J,"$1").trim());for(var G=0;G<T.length;G++)if(T[G].readyState==="interactive"||T[G].src===z||z===q&&T[G].innerHTML&&T[G].innerHTML.trim()===V)return T[G];return null}}return k})},"8bbf":function(n,c){n.exports=Xp},"95e6":function(n,c){n.exports=Hp()},fb15:function(n,c,u){if(u.r(c),typeof window<"u"){var g=window.document.currentScript;{var m=u("8875");g=m(),"currentScript"in document||Object.defineProperty(document,"currentScript",{get:m})}var w=g&&g.src.match(/(.+\/)[^/]+\.js(\?.*)?$/);w&&(u.p=w[1])}var k=u("8bbf"),P=u("95e6"),I=u.n(P);const O=["animationEnd","beforeMount","mounted","updated","click","mouseMove","legendClick","markerClick","selection","dataPointSelection","dataPointMouseEnter","dataPointMouseLeave","beforeZoom","beforeResetZoom","zoomed","scrolled","scrolled"];var z=Object(k.defineComponent)({name:"apexchart",props:{options:{type:Object},type:{type:String},series:{type:Array,required:!0},width:{default:"100%"},height:{default:"auto"}},emits:O,setup(K,{emit:J}){const V=Object(k.ref)(null),T=Object(k.ref)(null),G=U=>U&&typeof U=="object"&&!Array.isArray(U)&&U!=null,Z=(U,ue)=>{typeof Object.assign!="function"&&function(){Object.assign=function(be){if(be==null)throw new TypeError("Cannot convert undefined or null to object");let Oe=Object(be);for(let Re=1;Re<arguments.length;Re++){let Pe=arguments[Re];if(Pe!=null)for(let Ee in Pe)Pe.hasOwnProperty(Ee)&&(Oe[Ee]=Pe[Ee])}return Oe}}();let de=Object.assign({},U);return G(U)&&G(ue)&&Object.keys(ue).forEach(be=>{G(ue[be])?be in U?de[be]=Z(U[be],ue[be]):Object.assign(de,{[be]:ue[be]}):Object.assign(de,{[be]:ue[be]})}),de},H=async()=>{await Object(k.nextTick)();const U={chart:{type:K.type||K.options.chart.type||"line",height:K.height,width:K.width,events:{}},series:K.series};O.forEach(de=>{let be=(...Oe)=>J(de,...Oe);U.chart.events[de]=be});const ue=Z(K.options,U);return T.value=new I.a(V.value,ue),T.value.render()},ce=()=>(Q(),H()),Q=()=>{T.value.destroy()},ie=(U,ue)=>T.value.updateSeries(U,ue),ne=(U,ue,de,be)=>T.value.updateOptions(U,ue,de,be),ee=U=>T.value.toggleSeries(U),le=U=>{T.value.showSeries(U)},se=U=>{T.value.hideSeries(U)},ye=(U,ue)=>T.value.appendSeries(U,ue),ge=()=>{T.value.resetSeries()},Be=(U,ue)=>{T.value.toggleDataPointSelection(U,ue)},Le=U=>T.value.appendData(U),Te=(U,ue)=>T.value.zoomX(U,ue),He=()=>T.value.dataURI(),Ge=(U,ue)=>{T.value.addXaxisAnnotation(U,ue)},Gt=(U,ue)=>{T.value.addYaxisAnnotation(U,ue)},rt=(U,ue)=>{T.value.addPointAnnotation(U,ue)},We=(U,ue)=>{T.value.removeAnnotation(U,ue)},nt=()=>{T.value.clearAnnotations()};Object(k.onBeforeMount)(()=>{window.ApexCharts=I.a}),Object(k.onMounted)(()=>{V.value=Object(k.getCurrentInstance)().proxy.$el,H()}),Object(k.onBeforeUnmount)(()=>{!T.value||Q()});const ht=Object(k.toRefs)(K);return Object(k.watch)(ht.options,()=>{!T.value&&K.options?H():T.value.updateOptions(K.options)}),Object(k.watch)(ht.series,()=>{!T.value&&K.series?H():T.value.updateSeries(K.series)},{deep:!0}),Object(k.watch)(ht.type,()=>{ce()}),Object(k.watch)(ht.width,()=>{ce()}),Object(k.watch)(ht.height,()=>{ce()}),{chart:T,init:H,refresh:ce,destroy:Q,updateOptions:ne,updateSeries:ie,toggleSeries:ee,showSeries:le,hideSeries:se,resetSeries:ge,zoomX:Te,toggleDataPointSelection:Be,appendData:Le,appendSeries:ye,addXaxisAnnotation:Ge,addYaxisAnnotation:Gt,addPointAnnotation:rt,removeAnnotation:We,clearAnnotations:nt,dataURI:He}},render(){return Object(k.h)("div",{class:"vue-apexcharts"})}});const W=K=>{K.component(z.name,z)};z.install=W;var q=z;c.default=q}})})(tu);const Yp=eu(tu.exports),Bp={width:"249",height:"53",fill:"none",xmlns:"http://www.w3.org/2000/svg"},Wp=fr('<path d="M90.278 16.382v-4.564h21.503v4.564h-8.015V38h-5.472V16.382h-8.016Zm25.694 28.982c-.69 0-1.338-.056-1.943-.167-.596-.102-1.091-.234-1.483-.396l1.228-4.065c.639.196 1.214.302 1.725.32.52.016.968-.103 1.343-.359.383-.255.694-.69.933-1.303l.32-.831-7.044-20.2h5.727l4.065 14.421h.205l4.103-14.42h5.766l-7.632 21.758c-.367 1.057-.865 1.977-1.496 2.761a6.126 6.126 0 0 1-2.365 1.829c-.954.434-2.105.652-3.452.652Zm17.372 0v-27h5.369v3.298h.243a7.21 7.21 0 0 1 1.036-1.61c.46-.555 1.056-1.015 1.789-1.381.742-.375 1.662-.563 2.762-.563a7.38 7.38 0 0 1 3.963 1.125c1.21.741 2.177 1.862 2.902 3.362.724 1.492 1.086 3.362 1.086 5.612 0 2.19-.353 4.04-1.061 5.549-.698 1.5-1.653 2.638-2.863 3.413-1.202.767-2.549 1.15-4.04 1.15-1.057 0-1.956-.174-2.697-.524-.733-.349-1.334-.788-1.803-1.316a6.674 6.674 0 0 1-1.074-1.624h-.166v10.509h-5.446Zm5.331-17.182c0 1.167.162 2.186.486 3.055.324.87.792 1.547 1.406 2.033.614.477 1.359.716 2.237.716.887 0 1.637-.243 2.25-.729.614-.494 1.078-1.176 1.394-2.045.323-.878.485-1.
337-8.728.761a.89.89 0 0 1-1.21 0c-3.352-3.098-5.724-2.067-8.728-.761-1.72.747-3.579 1.555-5.72 1.555a8.541 8.541 0 0 1-2.396-.345Z"></path><rect x="22" y="15" width="6" height="2" rx="1"></rect><rect x="30" y="15" width="6" height="2" rx="1"></rect><rect x="46" y="15" width="6" height="2" rx="1"></rect><rect x="54" y="15" width="6" height="2" rx="1"></rect><rect x="38" y="15" width="6" height="2" rx="1"></rect><rect x="26" y="33" width="6" height="2" rx="1"></rect><rect x="42" y="33" width="6" height="2" rx="1"></rect><rect x="50" y="33" width="6" height="2" rx="1"></rect><rect x="34" y="33" width="6" height="2" rx="1"></rect><rect x="22" y="37" width="38" height="2" rx="1"></rect></g><rect x="18" y="33" width="6" height="2" rx="1" fill="#fff"></rect><rect x="6" y="33" width="8" height="2" rx="1" fill="#fff"></rect><rect x="6" y="27" width="6" height="2" rx="1" fill="#fff"></rect><rect x="14" y="27" width="6" height="2" rx="1" fill="#fff"></rect><rect x="6" y="37" width="4" height="2" rx="1" fill="#fff"></rect><rect x="12" y="37" width="4" height="2" rx="1" fill="#fff"></rect><rect x="18" y="37" width="2" height="2" rx="1" fill="#fff"></rect><rect x="62" y="37" width="6" height="2" rx="1" fill="#fff"></rect><rect x="70" y="37" width="4" height="2" rx="1" fill="#fff"></rect><rect x="6" y="19" width="10" height="2" rx="1" fill="#fff"></rect><rect x="6" y="23" width="8" height="2" rx="1" fill="#fff"></rect><rect x="62" y="15" width="6" height="2" rx="1" fill="#fff"></rect><rect x="70" y="15" width="6" height="2" rx="1" fill="#fff"></rect><rect x=".5" y="9.5" width="79" height="33" rx="3.5" stroke="#fff"></rect><rect x="6" y="15" width="14" height="2" rx="1" fill="#fff"></rect><rect x="62" y="19" width="14" height="2" rx="1" fill="#fff"></rect><rect x="66" y="23" width="10" height="2" rx="1" fill="#fff"></rect><rect x="68" y="27" width="8" height="2" rx="1" fill="#fff"></rect><rect x="66" y="33" width="10" height="2" rx="1" fill="#fff"></rect><rect x="62" y="27" width="4" height="2" rx="1" fill="#fff"></rect><rect x="60" y="33" width="4" height="2" rx="1" fill="#fff"></rect><defs><clipPath id="a"><path fill="#fff" transform="translate(20 5)" d="M0 0h40v40H0z"></path></clipPath></defs>',25),Vp=[Wp];function jp(s,n){return Je(),ct("svg",Bp,Vp)}const Gp={render:jp},Up={width:"249",height:"53",fill:"none",xmlns:"http://www.w3.org/2000/svg"},$p=fr('<path d="M90.278 16.382v-4.564h21.503v4.564h-8.015V38h-5.472V16.382h-8.016Zm25.694 28.982c-.69 0-1.338-.056-1.943-.167-.596-.102-1.091-.234-1.483-.396l1.228-4.065c.639.196 1.214.302 1.725.32.52.016.968-.103 1.343-.359.383-.255.694-.69.933-1.303l.32-.831-7.044-20.2h5.727l4.065 14.421h.205l4.103-14.42h5.766l-7.632 21.758c-.367 1.057-.865 1.977-1.496 2.761a6.126 6.126 0 0 1-2.365 1.829c-.954.434-2.105.652-3.452.652Zm17.372 0v-27h5.369v3.298h.243a7.21 7
674 3.158-1.372 4.9-1.416 1.776-.047 3.465.602 5.143 1.977 1.678-1.375 3.368-2.024 5.142-1.977 1.743.044 3.348.742 4.901 1.417 2.681 1.165 5.213 2.265 8.642.41a.89.89 0 0 1 1.299.951c-.308 1.596-1.48 3.394-3.217 4.935-1.803 1.6-4.02 2.766-6.242 3.285-4.032.942-7.73-.261-10.525-3.393-2.174 2.436-4.896 3.706-7.895 3.706Zm-9.554-7.05c1.332 2.074 4.11 4.25 7.33 5.002 2.586.605 6.319.471 9.41-3.598a.89.89 0 0 1 1.418 0c3.09 4.07 6.823 4.203 9.41 3.599 3.219-.753 5.998-2.929 7.33-5.003-3.198.927-5.786-.198-8.116-1.21-3.004-1.306-5.376-2.337-8.728.761a.89.89 0 0 1-1.21 0c-3.352-3.098-5.724-2.067-8.728-.761-1.72.747-3.579 1.555-5.72 1.555a8.541 8.541 0 0 1-2.396-.345Z"></path><rect x="22" y="15" width="6" height="2" rx="1"></rect><rect x="30" y="15" width="6" height="2" rx="1"></rect><rect x="46" y="15" width="6" height="2" rx="1"></rect><rect x="54" y="15" width="6" height="2" rx="1"></rect><rect x="38" y="15" width="6" height="2" rx="1"></rect><rect x="26" y="33" width="6" height="2" rx="1"></rect><rect x="42" y="33" width="6" height="2" rx="1"></rect><rect x="50" y="33" width="6" height="2" rx="1"></rect><rect x="34" y="33" width="6" height="2" rx="1"></rect><rect x="22" y="37" width="38" height="2" rx="1"></rect></g><rect x="18" y="33" width="6" height="2" rx="1" fill="#000"></rect><rect x="6" y="33" width="8" height="2" rx="1" fill="#000"></rect><rect x="6" y="27" width="6" height="2" rx="1" fill="#000"></rect><rect x="14" y="27" width="6" height="2" rx="1" fill="#000"></rect><rect x="6" y="37" width="4" height="2" rx="1" fill="#000"></rect><rect x="12" y="37" width="4" height="2" rx="1" fill="#000"></rect><rect x="18" y="37" width="2" height="2" rx="1" fill="#000"></rect><rect x="62" y="37" width="6" height="2" rx="1" fill="#000"></rect><rect x="70" y="37" width="4" height="2" rx="1" fill="#000"></rect><rect x="6" y="19" width="10" height="2" rx="1" fill="#000"></rect><rect x="6" y="23" width="8" height="2" rx="1" fill="#000"></rect><rect x="62" y="15" width="6" height="2" rx="1" fill="#000"></rect><rect x="70" y="15" width="6" height="2" rx="1" fill="#000"></rect><rect x=".5" y="9.5" width="79" height="33" rx="3.5" stroke="#000"></rect><rect x="6" y="15" width="14" height="2" rx="1" fill="#000"></rect><rect x="62" y="19" width="14" height="2" rx="1" fill="#000"></rect><rect x="66" y="23" width="10" height="2" rx="1" fill="#000"></rect><rect x="68" y="27" width="8" height="2" rx="1" fill="#000"></rect><rect x="66" y="33" width="10" height="2" rx="1" fill="#000"></rect><rect x="62" y="27" width="4" height="2" rx="1" fill="#000"></rect><rect x="60" y="33" width="4" height="2" rx="1" fill="#000"></rect><defs><clipPath id="a"><path fill="#fff" transform="translate(20 5)" d="M0 0h40v40H0z"></path></clipPath></defs>',25),qp=[$p];function Zp(s,n){return Je(),ct("svg",Up,qp)}const Kp={render:Zp};function Jp(s,n){return Je(),ct("svg",{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 24 24",fill:"currentColor","aria-hidden":"true"},[qe("path",{"fill-rule":"evenodd",d:"M7.5 3.75A1.5 1.5 0 006 5.25v13.5a1.5 1.5 0 001.5 1.5h6a1.5 1.5 0 001.5-1.5V15a.75.75 0 011.5 0v3.75a3 3 0 01-3 3h-6a3 3 0 01-3-3V5.25a3 3 0 013-3h6a3 3 0 013 3V9A.75.75 0 0115 9V5.25a1.5 1.5 0 00-1.5-1.5h-6zm10.72 4.72a.75.75 0 011.06 0l3 3a.75.75 0 010 1.06l-3 3a.75.75 0 11-1.06-1.06l1.72-1.72H9a.75.75 0 010-1.5h10.94l-1.72-1.72a.75.75 0 010-1.06z","clip-rule":"evenodd"})])}const Qp={xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 455 455",style:{"enable-background":"new 0 0 455 455"},"xml:space":"preserve"},ex=qe("path",{d:"m227.495 150-93.749 50-88.279-50 38.8 180h286.466l38.8-180-88.286 50zM87.5 360h280v55h-280z"},null,-1),tx=qe("circle",{cx:"40",cy:"80",r:"40"},null,-1),ix=qe("circle",{cx:"415",cy:"80",r:"40"},null,-1),sx=qe("circle",{cx:"227.5",cy:"80",r:"40"},null,-1),ax=[ex,tx,ix,sx];function rx(s,n){return Je(),ct("svg",Qp,ax)}const nx={render:rx},ox={xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 285.5 285.5",style:{"enable-background":"new 0 0 285.5 285.5"},"xml:space":"preserve"},lx=qe("path",{d:"M79.999 62.75c0 34.601 28.149 62.75 62.751 62.75s62.751-28.149 62.751-62.75S177.352 0 142.75 0 79.999 28.149 79.999 62.75zM42.75 285.5h200c8.284 0 15-6.716 15-15 0-63.411-51.589-115-115-115s-115 51.589-115 115c0 8.284 6.716 15 15 15z"},null,-1),cx=[lx];function hx(s,n){return Je(),ct("svg",ox,cx)}const ux={render:hx},dx={xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 489.802 489.802",style:{"enable-background":"new 0 0 489.802 489.802"},"xml:space":"preserve"},fx=qe("path",{d:"m20.701 281.901 32.1.2c4.8 24.7 14.3 48.7 28.7 70.5l-22.8 22.6c-8.2 8.1-8.2 21.2-.2 29.4l24.6 24.9c8.1 8.2 21.2 8.2 29.4.2l22.8-22.6c21.6 14.6 45.5 24.5 70.2 29.5l-.2 32.1c-.1 11.5 9.2 20.8 20.7 20.9l35 .2c11.5.1 20.8-9.2 20.9-20.7l.2-32.1c24.7-4.8 48.7-14.3 70.5-28.7l22.6 22.8c8.1 8.2 21.2 8.2 29.4.2l24.9-24.6c8.2-8.1 8.2-21.2.2-29.4l-22.6-22.8c14.6-21.6 24.5-45.5 29.5-70.2l32.1.2c11.5.1 20.8-9.2 20.9-20.7l.2-35c.1-11.5-9.2-20.8-20.7-20.9l-32.1-.2c-4.8-24.7-14.3-48.7-28.7-70.5l22.8-22.6c8.2-8.1 8.2-21.2.2-29.4l-24.6-24.9c-8.1-8.2-21.2-8.2-29.4-.2l-22.8 22.6c-21.6-14.6-45.5-24.5-70.2-29.5l.2-32.1c.1-11.5-9.2-20.8-20.7-20.9l-35-.2c-11.5-.1-20.8 9.2-20.9 20.7l-.3 32.1c-24.8 4.8-48.8 14.3-70.5 28.7l-22.6-22.8c-8.1-8.2-21.2-8.2-29.4-.2l-24.8 24.6c-8.2 8.1-8.2 21.2-.2 29.4l22.6 22.8c-14.6 21.6-24.5 45.5-29.5 70.2l-32.1-.2c-11.5-.1-20.8 9.2-20.9 20.7l-.2 35c-.1 11.4 9.2 20.8 20.7 20.9zm158.6-103.3c36.6-36.2 95.5-35.9 131.7.7s35.9 95.5-.7 131.7-95.5 35.9-131.7-.7-35.9-95.5.7-131.7z"},null,-1),gx=[fx];function px(s,n){return Je(),ct("svg",dx,gx)}const xx={render:px},mx={xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 463 463",style:{"enable-background":"new 0 0 463 463"},"xml:space":"preserve"},bx=qe("path",{d:"M431.5 120h-400C14.131 120 0 134.131 0 151.5v160C0 328.869 14.131 343 31.5 343h400c17.369 0 31.5-14.131 31.5-31.5v-160c0-17.369-14.131-31.5-31.5-31.5zM448 311.5c0 9.099-7.402 16.5-16.5 16.5h-400c-9.098 0-16.5-7.401-16.5-16.5v-160c0-9.099 7.402-16.5 16.5-16.5h400c9.098 0 16.5 7.401 16.5 16.5v160z"},null,-1),vx=qe("path",{d:"M327.5 280h-192c-4.142 0-7.5 3.357-7.5 7.5s3.358 7.5 7.5 7.5h192c4.142 0 7.5-3.357 7.5-7.5s-3.358-7.5-7.5-7.5zM103.5 280h-16c-4.142 0-7.5 3.357-7.5 7.5s3.358 7.5 7.5 7.5h16c4.142 0 7.5-3.357 7.5-7.5s-3.358-7.5-7.5-7.5zM55.5 280h-16c-4.142 0-7.5 3.357-7.5 7.5s3.358 7.5 7.5 7.5h16c4.142 0 7.5-3.357 7.5-7.5s-3.358-7.5-7.5-7.5zM423.5 280h-16c-4.142 0-7.5 3.357-7.5 7.5s3.358 7.5 7.5 7.5h16c4.142 0 7.5-3.357 7.5-7.5s-3.358-7.5-7.5-7.5zM375.5 280h-16c-4.142 0-7.5 3.357-7.5 7.5s3.358 7.5 7.5 7.5h16c4.142 0 7.5-3.357 7.5-7.5s-3.358-7.5-7.5-7.5zM423.5 248h-32c-4.142 0-7.5 3.357-7.5 7.5s3.358 7.5 7.5 7.5h32c4.142 0 7.5-3.357 7.5-7.5s-3.358-7.5-7.5-7.5zM367 255.5a7.5 7.5 0 0 0-7.5-7.5h-16c-4.142 0-7.5 3.357-7.5 7.5s3.358 7.5 7.5 7.5h16a7.5 7.5 0 0 0 7.5-7.5zM295.5 263h16c4.142 0 7.5-3.357 7.5-7.5s-3.358-7.5-7.5-7.5h-16c-4.142 0-7.5 3.357-7.5 7.5s3.358 7.5 7.5 7.5zM247.5 263h16c4.142 0 7.5-3.357 7.5-7.5s-3.358-7.5-7.5-7.5h-16c-4.142 0-7.5 3.357-7.5 7.5s3.358 7.5 7.5 7.5zM199.5 263h16c4.142 0 7.5-3.357 7.5-7.5s-3.358-7.5-7.5-7.5h-16c-4.142 0-7.5 3.357-7.5 7.5s3.358 7.5 7.5 7.5zM151.5 263h16c4.142 0 7.5-3.357 7.5-7.5s-3.358-7.5-7.5-7.5
 0 7.5-3.357 7.5-7.5s-3.358-7.5-7.5-7.5zM39.5 231h48c4.142 0 7.5-3.357 7.5-7.5s-3.358-7.5-7.5-7.5h-48c-4.142 0-7.5 3.357-7.5 7.5s3.358 7.5 7.5 7.5zM423.5 152h-16c-4.142 0-7.5 3.357-7.5 7.5s3.358 7.5 7.5 7.5h16c4.142 0 7.5-3.357 7.5-7.5s-3.358-7.5-7.5-7.5zM375.5 152h-16c-4.142 0-7.5 3.357-7.5 7.5s3.358 7.5 7.5 7.5h16c4.142 0 7.5-3.357 7.5-7.5s-3.358-7.5-7.5-7.5zM327.5 152h-16c-4.142 0-7.5 3.357-7.5 7.5s3.358 7.5 7.5 7.5h16c4.142 0 7.5-3.357 7.5-7.5s-3.358-7.5-7.5-7.5zM263.5 167h16c4.142 0 7.5-3.357 7.5-7.5s-3.358-7.5-7.5-7.5h-16c-4.142 0-7.5 3.357-7.5 7.5s3.358 7.5 7.5 7.5zM215.5 167h16c4.142 0 7.5-3.357 7.5-7.5s-3.358-7.5-7.5-7.5h-16c-4.142 0-7.5 3.357-7.5 7.5s3.358 7.5 7.5 7.5zM167.5 167h16c4.142 0 7.5-3.357 7.5-7.5s-3.358-7.5-7.5-7.5h-16c-4.142 0-7.5 3.357-7.5 7.5s3.358 7.5 7.5 7.5zM119.5 167h16c4.142 0 7.5-3.357 7.5-7.5s-3.358-7.5-7.5-7.5h-16c-4.142 0-7.5 3.357-7.5 7.5s3.358 7.5 7.5 7.5zM39.5 167h48c4.142 0 7.5-3.357 7.5-7.5s-3.358-7.5-7.5-7.5h-48c-4.142 0-7.5 3.357-7.5 7.5s3.358 7.5 7.5 7.5z"},null,-1),yx=[bx,vx];function wx(s,n){return Je(),ct("svg",mx,yx)}const kx={render:wx};/*!
  * vue-router v4.1.3
  * (c) 2022 Eduardo San Martin Morote
  * @license MIT
  */const ls=typeof window<"u";function Ax(s){return s.__esModule||s[Symbol.toStringTag]==="Module"}const Ze=Object.assign;function Dr(s,n){const c={};for(const u in n){const g=n[u];c[u]=jt(g)?g.map(s):s(g)}return c}const Gs=()=>{},jt=Array.isArray,Sx=/\/$/,Cx=s=>s.replace(Sx,"");function Xr(s,n,c="/"){let u,g={},m="",w="";const k=n.indexOf("#");let P=n.indexOf("?");return k<P&&k>=0&&(P=-1),P>-1&&(u=n.slice(0,P),m=n.slice(P+1,k>-1?k:n.length),g=s(m)),k>-1&&(u=u||n.slice(0,k),w=n.slice(k,n.length)),u=Lx(u!=null?u:n,c),{fullPath:u+(m&&"?")+m+w,path:u,query:g,hash:w}}function Ex(s,n){const c=n.query?s(n.query):"";return n.path+(c&&"?")+c+(n.hash||"")}function ml(s,n){return!n||!s.toLowerCase().startsWith(n.toLowerCase())?s:s.slice(n.length)||"/"}function Px(s,n,c){const u=n.matched.length-1,g=c.matched.length-1;return u>-1&&u===g&&ws(n.matched[u],c.matched[g])&&iu(n.params,c.params)&&s(n.query)===s(c.query)&&n.hash===c.hash}function ws(s,n){return(s.aliasOf||s)===(n.aliasOf||n)}function iu(s,n){if(Object.keys(s).length!==Object.keys(n).length)return!1;for(const c in s)if(!Tx(s[c],n[c]))return!1;return!0}function Tx(s,n){return jt(s)?bl(s,n):jt(n)?bl(n,s):s===n}function bl(s,n){return jt(n)?s.length===n.length&&s.every((c,u)=>c===n[u]):s.length===1&&s[0]===n}function Lx(s,n){if(s.startsWith("/"))return s;if(!s)return n;const c=n.split("/"),u=s.split("/");let g=c.length-1,m,w;for(m=0;m<u.length;m++)if(w=u[m],w!==".")if(w==="..")g>1&&g--;else break;return c.slice(0,g).join("/")+"/"+u.slice(m-(m===u.length?1:0)).join("/")}var ta;(function(s){s.pop="pop",s.push="push"})(ta||(ta={}));var Us;(function(s){s.back="back",s.forward="forward",s.unknown=""})(Us||(Us={}));function Mx(s){if(!s)if(ls){const n=document.querySelector("base");s=n&&n.getAttribute("href")||"/",s=s.replace(/^\w+:\/\/[^\/]+/,"")}else s="/";return s[0]!=="/"&&s[0]!=="#"&&(s="/"+s),Cx(s)}const _x=/^[^#]+#/;function Ix(s,n){return s.replace(_x,"#")+n}function Rx(s,n){const c=document.documentElement.getBoundingClientRect(),u=s.getBoundingClientRect();return{behavior:n.behavior,left:u.left-c.left-(n.left||0),top:u.top-c.top-(n.top||0)}}const br=()=>({left:window.pageXOffset,top:window.pageYOffset});function Ox(s){let n;if("el"in s){const c=s.el,u=typeof c=="string"&&c.startsWith("#"),g=typeof c=="string"?u?document.getElementById(c.slice(1)):document.querySelector(c):c;if(!g)return;n=Rx(g,s)}else n=s;"scrollBehavior"in document.documentElement.style?window.scrollTo(n):window.scrollTo(n.left!=null?n.left:window.pageXOffset,n.top!=null?n.top:window.pageYOffset)}function vl(s,n){return(history.state?history.state.position-n:-1)+s}const Ln=new Map;function Fx(s,n){Ln.set(s,n)}function zx(s){const n=Ln.get(s);return Ln.delete(s),n}let Nx=()=>location.protocol+"//"+location.host;function su(s,n){const{pathname:c,search:u,hash:g}=n,m=s.indexOf("#");if(m>-1){let k=g.includes(s.slice(m))?s.slice(m).length:1,P=g.slice(k);return P[0]!=="/"&&(P="/"+P),ml(P,"")}return ml(c,s)+u+g}function Dx(s,n,c,u){let g=[],m=[],w=null;const k=({state:z})=>{const W=su(s,location),q=c.value,K=n.value;let J=0;if(z){if(c.value=W,n.value=z,w&&w===q){w=null;return}J=K?z.position-K.position:0}else u(W);g.forEach(V=>{V(c.value,q,{delta:J,type:ta.pop,direction:J?J>0?Us.forward:Us.back:Us.unknown})})};function P(){w=c.value}function I(z){g.push(z);const W=()=>{const q=g.indexOf(z);q>-1&&g.splice(q,1)};return m.push(W),W}function O(){const{history:z}=window;!z.state||z.replaceState(Ze({},z.state,{scroll:br()}),"")}function N(){for(const z of m)z();m=[],window.removeEventListener("popstate",k),window.removeEventListener("beforeunload",O)}return window.addEventListener("popstate",k),window.addEventListener("beforeunload",O),{pauseListeners:P,listen:I,destroy:N}}function yl(s,n,c,u=!1,g=!1){return{back:s,current:n,forward:c,replaced:u,position:window.history.length,scroll:g?br():null}}function Xx(s){const{history:n,location:c}=window,u={value:su(s,c)},g={value:n.state};g.value||m(u.value,{back:null,current:u.value,forward:null,position:n.length-1,replaced:!0,scroll:null},!0);function m(P,I,O){const N=s.indexOf("#"),z=N>-1?(c.host&&document.querySelector("base")?s:s.slice(N))+P:Nx()+s+P;try{n[O?"replaceState":"pushState"](I,"",z),g.value=I}catch(W){console.error(W),c[O?"replace":"assign"](z)}}function w(P,I){const O=Ze({},n.state,yl(g.value.back,P,g.value.forward,!0),I,{position:g.value.position});m(P,O,!0),u.value=P}function k(P,I){const O=Ze({},g.value,n.state,{forward:P,scroll:br()});m(O.current,O,!0);const N=Ze({},yl(u.value,P,null),{position:O.position+1},I);m(P,N,!1),u.value=P}return{location:u,state:g,push:k,replace:w}}function Hx(s){s=Mx(s);const n=Xx(s),c=Dx(s,n.state,n.location,n.replace);function u(m,w=!0){w||c.pauseListeners(),history.go(m)}const g=Ze({location:"",base:s,go:u,createHref:Ix.bind(null,s)},n,c);return Object.defineProperty(g,"location",{enumerable:!0,get:()=>n.location.value}),Object.defineProperty(g,"state",{enumerable:!0,get:()=>n.state.value}),g}function Yx(s){return typeof s=="string"||s&&typeof s=="object"}function au(s){return typeof s=="string"||typeof s=="symbol"}const pi={path:"/",name:void 0,params:{},query:{},hash:"",fullPath:"/",matched:[],meta:{},redirectedFrom:void 0},ru=Symbol("");var wl;(function(s){s[s.aborted=4]="aborted",s[s.cancelled=8]="cancelled",s[s.duplicated=16]="duplicated"})(wl||(wl={}));function ks(s,n){return Ze(new Error,{type:s,[ru]:!0},n)}function si(s,n){return s instanceof Error&&ru in s&&(n==null||!!(s.type&n))}const kl="[^/]+?",Bx={sensitive:!1,strict:!1,start:!0,end:!0},Wx=/[.+*?^${}()[\]/\\]/g;function Vx(s,n){const c=Ze({},Bx,n),u=[];let g=c.start?"^":"";const m=[];for(const I of s){const O=I.length?[]:[90];c.strict&&!I.length&&(g+="/");for(let N=0;N<I.length;N++){const z=I[N];let W=40+(c.sensitive?.25:0);if(z.type===0)N||(g+="/"),g+=z.value.replace(Wx,"\\$&"),W+=40;else if(z.type===1){const{value:q,repeatable:K,optional:J,regexp:V}=z;m.push({name:q,repeatable:K,optional:J});const T=V||kl;if(T!==kl){W+=10;try{new RegExp(`(${T})`)}catch(Z){throw new Error(`Invalid custom RegExp for param "${q}" (${T}): `+Z.message)}}let G=K?`((?:${T})(?:/(?:${T}))*)`:`(${T})`;N||(G=J&&I.length<2?`(?:/${G})`:"/"+G),J&&(G+="?"),g+=G,W+=20,J&&(W+=-8),K&&(W+=-20),T===".*"&&(W+=-50)}O.push(W)}u.push(O)}if(c.strict&&c.end){const I=u.length-1;u[I][u[I].length-1]+=.7000000000000001}c.strict||(g+="/?"),c.end?g+="$":c.strict&&(g+="(?:/|$)");const w=new RegExp(g,c.sensitive?"":"i");function k(I){const O=I.match(w),N={};if(!O)return null;for(let z=1;z<O.length;z++){const W=O[z]||"",q=m[z-1];N[q.name]=W&&q.repeatable?W.split("/"):W}return N}function P(I){let O="",N=!1;for(const z of s){(!N||!O.endsWith("/"))&&(O+="/"),N=!1;for(const W of z)if(W.type===0)O+=W.value;else if(W.type===1){const{value:q,repeatable:K,optional:J}=W,V=q in I?I[q]:"";if(jt(V)&&!K)throw new Error(`Provided param "${q}" is an array but it is not repeatable (* or + modifiers)`);const T=jt(V)?V.join("/"):V;if(!T)if(J)z.length<2&&(O.endsWith("/")?O=O.slice(0,-1):N=!0);else throw new Error(`Missing required param "${q}"`);O+=T}}return O||"/"}return{re:w,score:u,keys:m,parse:k,stringify:P}}function jx(s,n){let c=0;for(;c<s.length&&c<n.length;){const u=n[c]-s[c];if(u)return u;c++}return s.length<n.length?s.length===1&&s[0]===40+40?-1:1:s.length>n.length?n.length===1&&n[0]===40+40?1:-1:0}function Gx(s,n){let c=0;const u=s.score,g=n.score;for(;c<u.length&&c<g.length;){const m=jx(u[c],g[c]);if(m)return m;c++}if(Math.abs(g.length-u.length)===1){if(Al(u))return 1;if(Al(g))return-1}return g.length-u.length}function Al(s){const n=s[s.length-1];return s.length>0&&n[n.length-1]<0}const Ux={type:0,value:""},$x=/[a-zA-Z0-9_]/;function qx(s){if(!s)return[[]];if(s==="/")return[[Ux]];if(!s.startsWith("/"))throw new Error(`Invalid path "${s}"`);function n(W){throw new Error(`ERR (${c})/"${I}": ${W}`)}let c=0,u=c;const g=[];let m;function w(){m&&g.push(m),m=[]}let k=0,P,I="",O="";function N(){!I||(c===0?m.push({type:0,value:I}):c===1||c===2||c===3?(m.length>1&&(P==="*"||P==="+")&&n(`A repeatable param (${I}) must be alone in its segment. eg: '/:ids+.`),m.push({type:1,value:I,regexp:O,repeatable:P==="*"||P==="+",optional:P==="*"||P==="?"})):n("Invalid state to consume buffer"),I="")}function z(){I+=P}for(;k<s.length;){if(P=s[k++],P==="\\"&&c!==2){u=c,c=4;continue}switch(c){case 0:P==="/"?(I&&N(),w()):P===":"?(N(),c=1):z();break;case 4:z(),c=u;break;case 1:P==="("?c=2:$x.test(P)?z():(N(),c=0,P!=="*"&&P!=="?"&&P!=="+"&&k--);break;case 2:P===")"?O[O.length-1]=="\\"?O=O.slice(0,-1)+P:c=3:O+=P;break;case 3:N(),c=0,P!=="*"&&P!=="?"&&P!=="+"&&k--,O="";break;default:n("Unknown state");break}}return c===2&&n(`Unfinished custom RegExp for param "${I}"`),N(),w(),g}function Zx(s,n,c){const u=Vx(qx(s.path),c),g=Ze(u,{record:s,parent:n,children:[],alias:[]});return n&&!g.record.aliasOf==!n.record.aliasOf&&n.children.push(g),g}function Kx(s,n){const c=[],u=new Map;n=Cl({strict:!1,end:!0,sensitive:!1},n);function g(O){return u.get(O)}function m(O,N,z){const W=!z,q=Qx(O);q.aliasOf=z&&z.record;const K=Cl(n,O),J=[q];if("alias"in O){const G=typeof O.alias=="string"?[O.alias]:O.alias;for(const Z of G)J.push(Ze({},q,{components:z?z.record.components:q.components,path:Z,aliasOf:z?z.record:q}))}let V,T;for(const G of J){const{path:Z}=G;if(N&&Z[0]!=="/"){const H=N.record.path,ce=H[H.length-1]==="/"?"":"/";G.path=N.record.path+(Z&&ce+Z)}if(V=Zx(G,N,K),z?z.alias.push(V):(T=T||V,T!==V&&T.alias.push(V),W&&O.name&&!Sl(V)&&w(O.name)),q.children){const H=q.children;for(let ce=0;ce<H.length;ce++)m(H[ce],V,z&&z.children[ce])}z=z||V,P(V)}return T?()=>{w(T)}:Gs}function w(O){if(au(O)){const N=u.get(O);N&&(u.delete(O),c.splice(c.indexOf(N),1),N.children.forEach(w),N.alias.forEach(w))}else{const N=c.indexOf(O);N>-1&&(c.splice(N,1),O.record.name&&u.delete(O.record.name),O.children.forEach(w),O.alias.forEach(w))}}function k(){return c}function P(O){let N=0;for(;N<c.length&&Gx(O,c[N])>=0&&(O.record.path!==c[N].record.path||!nu(O,c[N]));)N++;c.splice(N,0,O),O.record.name&&!Sl(O)&&u.set(O.record.name,O)}function I(O,N){let z,W={},q,K;if("name"in O&&O.name){if(z=u.get(O.name),!z)throw ks(1,{location:O});K=z.record.name,W=Ze(Jx(N.params,z.keys.filter(T=>!T.optional).map(T=>T.name)),O.params),q=z.stringify(W)}else if("path"in O)q=O.path,z=c.find(T=>T.re.test(q)),z&&(W=z.parse(q),K=z.record.name);else{if(z=N.name?u.get(N.name):c.find(T=>T.re.test(N.path)),!z)throw ks(1,{location:O,currentLocation:N});K=z.record.name,W=Ze({},N.params,O.params),q=z.stringify(W)}const J=[];let V=z;for(;V;)J.unshift(V.record),V=V.parent;return{name:K,path:q,params:W,matched:J,meta:tm(J)}}return s.forEach(O=>m(O)),{addRoute:m,resolve:I,removeRoute:w,getRoutes:k,getRecordMatcher:g}}function Jx(s,n){const c={};for(const u of n)u in s&&(c[u]=s[u]);return c}function Qx(s){return{path:s.path,redirect:s.redirect,name:s.name,meta:s.meta||{},aliasOf:void 0,beforeEnter:s.beforeEnter,props:em(s),children:s.children||[],instances:{},leaveGuards:new Set,updateGuards:new Set,enterCallbacks:{},components:"components"in s?s.components||null:s.component&&{default:s.component}}}function em(s){const n={},c=s.props||!1;if("component"in s)n.default=c;else for(const u in s.components)n[u]=typeof c=="boolean"?c:c[u];return n}function Sl(s){for(;s;){if(s.record.aliasOf)return!0;s=s.parent}return!1}function tm(s){return s.reduce((n,c)=>Ze(n,c.meta),{})}function Cl(s,n){const c={};for(const u in s)c[u]=u in n?n[u]:s[u];return c}function nu(s,n){return n.children.some(c=>c===s||nu(s,c))}const ou=/#/g,im=/&/g,sm=/\//g,am=/=/g,rm=/\?/g,lu=/\+/g,nm=/%5B/g,om=/%5D/g,cu=/%5E/g,lm=/%60/g,hu=/%7B/g,cm=/%7C/g,uu=/%7D/g,hm=/%20/g;function lo(s){return encodeURI(""+s).replace(cm,"|").replace(nm,"[").replace(om,"]")}function um(s){return lo(s).replace(hu,"{").replace(uu,"}").replace(cu,"^")}function Mn(s){return lo(s).replace(lu,"%2B").replace(hm,"+").replace(ou,"%23").replace(im,"%26").replace(lm,"`").replace(hu,"{").replace(uu,"}").replace(cu,"^")}function dm(s){return Mn(s).replace(am,"%3D")}function fm(s){return lo(s).replace(ou,"%23").replace(rm,"%3F")}function gm(s){return s==null?"":fm(s).replace(sm,"%2F")}function Ua(s){try{return decodeURIComponent(""+s)}catch{}return""+s}function pm(s){const n={};if(s===""||s==="?")return n;const u=(s[0]==="?"?s.slice(1):s).split("&");for(let g=0;g<u.length;++g){const m=u[g].replace(lu," "),w=m.indexOf("="),k=Ua(w<0?m:m.slice(0,w)),P=w<0?null:Ua(m.slice(w+1));if(k in n){let I=n[k];jt(I)||(I=n[k]=[I]),I.push(P)}else n[k]=P}return n}function El(s){let n="";for(let c in s){const u=s[c];if(c=dm(c),u==null){u!==void 0&&(n+=(n.length?"&":"")+c);continue}(jt(u)?u.map(m=>m&&Mn(m)):[u&&Mn(u)]).forEach(m=>{m!==void 0&&(n+=(n.length?"&":"")+c,m!=null&&(n+="="+m))})}return n}function xm(s){const n={};for(const c in s){const u=s[c];u!==void 0&&(n[c]=jt(u)?u.map(g=>g==null?null:""+g):u==null?u:""+u)}return n}const mm=Symbol(""),Pl=Symbol(""),vr=Symbol(""),co=Symbol(""),_n=Symbol("");function _s(){let s=[];function n(u){return s.push(u),()=>{const g=s.indexOf(u);g>-1&&s.splice(g,1)}}function c(){s=[]}return{add:n,list:()=>s,reset:c}}function vi(s,n,c,u,g){const m=u&&(u.enterCallbacks[g]=u.enterCallbacks[g]||[]);return()=>new Promise((w,k)=>{const P=N=>{N===!1?k(ks(4,{from:c,to:n})):N instanceof Error?k(N):Yx(N)?k(ks(2,{from:n,to:N})):(m&&u.enterCallbacks[g]===m&&typeof N=="function"&&m.push(N),w())},I=s.call(u&&u.instances[g],n,c,P);let O=Promise.resolve(I);s.length<3&&(O=O.then(P)),O.catch(N=>k(N))})}function Hr(s,n,c,u){const g=[];for(const m of s)for(const w in m.components){let k=m.components[w];if(!(n!=="beforeRouteEnter"&&!m.instances[w]))if(bm(k)){const I=(k.__vccOpts||k)[n];I&&g.push(vi(I,c,u,m,w))}else{let P=k();g.push(()=>P.then(I=>{if(!I)return Promise.reject(new Error(`Couldn't resolve component "${w}" at "${m.path}"`));const O=Ax(I)?I.default:I;m.components[w]=O;const z=(O.__vccOpts||O)[n];return z&&vi(z,c,u,m,w)()}))}}return g}function bm(s){return typeof s=="object"||"displayName"in s||"props"in s||"__vccOpts"in s}function Tl(s){const n=Rt(vr),c=Rt(co),u=je(()=>n.resolve($e(s.to))),g=je(()=>{const{matched:P}=u.value,{length:I}=P,O=P[I-1],N=c.matched;if(!O||!N.length)return-1;const z=N.findIndex(ws.bind(null,O));if(z>-1)return z;const W=Ll(P[I-2]);return I>1&&Ll(O)===W&&N[N.length-1].path!==W?N.findIndex(ws.bind(null,P[I-2])):z}),m=je(()=>g.value>-1&&km(c.params,u.value.params)),w=je(()=>g.value>-1&&g.value===c.matched.length-1&&iu(c.params,u.value.params));function k(P={}){return wm(P)?n[$e(s.replace)?"replace":"push"]($e(s.to)).catch(Gs):Promise.resolve()}return{route:u,href:je(()=>u.value.href),isActive:m,isExactActive:w,navigate:k}}const vm=li({name:"RouterLink",compatConfig:{MODE:3},props:{to:{type:[String,Object],required:!0},replace:Boolean,activeClass:String,exactActiveClass:String,custom:Boolean,ariaCurrentValue:{type:String,default:"page"}},useLink:Tl,setup(s,{slots:n}){const c=Ii(Tl(s)),{options:u}=Rt(vr),g=je(()=>({[Ml(s.activeClass,u.linkActiveClass,"router-link-active")]:c.isActive,[Ml(s.exactActiveClass,u.linkExactActiveClass,"router-link-exact-active")]:c.isExactActive}));return()=>{const m=n.default&&n.default(c);return s.custom?m:pr("a",{"aria-current":c.isExactActive?s.ariaCurrentValue:null,href:c.href,onClick:c.navigate,class:g.value},m)}}}),ym=vm;function wm(s){if(!(s.metaKey||s.altKey||s.ctrlKey||s.shiftKey)&&!s.defaultPrevented&&!(s.button!==void 0&&s.button!==0)){if(s.currentTarget&&s.currentTarget.getAttribute){const n=s.currentTarget.getAttribute("target");if(/\b_blank\b/i.test(n))return}return s.preventDefault&&s.preventDefault(),!0}}function km(s,n){for(const c in n){const u=n[c],g=s[c];if(typeof u=="string"){if(u!==g)return!1}else if(!jt(g)||g.length!==u.length||u.some((m,w)=>m!==g[w]))return!1}return!0}function Ll(s){return s?s.aliasOf?s.aliasOf.path:s.path:""}const Ml=(s,n,c)=>s!=null?s:n!=null?n:c,Am=li({name:"RouterView",inheritAttrs:!1,props:{name:{type:String,default:"default"},route:Object},compatConfig:{MODE:3},setup(s,{attrs:n,slots:c}){const u=Rt(_n),g=je(()=>s.route||u.value),m=Rt(Pl,0),w=je(()=>{let I=$e(m);const{matched:O}=g.value;let N;for(;(N=O[I])&&!N.components;)I++;return I}),k=je(()=>g.value.matched[w.value]);Bs(Pl,je(()=>w.value+1)),Bs(mm,k),Bs(_n,g);const P=Ct();return Ai(()=>[P.value,k.value,s.name],([I,O,N],[z,W,q])=>{O&&(O.instances[N]=I,W&&W!==O&&I&&I===z&&(O.leaveGuards.size||(O.leaveGuards=W.leaveGuards),O.updateGuards.size||(O.updateGuards=W.updateGuards))),I&&O&&(!W||!ws(O,W)||!z)&&(O.enterCallbacks[N]||[]).forEach(K=>K(I))},{flush:"post"}),()=>{const I=g.value,O=s.name,N=k.value,z=N&&N.components[O];if(!z)return _l(c.default,{Component:z,route:I});const W=N.props[O],q=W?W===!0?I.params:typeof W=="function"?W(I):W:null,J=pr(z,Ze({},q,n,{onVnodeUnmounted:V=>{V.component.isUnmounted&&(N.instances[O]=null)},ref:P}));return _l(c.default,{Component:J,route:I})||J}}});function _l(s,n){if(!s)return null;const c=s(n);return c.length===1?c[0]:c}const Sm=Am;function Cm(s){const n=Kx(s.routes,s),c=s.parseQuery||pm,u=s.stringifyQuery||El,g=s.history,m=_s(),w=_s(),k=_s(),P=wc(pi);let I=pi;ls&&s.scrollBehavior&&"scrollRestoration"in history&&(history.scrollRestoration="manual");const O=Dr.bind(null,U=>""+U),N=Dr.bind(null,gm),z=Dr.bind(null,Ua);function W(U,ue){let de,be;return au(U)?(de=n.getRecordMatcher(U),be=ue):be=U,n.addRoute(be,de)}function q(U){const ue=n.getRecordMatcher(U);ue&&n.removeRoute(ue)}function K(){return n.getRoutes().map(U=>U.record)}function J(U){return!!n.getRecordMatcher(U)}function V(U,ue){if(ue=Ze({},ue||P.value),typeof U=="string"){const Ee=Xr(c,U,ue.path),D=n.resolve({path:Ee.path},ue),B=g.createHref(Ee.fullPath);return Ze(Ee,D,{params:z(D.params),hash:Ua(Ee.hash),redirectedFrom:void 0,href:B})}let de;if("path"in U)de=Ze({},U,{path:Xr(c,U.path,ue.path).path});else{const Ee=Ze({},U.params);for(const D in Ee)Ee[D]==null&&delete Ee[D];de=Ze({},U,{params:N(U.params)}),ue.params=N(ue.params)}const be=n.resolve(de,ue),Oe=U.hash||"";be.params=O(z(be.params));const Re=Ex(u,Ze({},U,{hash:um(Oe),path:be.path})),Pe=g.createHref(Re);return Ze({fullPath:Re,hash:Oe,query:u===El?xm(U.query):U.query||{}},be,{redirectedFrom:void 0,href:Pe})}function T(U){return typeof U=="string"?Xr(c,U,P.value.path):Ze({},U)}function G(U,ue){if(I!==U)return ks(8,{from:ue,to:U})}function Z(U){return Q(U)}function H(U){return Z(Ze(T(U),{replace:!0}))}function ce(U){const ue=U.matched[U.matched.length-1];if(ue&&ue.redirect){const{redirect:de}=ue;let be=typeof de=="function"?de(U):de;return typeof be=="string"&&(be=be.includes("?")||be.includes("#")?be=T(be):{path:be},be.params={}),Ze({query:U.query,hash:U.hash,params:"path"in be?{}:U.params},be)}}function Q(U,ue){const de=I=V(U),be=P.value,Oe=U.state,Re=U.force,Pe=U.replace===!0,Ee=ce(de);if(Ee)return Q(Ze(T(Ee),{state:Oe,force:Re,replace:Pe}),ue||de);const D=de;D.redirectedFrom=ue;let B;return!Re&&Px(u,be,de)&&(B=ks(16,{to:D,from:be}),Gt(be,be,!0,!1)),(B?Promise.resolve(B):ne(D,be)).catch($=>si($)?si($,2)?$:Ge($):Te($,D,be)).then($=>{if($){if(si($,2))return Q(Ze({replace:Pe},T($.to),{state:Oe,force:Re}),ue||D)}else $=le(D,be,!0,Pe,Oe);return ee(D,be,$),$})}function ie(U,ue){const de=G(U,ue);return de?Promise.reject(de):Promise.resolve()}function ne(U,ue){let de;const[be,Oe,Re]=Em(U,ue);de=Hr(be.reverse(),"beforeRouteLeave",U,ue);for(const Ee of be)Ee.leaveGuards.forEach(D=>{de.push(vi(D,U,ue))});const Pe=ie.bind(null,U,ue);return de.push(Pe),is(de).then(()=>{de=[];for(const Ee of m.list())de.push(vi(Ee,U,ue));return de.push(Pe),is(de)}).then(()=>{de=Hr(Oe,"beforeRouteUpdate",U,ue);for(const Ee of Oe)Ee.updateGuards.forEach(D=>{de.push(vi(D,U,ue))});return de.push(Pe),is(de)}).then(()=>{de=[];for(const Ee of U.matched)if(Ee.beforeEnter&&!ue.matched.includes(Ee))if(jt(Ee.beforeEnter))for(const D of Ee.beforeEnter)de.push(vi(D,U,ue));else de.push(vi(Ee.beforeEnter,U,ue));return de.push(Pe),is(de)}).then(()=>(U.matched.forEach(Ee=>Ee.enterCallbacks={}),de=Hr(Re,"beforeRouteEnter",U,ue),de.push(Pe),is(de))).then(()=>{de=[];for(const Ee of w.list())de.push(vi(Ee,U,ue));return de.push(Pe),is(de)}).catch(Ee=>si(Ee,8)?Ee:Promise.reject(Ee))}function ee(U,ue,de){for(const be of k.list())be(U,ue,de)}function le(U,ue,de,be,Oe){const Re=G(U,ue);if(Re)return Re;const Pe=ue===pi,Ee=ls?history.state:{};de&&(be||Pe?g.replace(U.fullPath,Ze({scroll:Pe&&Ee&&Ee.scroll},Oe)):g.push(U.fullPath,Oe)),P.value=U,Gt(U,ue,de,Pe),Ge()}let se;function ye(){se||(se=g.listen((U,ue,de)=>{if(!ht.listening)return;const be=V(U),Oe=ce(be);if(Oe){Q(Ze(Oe,{replace:!0}),be).catch(Gs);return}I=be;const Re=P.value;ls&&Fx(vl(Re.fullPath,de.delta),br()),ne(be,Re).catch(Pe=>si(Pe,12)?Pe:si(Pe,2)?(Q(Pe.to,be).then(Ee=>{si(Ee,20)&&!de.delta&&de.type===ta.pop&&g.go(-1,!1)}).catch(Gs),Promise.reject()):(de.delta&&g.go(-de.delta,!1),Te(Pe,be,Re))).then(Pe=>{Pe=Pe||le(be,Re,!1),Pe&&(de.delta&&!si(Pe,8)?g.go(-de.delta,!1):de.type===ta.pop&&si(Pe,20)&&g.go(-1,!1)),ee(be,Re,Pe)}).catch(Gs)}))}let ge=_s(),Be=_s(),Le;function Te(U,ue,de){Ge(U);const be=Be.list();return be.length?be.forEach(Oe=>Oe(U,ue,de)):console.error(U),Promise.reject(U)}function He(){return Le&&P.value!==pi?Promise.resolve():new Promise((U,ue)=>{ge.add([U,ue])})}function Ge(U){return Le||(Le=!U,ye(),ge.list().forEach(([ue,de])=>U?de(U):ue()),ge.reset()),U}function Gt(U,ue,de,be){const{scrollBehavior:Oe}=s;if(!ls||!Oe)return Promise.resolve();const Re=!de&&zx(vl(U.fullPath,0))||(be||!de)&&history.state&&history.state.scroll||null;return xs().then(()=>Oe(U,ue,Re)).then(Pe=>Pe&&Ox(Pe)).catch(Pe=>Te(Pe,U,ue))}const rt=U=>g.go(U);let We;const nt=new Set,ht={currentRoute:P,listening:!0,addRoute:W,removeRoute:q,hasRoute:J,getRoutes:K,resolve:V,options:s,push:Z,replace:H,go:rt,back:()=>rt(-1),forward:()=>rt(1),beforeEach:m.add,beforeResolve:w.add,afterEach:k.add,onError:Be.add,isReady:He,install(U){const ue=this;U.component("RouterLink",ym),U.component("RouterView",Sm),U.config.globalProperties.$router=ue,Object.defineProperty(U.config.globalProperties,"$route",{enumerable:!0,get:()=>$e(P)}),ls&&!We&&P.value===pi&&(We=!0,Z(g.location).catch(Oe=>{}));const de={};for(const Oe in pi)de[Oe]=je(()=>P.value[Oe]);U.provide(vr,ue),U.provide(co,Ii(de)),U.provide(_n,P);const be=U.unmount;nt.add(U),U.unmount=function(){nt.delete(U),nt.size<1&&(I=pi,se&&se(),se=null,P.value=pi,We=!1,Le=!1),be()}}};return ht}function is(s){return s.reduce((n,c)=>n.then(()=>c()),Promise.resolve())}function Em(s,n){const c=[],u=[],g=[],m=Math.max(n.matched.length,s.matched.length);for(let w=0;w<m;w++){const k=n.matched[w];k&&(s.matched.find(I=>ws(I,k))?u.push(k):c.push(k));const P=s.matched[w];P&&(n.matched.find(I=>ws(I,P))||g.push(P))}return[c,u,g]}function Pm(){return Rt(vr)}function du(){return Rt(co)}const Tm=`a
abandon
ability
able
abortion
...
yourself
youth
zone`,$a={checkTestEnd:Lm,countTypos:_m,calcWpm:Mm};function Lm(s,n,c){return!(c-1!==s.currWord.idx||s.currLatter.idx!==s.currWord.str.length-1||!n)}function Mm(s,n,c){const g=n/5/(c/60)-s/c/60;return Math.round(g)}function _m(s){return s.latters.reduce((n,c)=>(c.isCorrect===!1&&n++,n),0)}const Dt={generateNewTest:Om,retest:Fm,countAllTypos:Ym,calcWordWpm:Hm,calcTestWpm:Xm,saveTestToLocalStorage:Dm,localOption:Im,saveLocalOption:Rm};function Im(){const s=localStorage.getItem("testOptions");return s?JSON.parse(s):(localStorage.setItem("testOptions",JSON.stringify({mode:"time",level:15})),{mode:"time",level:15})}function Rm(s){localStorage.setItem("testOptions",JSON.stringify(s))}function Om(s="english"){const n=zm().map(u=>({word:u,isCorrect:null,wpm:0,typeCount:0,time:0,latters:u.split("").map(g=>({latter:g,isCorrect:null}))}));return{currLatter:{idx:0,str:n[0].latters[0].latter},currWord:{idx:0,str:n[0].word},time:0,typoCount:0,sumType:0,acc:0,realAcc:0,wpm:0,txt:n}}function Fm(s){const n={...s};return n.currLatter={idx:0,str:n.txt[0].latters[0].latter},n.currWord={idx:0,str:n.txt[0].word},n.typoCount=0,n.sumType=0,n.txt=Nm(s.txt),n}function zm(s="english"){return Tm.split(`
`).sort(()=>Math.random()-.5).slice(0,100)}function Nm(s){return s.map(n=>({word:n.word,typeCount:0,wpm:0,time:0,isCorrect:null,latters:n.word.split("").map(c=>({latter:c,isCorrect:null}))}))}function Dm(s){window.localStorage.setItem("test",JSON.stringify(s))}function Xm(s){const n=s.txt.map(({wpm:c})=>c).slice(0,s.currWord.idx).reduce((c,u)=>c+=u,0);return Math.round(n/s.currWord.idx)}function Hm(s){return s.txt.map((c,u)=>{let g=0;for(let m=0;m<u;m++)g+=$a.countTypos(s.txt[m]);return u<s.currWord.idx&&(c.wpm=$a.calcWpm(g,c.typeCount,c.time)),c})}function Ym(s){return s.txt.reduce((n,c)=>(n+=$a.countTypos(c),n),0)}async function Il(s,n){if(n===null)return null;const c=s.getBoundingClientRect(),u=n.getBoundingClientRect();return Ii({top:s.offsetTop-Math.round(s.clientHeight/5),bottom:c.bottom-u.bottom,right:c.right-u.right,left:c.left-u.left,leftEnd:c.left-u.left+c.width})}const Is=ua({id:"caret",state:()=>({caretPos:null,isLatterEnd:!1,currLineIdx:1,relativeTop:0,caretCurrWordIdx:0}),getters:{getCaretPos:({caretPos:s})=>s,getIslatterEnd:({isLatterEnd:s})=>s,getRelativeTop:({relativeTop:s})=>s,getCurrLineIdx:({currLineIdx:s})=>s},actions:{async updatedCaretPos(s,n){const c=fu();if(this.caretPos===null){this.caretPos=await Il(s,n);return}const{top:u,left:g,leftEnd:m,bottom:w}=await Il(s,n);u===this.caretPos.top?(this.caretPos.left=g,this.caretPos.leftEnd=m):(this.currLineIdx++,this.currLineIdx>=3&&(c.cutWordsToRender(),this.caretCurrWordIdx=0),this.caretPos.top=u,this.caretPos.left=g,this.caretPos.leftEnd=m,this.caretPos.bottom=w,this.relativeTop+=u)},setLatterEnd(s){this.isLatterEnd=s},resetCaret(){this.relativeTop=0,this.caretPos=null}}}),fu=ua({id:"test",state:()=>({test:Dt.generateNewTest(),isActive:!1,AFKtimeout:null,testTimeInterval:null,isNewTest:!1,wordsToCut:0}),getters:{getTest:({test:s})=>s,getIsNewTest:({isNewTest:s})=>s,getWordFromTxt:({test:s})=>s==null?void 0:s.txt[s.currWord.idx],getLatterFromTxt:({test:s})=>s==null?void 0:s.txt[s.currWord.idx].latters[s.currLatter.idx],getIsActiveTest:({isActive:s})=>s},actions:{cutWordsToRender(){this.wordsToCut=this.test.currWord.idx},loadTest(){this.test=Dt.generateNewTest()},setNewTest(){this.isNewTest=!0},activateTest(){this.isActive=!0,this.handleTime(!0)},newTest(){this.test=Dt.generateNewTest(),this.test.time=0,this.isNewTest=!1,this.handleTime(!1),this.$router.push("/test")},reloadTest(){this.test.time=0,this.handleTime(!1),this.test=Dt.retest(this.test)},setAFK(){this.isActive=!1,this.handleTime(!1)},handleTime(s){s?(this.isActive=!0,this.testTimeInterval=setInterval(()=>this.test.time+=.25,250)):(clearInterval(this.testTimeInterval),this.testTimeInterval=null)},finishTest(){console.log("finished Test !!"),this.handleTime(!1),this.test.txt=Dt.calcWordWpm(this.test),this.test.realAcc=Math.round(100-this.test.typoCount*100/this.test.sumType),this.test.acc=Math.round(100-Dt.countAllTypos(this.test)*100/this.test.sumType),this.test.wpm=Dt.calcTestWpm(this.test),Dt.saveTestToLocalStorage(this.test),this.$router.push("/testResult")},handleType(s){var m;if(this.test===null)return;const n=gu(),c=Is(),{currLatter:u,currWord:g}=this.test;if(this.test.txt[g.idx].latters[u.idx],this.isActive||this.handleTime(!0),n.getTestMode==="words"&&$a.checkTestEnd(this.test,c.getIslatterEnd,n.getTestLevel)){this.handleTime(!1),this.finishTest();return}this.test.sumType++,this.AFKtimeout!==null&&clearTimeout(this.AFKtimeout),this.AFKtimeout=setTimeout(()=>{this.setAFK()},3e3),s===((m=this.test)==null?void 0:m.currLatter.str)?u.str==="space"?this.setNextWord(!0):this.setLatterNewStatus(!0):(this.test.typoCount++,u.str==="space"?this.setNextWord(!1):this.setLatterNewStatus(!1))},finishWord(){const{currWord:s}=this.test;this.test.txt[s.idx].time=this.test.time,this.test.txt[s.idx].typeCount=this.test.sumType,this.test.txt[s.idx].latters.every(n=>n.isCorrect)?this.test.txt[s.idx].isCorrect=!0:this.test.txt[s.idx].isCorrect=!1},setNextWord(s){this.finishWord();const{currLatter:n,currWord:c}=this.test;Is().setLatterEnd(!1),c.idx++,c.str=this.test.txt[c.idx].word,n.idx=0,n.str=c.str[0]},setPrevWord(){const{currLatter:s,currWord:n}=this.test;Is().setLatterEnd(!0),n.idx--;const u=this.test.txt[n.idx];s.idx=u.latters.length-1,n.str=u.word,s.str=n.str[n.str.length-1]},setLatterNewStatus(s){const{currLatter:n,currWord:c}=this.test,u=Is();this.test.txt[c.idx].latters[n.idx].isCorrect=!!s,n.idx===c.str.length-1?(n.str="space",u.setLatterEnd(!0)):(n.idx++,n.str=c.str[n.idx])},hendleSpicialKeys(s){switch(s){case"Backspace":this.hendleBackspace();break;case"Escape":this.setAFK()}},hendleBackspace(){console.log("backspace");const{currWord:s,currLatter:n}=this.test,c=Is();n.idx===0&&s.idx===0||s.idx>1&&this.test.txt.slice(0,s.idx).every(g=>g.isCorrect)&&n.idx===0||(n.idx===0?this.setPrevWord():n.idx===s.str.length-1&&c.$state.isLatterEnd?(c.setLatterEnd(!1),n.str=s.str[s.str.length-1],this.test.txt[s.idx].latters[n.idx].isCorrect=null):(n.idx--,this.test.txt[s.idx].latters[n.idx].isCorrect=null,n.str=s.str[n.idx]))}}}),gu=ua("testPtions",()=>{const s=fu(),n=Pm(),c=Ct(Dt.localOption().mode),u=Ct(Dt.localOption().level),g=je(()=>c.value),m=je(()=>u.value),w=je(()=>u.value===15&&c.value==="words");function k(I){c.value=I,Dt.saveLocalOption({mode:c.value,level:u.value}),s.setNewTest(),n.push("/test")}function P(I){u.value=I,Dt.saveLocalOption({mode:c.value,level:u.value}),s.setNewTest(),n.push("/test")}return{getTestLevel:m,getTestMode:g,setTestMode:k,setTestLevel:P,getIsOnMinWords:w}}),Bm="modulepreload",Wm=function(s){return"/"+s},Rl={},Pa=function(n,c,u){return!c||c.length===0?n():Promise.all(c.map(g=>{if(g=Wm(g),g in Rl)return;Rl[g]=!0;const m=g.endsWith(".css"),w=m?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${g}"]${w}`))return;const k=document.createElement("link");if(k.rel=m?"stylesheet":Bm,m||(k.as="script",k.crossOrigin=""),k.href=g,document.head.appendChild(k),m)return new Promise((P,I)=>{k.addEventListener("load",P),k.addEventListener("error",()=>I(new Error(`Unable to preload CSS for ${g}`)))})})).then(()=>n())},ho=Cm({history:Hx("/"),routes:[{path:"/",name:"Home",component:()=>Pa(()=>import("./Home.672758dc.js"),["assets/Home.672758dc.js","assets/Home.b7d65467.css"])},{path:"/test",name:"Test",component:()=>Pa(()=>import("./Test.57298223.js"),["assets/Test.57298223.js","assets/Test.a00cd2ef.css"])},{path:"/testResult",name:"test result",component:()=>Pa(()=>import("./TestResult.969674de.js"),["assets/TestResult.969674de.js","assets/TestResult.029019c6.css"])},{path:"/profile",name:"profile",component:()=>Pa(()=>import("./Profile.aeee0ecb.js"),["assets/Profile.aeee0ecb.js","assets/Profile.e2c7da0b.css"])}]});var pu={exports:{}},uo={exports:{}},xu=function(n,c){return function(){for(var g=new Array(arguments.length),m=0;m<g.length;m++)g[m]=arguments[m];return n.apply(c,g)}},Vm=xu,fo=Object.prototype.toString,go=function(s){return function(n){var c=fo.call(n);return s[c]||(s[c]=c.slice(8,-1).toLowerCase())}}(Object.create(null));function Qi(s){return s=s.toLowerCase(),function(c){return go(c)===s}}function po(s){return Array.isArray(s)}function qa(s){return typeof s>"u"}function jm(s){return s!==null&&!qa(s)&&s.constructor!==null&&!qa(s.constructor)&&typeof s.constructor.isBuffer=="function"&&s.constructor.isBuffer(s)}var mu=Qi("ArrayBuffer");function Gm(s){var n;return typeof ArrayBuffer<"u"&&ArrayBuffer.isView?n=ArrayBuffer.isView(s):n=s&&s.buffer&&mu(s.buffer),n}function Um(s){return typeof s=="string"}function $m(s){return typeof s=="number"}function bu(s){return s!==null&&typeof s=="object"}function Oa(s){if(go(s)!=="object")return!1;var n=Object.getPrototypeOf(s);return n===null||n===Object.prototype}var qm=Qi("Date"),Zm=Qi("File"),Km=Qi("Blob"),Jm=Qi("FileList");function xo(s){return fo.call(s)==="[object Function]"}function Qm(s){return bu(s)&&xo(s.pipe)}function eb(s){var n="[object FormData]";return s&&(typeof FormData=="function"&&s instanceof FormData||fo.call(s)===n||xo(s.toString)&&s.toString()===n)}var tb=Qi("URLSearchParams");function ib(s){return s.trim?s.trim():s.replace(/^\s+|\s+$/g,"")}function sb(){return typeof navigator<"u"&&(navigator.product==="ReactNative"||navigator.product==="NativeScript"||navigator.product==="NS")?!1:typeof window<"u"&&typeof document<"u"}function mo(s,n){if(!(s===null||typeof s>"u"))if(typeof s!="object"&&(s=[s]),po(s))for(var c=0,u=s.length;c<u;c++)n.call(null,s[c],c,s);else for(var g in s)Object.prototype.hasOwnProperty.call(s,g)&&n.call(null,s[g],g,s)}function In(){var s={};function n(g,m){Oa(s[m])&&Oa(g)?s[m]=In(s[m],g):Oa(g)?s[m]=In({},g):po(g)?s[m]=g.slice():s[m]=g}for(var c=0,u=arguments.length;c<u;c++)mo(arguments[c],n);return s}function ab(s,n,c){return mo(n,function(g,m){c&&typeof g=="function"?s[m]=Vm(g,c):s[m]=g}),s}function rb(s){return s.charCodeAt(0)===65279&&(s=s.slice(1)),s}function nb(s,n,c,u){s.prototype=Object.create(n.prototype,u),s.prototype.constructor=s,c&&Object.assign(s.prototype,c)}function ob(s,n,c){var u,g,m,w={};n=n||{};do{for(u=Object.getOwnPropertyNames(s),g=u.length;g-- >0;)m=u[g],w[m]||(n[m]=s[m],w[m]=!0);s=Object.getPrototypeOf(s)}while(s&&(!c||c(s,n))&&s!==Object.prototype);return n}function lb(s,n,c){s=String(s),(c===void 0||c>s.length)&&(c=s.length),c-=n.length;var u=s.indexOf(n,c);return u!==-1&&u===c}function cb(s){if(!s)return null;var n=s.length;if(qa(n))return null;for(var c=new Array(n);n-- >0;)c[n]=s[n];return c}var hb=function(s){return function(n){return s&&n instanceof s}}(typeof Uint8Array<"u"&&Object.getPrototypeOf(Uint8Array)),dt={isArray:po,isArrayBuffer:mu,isBuffer:jm,isFormData:eb,isArrayBufferView:Gm,isString:Um,isNumber:$m,isObject:bu,isPlainObject:Oa,isUndefined:qa,isDate:qm,isFile:Zm,isBlob:Km,isFunction:xo,isStream:Qm,isURLSearchParams:tb,isStandardBrowserEnv:sb,forEach:mo,merge:In,extend:ab,trim:ib,stripBOM:rb,inherits:nb,toFlatObject:ob,kindOf:go,kindOfTest:Qi,endsWith:lb,toArray:cb,isTypedArray:hb,isFileList:Jm},ss=dt;function Ol(s){return encodeURIComponent(s).replace(/%3A/gi,":").replace(/%24/g,"$").replace(/%2C/gi,",").replace(/%20/g,"+").replace(/%5B/gi,"[").replace(/%5D/gi,"]")}var vu=function(n,c,u){if(!c)return n;var g;if(u)g=u(c);else if(ss.isURLSearchParams(c))g=c.toString();else{var m=[];ss.forEach(c,function(P,I){P===null||typeof P>"u"||(ss.isArray(P)?I=I+"[]":P=[P],ss.forEach(P,function(N){ss.isDate(N)?N=N.toISOString():ss.isObject(N)&&(N=JSON.stringify(N)),m.push(Ol(I)+"="+Ol(N))}))}),g=m.join("&")}if(g){var w=n.indexOf("#");w!==-1&&(n=n.slice(0,w)),n+=(n.indexOf("?")===-1?"?":"&")+g}return n},ub=dt;function yr(){this.handlers=[]}yr.prototype.use=function(n,c,u){return this.handlers.push({fulfilled:n,rejected:c,synchronous:u?u.synchronous:!1,runWhen:u?u.runWhen:null}),this.handlers.length-1};yr.prototype.eject=function(n){this.handlers[n]&&(this.handlers[n]=null)};yr.prototype.forEach=function(n){ub.forEach(this.handlers,function(u){u!==null&&n(u)})};var db=yr,fb=dt,gb=function(n,c){fb.forEach(n,function(g,m){m!==c&&m.toUpperCase()===c.toUpperCase()&&(n[c]=g,delete n[m])})},yu=dt;function As(s,n,c,u,g){Error.call(this),this.message=s,this.name="AxiosError",n&&(this.code=n),c&&(this.config=c),u&&(this.request=u),g&&(this.response=g)}yu.inherits(As,Error,{toJSON:function(){return{message:this.message,name:this.name,description:this.description,number:this.number,fileName:this.fileName,lineNumber:this.lineNumber,columnNumber:this.columnNumber,stack:this.stack,config:this.config,code:this.code,status:this.response&&this.response.status?this.response.status:null}}});var wu=As.prototype,ku={};["ERR_BAD_OPTION_VALUE","ERR_BAD_OPTION","ECONNABORTED","ETIMEDOUT","ERR_NETWORK","ERR_FR_TOO_MANY_REDIRECTS","ERR_DEPRECATED","ERR_BAD_RESPONSE","ERR_BAD_REQUEST","ERR_CANCELED"].forEach(function(s){ku[s]={value:s}});Object.defineProperties(As,ku);Object.defineProperty(wu,"isAxiosError",{value:!0});As.from=function(s,n,c,u,g,m){var w=Object.create(wu);return yu.toFlatObject(s,w,function(P){return P!==Error.prototype}),As.call(w,s.message,n,c,u,g),w.name=s.name,m&&Object.assign(w,m),w};var Cs=As,Au={silentJSONParsing:!0,forcedJSONParsing:!0,clarifyTimeoutError:!1},Ht=dt;function pb(s,n){n=n||new FormData;var c=[];function u(m){return m===null?"":Ht.isDate(m)?m.toISOString():Ht.isArrayBuffer(m)||Ht.isTypedArray(m)?typeof Blob=="function"?new Blob([m]):Buffer.from(m):m}function g(m,w){if(Ht.isPlainObject(m)||Ht.isArray(m)){if(c.indexOf(m)!==-1)throw Error("Circular reference detected in "+w);c.push(m),Ht.forEach(m,function(P,I){if(!Ht.isUndefined(P)){var O=w?w+"."+I:I,N;if(P&&!w&&typeof P=="object"){if(Ht.endsWith(I,"{}"))P=JSON.stringify(P);else if(Ht.endsWith(I,"[]")&&(N=Ht.toArray(P))){N.forEach(function(z){!Ht.isUndefined(z)&&n.append(O,u(z))});return}}g(P,O)}}),c.pop()}else n.append(w,u(m))}return g(s),n}var Su=pb,Yr,Fl;function xb(){if(Fl)return Yr;Fl=1;var s=Cs;return Yr=function(c,u,g){var m=g.config.validateStatus;!g.status||!m||m(g.status)?c(g):u(new s("Request failed with status code "+g.status,[s.ERR_BAD_REQUEST,s.ERR_BAD_RESPONSE][Math.floor(g.status/100)-4],g.config,g.request,g))},Yr}var Br,zl;function mb(){if(zl)return Br;zl=1;var s=dt;return Br=s.isStandardBrowserEnv()?function(){return{write:function(u,g,m,w,k,P){var I=[];I.push(u+"="+encodeURIComponent(g)),s.isNumber(m)&&I.push("expires="+new Date(m).toGMTString()),s.isString(w)&&I.push("path="+w),s.isString(k)&&I.push("domain="+k),P===!0&&I.push("secure"),document.cookie=I.join("; ")},read:function(u){var g=document.cookie.match(new RegExp("(^|;\\s*)("+u+")=([^;]*)"));return g?decodeURIComponent(g[3]):null},remove:function(u){this.write(u,"",Date.now()-864e5)}}}():function(){return{write:function(){},read:function(){return null},remove:function(){}}}(),Br}var bb=function(n){return/^([a-z][a-z\d+\-.]*:)?\/\//i.test(n)},vb=function(n,c){return c?n.replace(/\/+$/,"")+"/"+c.replace(/^\/+/,""):n},yb=bb,wb=vb,Cu=function(n,c){return n&&!yb(c)?wb(n,c):c},Wr,Nl;function kb(){if(Nl)return Wr;Nl=1;var s=dt,n=["age","authorization","content-length","content-type","etag","expires","from","host","if-modified-since","if-unmodified-since","last-modified","location","max-forwards","proxy-authorization","referer","retry-after","user-agent"];return Wr=function(u){var g={},m,w,k;return u&&s.forEach(u.split(`
`),function(I){if(k=I.indexOf(":"),m=s.trim(I.substr(0,k)).toLowerCase(),w=s.trim(I.substr(k+1)),m){if(g[m]&&n.indexOf(m)>=0)return;m==="set-cookie"?g[m]=(g[m]?g[m]:[]).concat([w]):g[m]=g[m]?g[m]+", "+w:w}}),g},Wr}var Vr,Dl;function Ab(){if(Dl)return Vr;Dl=1;var s=dt;return Vr=s.isStandardBrowserEnv()?function(){var c=/(msie|trident)/i.test(navigator.userAgent),u=document.createElement("a"),g;function m(w){var k=w;return c&&(u.setAttribute("href",k),k=u.href),u.setAttribute("href",k),{href:u.href,protocol:u.protocol?u.protocol.replace(/:$/,""):"",host:u.host,search:u.search?u.search.replace(/^\?/,""):"",hash:u.hash?u.hash.replace(/^#/,""):"",hostname:u.hostname,port:u.port,pathname:u.pathname.charAt(0)==="/"?u.pathname:"/"+u.pathname}}return g=m(window.location.href),function(k){var P=s.isString(k)?m(k):k;return P.protocol===g.protocol&&P.host===g.host}}():function(){return function(){return!0}}(),Vr}var jr,Xl;function wr(){if(Xl)return jr;Xl=1;var s=Cs,n=dt;function c(u){s.call(this,u==null?"canceled":u,s.ERR_CANCELED),this.name="CanceledError"}return n.inherits(c,s,{__CANCEL__:!0}),jr=c,jr}var Gr,Hl;function Sb(){return Hl||(Hl=1,Gr=function(n){var c=/^([-+\w]{1,25})(:?\/\/|:)/.exec(n);return c&&c[1]||""}),Gr}var Ur,Yl;function Bl(){if(Yl)return Ur;Yl=1;var s=dt,n=xb(),c=mb(),u=vu,g=Cu,m=kb(),w=Ab(),k=Au,P=Cs,I=wr(),O=Sb();return Ur=function(z){return new Promise(function(q,K){var J=z.data,V=z.headers,T=z.responseType,G;function Z(){z.cancelToken&&z.cancelToken.unsubscribe(G),z.signal&&z.signal.removeEventListener("abort",G)}s.isFormData(J)&&s.isStandardBrowserEnv()&&delete V["Content-Type"];var H=new XMLHttpRequest;if(z.auth){var ce=z.auth.username||"",Q=z.auth.password?unescape(encodeURIComponent(z.auth.password)):"";V.Authorization="Basic "+btoa(ce+":"+Q)}var ie=g(z.baseURL,z.url);H.open(z.method.toUpperCase(),u(ie,z.params,z.paramsSerializer),!0),H.timeout=z.timeout;function ne(){if(!!H){var se="getAllResponseHeaders"in H?m(H.getAllResponseHeaders()):null,ye=!T||T==="text"||T==="json"?H.responseText:H.response,ge={data:ye,status:H.status,statusText:H.statusText,headers:se,config:z,request:H};n(function(Le){q(Le),Z()},function(Le){K(Le),Z()},ge),H=null}}if("onloadend"in H?H.onloadend=ne:H.onreadystatechange=function(){!H||H.readyState!==4||H.status===0&&!(H.responseURL&&H.responseURL.indexOf("file:")===0)||setTimeout(ne)},H.onabort=function(){!H||(K(new P("Request aborted",P.ECONNABORTED,z,H)),H=null)},H.onerror=function(){K(new P("Network Error",P.ERR_NETWORK,z,H,H)),H=null},H.ontimeout=function(){var ye=z.timeout?"timeout of "+z.timeout+"ms exceeded":"timeout exceeded",ge=z.transitional||k;z.timeoutErrorMessage&&(ye=z.timeoutErrorMessage),K(new P(ye,ge.clarifyTimeoutError?P.ETIMEDOUT:P.ECONNABORTED,z,H)),H=null},s.isStandardBrowserEnv()){var ee=(z.withCredentials||w(ie))&&z.xsrfCookieName?c.read(z.xsrfCookieName):void 0;ee&&(V[z.xsrfHeaderName]=ee)}"setRequestHeader"in H&&s.forEach(V,function(ye,ge){typeof J>"u"&&ge.toLowerCase()==="content-type"?delete V[ge]:H.setRequestHeader(ge,ye)}),s.isUndefined(z.withCredentials)||(H.withCredentials=!!z.withCredentials),T&&T!=="json"&&(H.responseType=z.responseType),typeof z.onDownloadProgress=="function"&&H.addEventListener("progress",z.onDownloadProgress),typeof z.onUploadProgress=="function"&&H.upload&&H.upload.addEventListener("progress",z.onUploadProgress),(z.cancelToken||z.signal)&&(G=function(se){!H||(K(!se||se&&se.type?new I:se),H.abort(),H=null)},z.cancelToken&&z.cancelToken.subscribe(G),z.signal&&(z.signal.aborted?G():z.signal.addEventListener("abort",G))),J||(J=null);var le=O(ie);if(le&&["http","https","file"].indexOf(le)===-1){K(new P("Unsupported protocol "+le+":",P.ERR_BAD_REQUEST,z));return}H.send(J)})},Ur}var $r,Wl;function Cb(){return Wl||(Wl=1,$r=null),$r}var ot=dt,Vl=gb,jl=Cs,Eb=Au,Pb=Su,Tb={"Content-Type":"application/x-www-form-urlencoded"};function Gl(s,n){!ot.isUndefined(s)&&ot.isUndefined(s["Content-Type"])&&(s["Content-Type"]=n)}function Lb(){var s;return(typeof XMLHttpRequest<"u"||typeof process<"u"&&Object.prototype.toString.call(process)==="[object process]")&&(s=Bl()),s}function Mb(s,n,c){if(ot.isString(s))try{return(n||JSON.parse)(s),ot.trim(s)}catch(u){if(u.name!=="SyntaxError")throw u}return(c||JSON.stringify)(s)}var kr={transitional:Eb,adapter:Lb(),transformRequest:[function(n,c){if(Vl(c,"Accept"),Vl(c,"Content-Type"),ot.isFormData(n)||ot.isArrayBuffer(n)||ot.isBuffer(n)||ot.isStream(n)||ot.isFile(n)||ot.isBlob(n))return n;if(ot.isArrayBufferView(n))return n.buffer;if(ot.isURLSearchParams(n))return Gl(c,"application/x-www-form-urlencoded;charset=utf-8"),n.toString();var u=ot.isObject(n),g=c&&c["Content-Type"],m;if((m=ot.isFileList(n))||u&&g==="multipart/form-data"){var w=this.env&&this.env.FormData;return Pb(m?{"files[]":n}:n,w&&new w)}else if(u||g==="application/json")return Gl(c,"application/json"),Mb(n);return n}],transformResponse:[function(n){var c=this.transitional||kr.transitional,u=c&&c.silentJSONParsing,g=c&&c.forcedJSONParsing,m=!u&&this.responseType==="json";if(m||g&&ot.isString(n)&&n.length)try{return JSON.parse(n)}catch(w){if(m)throw w.name==="SyntaxError"?jl.from(w,jl.ERR_BAD_RESPONSE,this,null,this.response):w}return n}],timeout:0,xsrfCookieName:"XSRF-TOKEN",xsrfHeaderName:"X-XSRF-TOKEN",maxContentLength:-1,maxBodyLength:-1,env:{FormData:Cb()},validateStatus:function(n){return n>=200&&n<300},headers:{common:{Accept:"application/json, text/plain, */*"}}};ot.forEach(["delete","get","head"],function(n){kr.headers[n]={}});ot.forEach(["post","put","patch"],function(n){kr.headers[n]=ot.merge(Tb)});var bo=kr,_b=dt,Ib=bo,Rb=function(n,c,u){var g=this||Ib;return _b.forEach(u,function(w){n=w.call(g,n,c)}),n},qr,Ul;function Eu(){return Ul||(Ul=1,qr=function(n){return!!(n&&n.__CANCEL__)}),qr}var $l=dt,Zr=Rb,Ob=Eu(),Fb=bo,zb=wr();function Kr(s){if(s.cancelToken&&s.cancelToken.throwIfRequested(),s.signal&&s.signal.aborted)throw new zb}var Nb=function(n){Kr(n),n.headers=n.headers||{},n.data=Zr.call(n,n.data,n.headers,n.transformRequest),n.headers=$l.merge(n.headers.common||{},n.headers[n.method]||{},n.headers),$l.forEach(["delete","get","head","post","put","patch","common"],function(g){delete n.headers[g]});var c=n.adapter||Fb.adapter;return c(n).then(function(g){return Kr(n),g.data=Zr.call(n,g.data,g.headers,n.transformResponse),g},function(g){return Ob(g)||(Kr(n),g&&g.response&&(g.response.data=Zr.call(n,g.response.data,g.response.headers,n.transformResponse))),Promise.reject(g)})},Pt=dt,Pu=function(n,c){c=c||{};var u={};function g(O,N){return Pt.isPlainObject(O)&&Pt.isPlainObject(N)?Pt.merge(O,N):Pt.isPlainObject(N)?Pt.merge({},N):Pt.isArray(N)?N.slice():N}function m(O){if(Pt.isUndefined(c[O])){if(!Pt.isUndefined(n[O]))return g(void 0,n[O])}else return g(n[O],c[O])}function w(O){if(!Pt.isUndefined(c[O]))return g(void 0,c[O])}function k(O){if(Pt.isUndefined(c[O])){if(!Pt.isUndefined(n[O]))return g(void 0,n[O])}else return g(void 0,c[O])}function P(O){if(O in c)return g(n[O],c[O]);if(O in n)return g(void 0,n[O])}var I={url:w,method:w,data:w,baseURL:k,transformRequest:k,transformResponse:k,paramsSerializer:k,timeout:k,timeoutMessage:k,withCredentials:k,adapter:k,responseType:k,xsrfCookieName:k,xsrfHeaderName:k,onUploadProgress:k,onDownloadProgress:k,decompress:k,maxContentLength:k,maxBodyLength:k,beforeRedirect:k,transport:k,httpAgent:k,httpsAgent:k,cancelToken:k,socketPath:k,responseEncoding:k,validateStatus:P};return Pt.forEach(Object.keys(n).concat(Object.keys(c)),function(N){var z=I[N]||m,W=z(N);Pt.isUndefined(W)&&z!==P||(u[N]=W)}),u},Jr,ql;function Tu(){return ql||(ql=1,Jr={version:"0.27.2"}),Jr}var Db=Tu().version,yi=Cs,vo={};["object","boolean","number","function","string","symbol"].forEach(function(s,n){vo[s]=function(u){return typeof u===s||"a"+(n<1?"n ":" ")+s}});var Zl={};vo.transitional=function(n,c,u){function g(m,w){return"[Axios v"+Db+"] Transitional option '"+m+"'"+w+(u?". "+u:"")}return function(m,w,k){if(n===!1)throw new yi(g(w," has been removed"+(c?" in "+c:"")),yi.ERR_DEPRECATED);return c&&!Zl[w]&&(Zl[w]=!0,console.warn(g(w," has been deprecated since v"+c+" and will be removed in the near future"))),n?n(m,w,k):!0}};function Xb(s,n,c){if(typeof s!="object")throw new yi("options must be an object",yi.ERR_BAD_OPTION_VALUE);for(var u=Object.keys(s),g=u.length;g-- >0;){var m=u[g],w=n[m];if(w){var k=s[m],P=k===void 0||w(k,m,s);if(P!==!0)throw new yi("option "+m+" must be "+P,yi.ERR_BAD_OPTION_VALUE);continue}if(c!==!0)throw new yi("Unknown option "+m,yi.ERR_BAD_OPTION)}}var Hb={assertOptions:Xb,validators:vo},Lu=dt,Yb=vu,Kl=db,Jl=Nb,Ar=Pu,Bb=Cu,Mu=Hb,as=Mu.validators;function Ss(s){this.defaults=s,this.interceptors={request:new Kl,response:new Kl}}Ss.prototype.request=function(n,c){typeof n=="string"?(c=c||{},c.url=n):c=n||{},c=Ar(this.defaults,c),c.method?c.method=c.method.toLowerCase():this.defaults.method?c.method=this.defaults.method.toLowerCase():c.method="get";var u=c.transitional;u!==void 0&&Mu.assertOptions(u,{silentJSONParsing:as.transitional(as.boolean),forcedJSONParsing:as.transitional(as.boolean),clarifyTimeoutError:as.transitional(as.boolean)},!1);var g=[],m=!0;this.interceptors.request.forEach(function(W){typeof W.runWhen=="function"&&W.runWhen(c)===!1||(m=m&&W.synchronous,g.unshift(W.fulfilled,W.rejected))});var w=[];this.interceptors.response.forEach(function(W){w.push(W.fulfilled,W.rejected)});var k;if(!m){var P=[Jl,void 0];for(Array.prototype.unshift.apply(P,g),P=P.concat(w),k=Promise.resolve(c);P.length;)k=k.then(P.shift(),P.shift());return k}for(var I=c;g.length;){var O=g.shift(),N=g.shift();try{I=O(I)}catch(z){N(z);break}}try{k=Jl(I)}catch(z){return Promise.reject(z)}for(;w.length;)k=k.then(w.shift(),w.shift());return k};Ss.prototype.getUri=function(n){n=Ar(this.defaults,n);var c=Bb(n.baseURL,n.url);return Yb(c,n.params,n.paramsSerializer)};Lu.forEach(["delete","get","head","options"],function(n){Ss.prototype[n]=function(c,u){return this.request(Ar(u||{},{method:n,url:c,data:(u||{}).data}))}});Lu.forEach(["post","put","patch"],function(n){function c(u){return function(m,w,k){return this.request(Ar(k||{},{method:n,headers:u?{"Content-Type":"multipart/form-data"}:{},url:m,data:w}))}}Ss.prototype[n]=c(),Ss.prototype[n+"Form"]=c(!0)});var Wb=Ss,Qr,Ql;function Vb(){if(Ql)return Qr;Ql=1;var s=wr();function n(c){if(typeof c!="function")throw new TypeError("executor must be a function.");var u;this.promise=new Promise(function(w){u=w});var g=this;this.promise.then(function(m){if(!!g._listeners){var w,k=g._listeners.length;for(w=0;w<k;w++)g._listeners[w](m);g._listeners=null}}),this.promise.then=function(m){var w,k=new Promise(function(P){g.subscribe(P),w=P}).then(m);return k.cancel=function(){g.unsubscribe(w)},k},c(function(w){g.reason||(g.reason=new s(w),u(g.reason))})}return n.prototype.throwIfRequested=function(){if(this.reason)throw this.reason},n.prototype.subscribe=function(u){if(this.reason){u(this.reason);return}this._listeners?this._listeners.push(u):this._listeners=[u]},n.prototype.unsubscribe=function(u){if(!!this._listeners){var g=this._listeners.indexOf(u);g!==-1&&this._listeners.splice(g,1)}},n.source=function(){var u,g=new n(function(w){u=w});return{token:g,cancel:u}},Qr=n,Qr}var en,ec;function jb(){return ec||(ec=1,en=function(n){return function(u){return n.apply(null,u)}}),en}var tn,tc;function Gb(){if(tc)return tn;tc=1;var s=dt;return tn=function(c){return s.isObject(c)&&c.isAxiosError===!0},tn}var ic=dt,Ub=xu,Fa=Wb,$b=Pu,qb=bo;function _u(s){var n=new Fa(s),c=Ub(Fa.prototype.request,n);return ic.extend(c,Fa.prototype,n),ic.extend(c,n),c.create=function(g){return _u($b(s,g))},c}var Et=_u(qb);Et.Axios=Fa;Et.CanceledError=wr();Et.CancelToken=Vb();Et.isCancel=Eu();Et.VERSION=Tu().version;Et.toFormData=Su;Et.AxiosError=Cs;Et.Cancel=Et.CanceledError;Et.all=function(n){return Promise.all(n)};Et.spread=jb();Et.isAxiosError=Gb();uo.exports=Et;uo.exports.default=Et;(function(s){s.exports=uo.exports})(pu);const Es=eu(pu.exports);Es.defaults.withCredentials=!0;const da="http://localhost:3000/api/user",Ta={logout:Zb,login:Kb,signup:Jb,loginWithGoogle:Qb,getLoggedInUser:ev};async function Zb(){return Es.post(`${da}/logout`).then(({data:s})=>s)}async function Kb(s){return Es.post(`${da}/signin`,s,{withCredentials:!0}).then(({data:n})=>n)}async function Jb(s){return Es.post(`${da}/signup`,s,{withCredentials:!0}).then(({data:n})=>n)}async function Qb(){return Es.get(`${da}/google/login`,{withCredentials:!0}).then(({data:s})=>s)}async function ev(){try{const{data:s}=await Es.get(`${da}/current_user`,{withCredentials:!0});return s||null}catch(s){console.log("cant get current user",s)}}const Iu=ua("user",()=>{const s=Ct(null),n=je(()=>s.value);async function c(){s.value=await Ta.getLoggedInUser()}async function u(){window.open("http://localhost:3000/api/user/google/login")}async function g(k){s.value=await Ta.login(k)}async function m(k){await Ta.signup(k),document.location.reload()}async function w(){await Ta.logout()}return{user:s,getLoggedInUser:n,login:g,setLoggedInUser:c,loginWithGoogle:u,logout:w,signup:m}}),Ru=ua("theme",()=>{const s=Ct(c()),n=je(()=>s.value);function c(){const g=localStorage.getItem("AppTheme");return console.log(g),g||localStorage.setItem("AppTheme","dark"),g}function u(g){localStorage.setItem("AppTheme",g),s.value=g}return{isDark:s,getAppTheme:n,setTheme:u}}),tv={class:"header-contianer flex"},iv={class:"logo-and-nav flex"},sv={class:"nav flex"},av={key:0,class:"username"},rv={key:0,class:"test-options flex"},nv={class:"time-or-number-option test-option flex"},ov={class:"numbers-options test-option flex"},lv=["onClick"],cv=dr("Logout "),hv=li({__name:"Header",setup(s){const n=gu(),c=Iu(),u=Ru(),g=je(()=>u.getAppTheme),m=je(()=>c.getLoggedInUser),w=du(),k=je(()=>n.getTestMode),P=je(()=>n.getTestLevel);function I(K){typeof K=="string"?n.setTestMode(K):n.setTestLevel(K)}function O(){c.logout(),document.location.reload()}const N=je(()=>!!(w.name==="profile"&&c.getLoggedInUser));function z(K){ho.push(K)}const W=je(()=>({hidden:w.name==="Home"})),q=je(()=>{var J,V;return((J=m.value)==null?void 0:J.username[0].toUpperCase())+((V=m.value)==null?void 0:V.username.split(" ").slice(0,1).join().slice(1))});return(K,J)=>(Je(),ct("header",{class:qt([$e(W),"app-header"])},[qe("div",tv,[qe("nav",iv,[$e(g)==="light"?(Je(),Ti($e(Gp),{key:0,onClick:J[0]||(J[0]=V=>z("/")),class:"logo"})):(Je(),Ti($e(Kp),{key:1,onClick:J[1]||(J[1]=V=>z("/")),class:"logo"})),qe("div",sv,[ze($e(kx),{onClick:J[2]||(J[2]=V=>z("/test")),class:"nav-svg keyboard"}),ze($e(nx),{onClick:J[3]||(J[3]=V=>z("/leaderboard")),class:"nav-svg"}),ze($e(xx),{onClick:J[4]||(J[4]=V=>z("/settings")),class:"nav-svg"}),qe("div",{onClick:J[5]||(J[5]=V=>z("/profile")),class:"user-nav-link flex align-center"},[ze($e(ux),{class:"nav-svg"}),$e(m)?(Je(),ct("span",av,sn($e(q)),1)):dh("",!0)])])]),$e(N)?(Je(),ct("button",{key:1,onClick:O,class:"logout-btn flex"},[cv,ze($e(Jp),{class:"logout-svg"})])):(Je(),ct("div",rv,[qe("div",nv,[qe("h2",{class:qt(["txt-light",{"active-option":$e(k)==="time"}]),onClick:J[6]||(J[6]=V=>I("time"))},"time",2),qe("h2",{class:qt(["txt-light",{"active-option":$e(k)==="words"}]),onClick:J[7]||(J[7]=V=>I("words"))},"words",2)]),qe("div",ov,[(Je(),ct(st,null,qc(4,V=>qe("h2",{key:V,onClick:T=>I(V*15),class:qt(["txt-light",{"active-option":$e(P)===V*15}])},sn(V*15),11,lv)),64))])]))])],2))}});function uv(s,n){return Je(),ct("svg",{xmlns:"http://www.w3.org/2000/svg",fill:"none",viewBox:"0 0 24 24","stroke-width":"1.5",stroke:"currentColor","aria-hidden":"true"},[qe("path",{"stroke-linecap":"round","stroke-linejoin":"round",d:"M21.752 15.002A9.718 9.718 0 0118 15.75c-5.385 0-9.75-4.365-9.75-9.75 0-1.33.266-2.597.748-3.752A9.753 9.753 0 003 11.25C3 16.635 7.365 21 12.75 21a9.753 9.753 0 009.002-5.998z"})])}function dv(s,n){return Je(),ct("svg",{xmlns:"http://www.w3.org/2000/svg",fill:"none",viewBox:"0 0 24 24","stroke-width":"1.5",stroke:"currentColor","aria-hidden":"true"},[qe("path",{"stroke-linecap":"round","stroke-linejoin":"round",d:"M12 3v2.25m6.364.386l-1.591 1.591M21 12h-2.25m-.386 6.364l-1.591-1.591M12 18.75V21m-4.773-4.227l-1.591 1.591M5.25 12H3m4.227-4.773L5.636 5.636M15.75 12a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0z"})])}const fv=["checked"],gv={for:"switch"},pv=li({__name:"CustomToggleSwitch",setup(s){const n=Ru(),c=je(()=>n.getAppTheme);Ct(document.querySelector("body"));function u(){const g=c.value==="dark"?"light":"dark";n.setTheme(g)}return Rc(()=>{var g,m,w,k;console.log(c.value),c.value=="dark"?((g=document.querySelector("body"))==null||g.classList.remove("dark"),(m=document.querySelector("body"))==null||m.classList.add("light")):((w=document.querySelector("body"))==null||w.classList.remove("light"),(k=document.querySelector("body"))==null||k.classList.add("dark"))}),(g,m)=>(Je(),ct(st,null,[qe("input",{onChange:u,type:"checkbox",id:"switch",checked:$e(c)==="dark"},null,40,fv),qe("label",gv,[$e(c)!=="dark"?(Je(),Ti($e(uv),{key:0,class:"moon-svg"})):(Je(),Ti($e(dv),{key:1,class:"sun-svg"}))])],64))}});const xv=(s,n)=>{const c=s.__vccOpts||s;for(const[u,g]of n)c[u]=g;return c},mv=xv(pv,[["__scopeId","data-v-d3ec2b67"]]),bv=qe("div",{class:"set-goal"},[qe("h2",null,"here you will set the goal")],-1),vv={class:"main-footer flex"},yv=fr('<div class="footer-links flex"><div class="footer-link flex"><h2 class="txt-light">Linkedin</h2></div><div class="footer-link flex"><h2 class="txt-light">&lt;Code\\&gt;</h2></div></div>',1),wv=li({__name:"Footer",setup(s){const n=du(),c=je(()=>({hidden:n.name==="Home"}));return(u,g)=>(Je(),ct("section",{class:qt(["botton",$e(c)])},[bv,qe("footer",vv,[yv,ze(mv)])],2))}});const kv={class:"main-app"},Av=li({__name:"App",setup(s){return Ct(0),Iu().setLoggedInUser(),(c,u)=>{const g=Gc("RouterView");return Je(),ct("main",kv,[ze(hv),ze(g,null,{default:Js(({Component:m})=>[ze(mr,{name:"fade",mode:"out-in"},{default:Js(()=>[(Je(),Ti($c(m)))]),_:2},1024)]),_:1}),ze(wv)])}}});const Ou=Op(),Sr=Yh(Av);Ou.use(({store:s})=>{s.$router=Lt(ho)});Sr.use(Ou);Sr.use(ho);Sr.use(Yp);Sr.mount("#app");export{ja as A,Ti as B,fr as C,Iu as D,st as F,Yp as V,xv as _,ct as a,qe as b,je as c,li as d,$e as e,Pm as f,ze as g,fu as h,Is as i,ia as j,gu as k,Ct as l,ha as m,qt as n,Je as o,ca as p,dh as q,qc as r,ip as s,sn as t,Ru as u,Ii as v,Rc as w,Gc as x,dr as y,Af as z};
