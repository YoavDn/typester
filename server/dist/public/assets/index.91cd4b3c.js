(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const g of document.querySelectorAll('link[rel="modulepreload"]'))u(g);new MutationObserver(g=>{for(const m of g)if(m.type==="childList")for(const w of m.addedNodes)w.tagName==="LINK"&&w.rel==="modulepreload"&&u(w)}).observe(document,{childList:!0,subtree:!0});function c(g){const m={};return g.integrity&&(m.integrity=g.integrity),g.referrerpolicy&&(m.referrerPolicy=g.referrerpolicy),g.crossorigin==="use-credentials"?m.credentials="include":g.crossorigin==="anonymous"?m.credentials="omit":m.credentials="same-origin",m}function u(g){if(g.ep)return;g.ep=!0;const m=c(g);fetch(g.href,m)}})();function Za(s,n){const c=Object.create(null),u=s.split(",");for(let g=0;g<u.length;g++)c[u[g]]=!0;return n?g=>!!c[g.toLowerCase()]:g=>!!c[g]}const Gu="Infinity,undefined,NaN,isFinite,isNaN,parseFloat,parseInt,decodeURI,decodeURIComponent,encodeURI,encodeURIComponent,Math,Number,Date,Array,Object,Boolean,String,RegExp,Map,Set,JSON,Intl,BigInt",Uu=Za(Gu),$u="itemscope,allowfullscreen,formnovalidate,ismap,nomodule,novalidate,readonly",qu=Za($u);function sc(s){return!!s||s===""}function ia(s){if(ke(s)){const n={};for(let c=0;c<s.length;c++){const u=s[c],g=et(u)?Ju(u):ia(u);if(g)for(const m in g)n[m]=g[m]}return n}else{if(et(s))return s;if(it(s))return s}}const Zu=/;(?![^(]*\))/g,Ku=/:(.+)/;function Ju(s){const n={};return s.split(Zu).forEach(c=>{if(c){const u=c.split(Ku);u.length>1&&(n[u[0].trim()]=u[1].trim())}}),n}function qt(s){let n="";if(et(s))n=s;else if(ke(s))for(let c=0;c<s.length;c++){const u=qt(s[c]);u&&(n+=u+" ")}else if(it(s))for(const c in s)s[c]&&(n+=c+" ");return n.trim()}function Qu(s){if(!s)return null;let{class:n,style:c}=s;return n&&!et(n)&&(s.class=qt(n)),c&&(s.style=ia(c)),s}function ed(s,n){if(s.length!==n.length)return!1;let c=!0;for(let u=0;c&&u<s.length;u++)c=Ci(s[u],n[u]);return c}function Ci(s,n){if(s===n)return!0;let c=Po(s),u=Po(n);if(c||u)return c&&u?s.getTime()===n.getTime():!1;if(c=$s(s),u=$s(n),c||u)return s===n;if(c=ke(s),u=ke(n),c||u)return c&&u?ed(s,n):!1;if(c=it(s),u=it(n),c||u){if(!c||!u)return!1;const g=Object.keys(s).length,m=Object.keys(n).length;if(g!==m)return!1;for(const w in s){const k=s.hasOwnProperty(w),P=n.hasOwnProperty(w);if(k&&!P||!k&&P||!Ci(s[w],n[w]))return!1}}return String(s)===String(n)}function Ka(s,n){return s.findIndex(c=>Ci(c,n))}const tn=s=>et(s)?s:s==null?"":ke(s)||it(s)&&(s.toString===rc||!_e(s.toString))?JSON.stringify(s,ac,2):String(s),ac=(s,n)=>n&&n.__v_isRef?ac(s,n.value):us(n)?{[`Map(${n.size})`]:[...n.entries()].reduce((c,[u,g])=>(c[`${u} =>`]=g,c),{})}:qi(n)?{[`Set(${n.size})`]:[...n.values()]}:it(n)&&!ke(n)&&!nc(n)?String(n):n,Be={},hs=[],Vt=()=>{},td=()=>!1,id=/^on[^a-z]/,sa=s=>id.test(s),In=s=>s.startsWith("onUpdate:"),tt=Object.assign,Rn=(s,n)=>{const c=s.indexOf(n);c>-1&&s.splice(c,1)},sd=Object.prototype.hasOwnProperty,Ne=(s,n)=>sd.call(s,n),ke=Array.isArray,us=s=>aa(s)==="[object Map]",qi=s=>aa(s)==="[object Set]",Po=s=>aa(s)==="[object Date]",_e=s=>typeof s=="function",et=s=>typeof s=="string",$s=s=>typeof s=="symbol",it=s=>s!==null&&typeof s=="object",On=s=>it(s)&&_e(s.then)&&_e(s.catch),rc=Object.prototype.toString,aa=s=>rc.call(s),ad=s=>aa(s).slice(8,-1),nc=s=>aa(s)==="[object Object]",Fn=s=>et(s)&&s!=="NaN"&&s[0]!=="-"&&""+parseInt(s,10)===s,zs=Za(",key,ref,ref_for,ref_key,onVnodeBeforeMount,onVnodeMounted,onVnodeBeforeUpdate,onVnodeUpdated,onVnodeBeforeUnmount,onVnodeUnmounted"),Ja=s=>{const n=Object.create(null);return c=>n[c]||(n[c]=s(c))},rd=/-(\w)/g,Ot=Ja(s=>s.replace(rd,(n,c)=>c?c.toUpperCase():"")),nd=/\B([A-Z])/g,Zt=Ja(s=>s.replace(nd,"-$1").toLowerCase()),ra=Ja(s=>s.charAt(0).toUpperCase()+s.slice(1)),Ns=Ja(s=>s?`on${ra(s)}`:""),gs=(s,n)=>!Object.is(s,n),ds=(s,n)=>{for(let c=0;c<s.length;c++)s[c](n)},za=(s,n,c)=>{Object.defineProperty(s,n,{configurable:!0,enumerable:!1,value:c})},Ei=s=>{const n=parseFloat(s);return isNaN(n)?s:n};let To;const od=()=>To||(To=typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{});let Tt;class zn{constructor(n=!1){this.active=!0,this.effects=[],this.cleanups=[],!n&&Tt&&(this.parent=Tt,this.index=(Tt.scopes||(Tt.scopes=[])).push(this)-1)}run(n){if(this.active){const c=Tt;try{return Tt=this,n()}finally{Tt=c}}}on(){Tt=this}off(){Tt=this.parent}stop(n){if(this.active){let c,u;for(c=0,u=this.effects.length;c<u;c++)this.effects[c].stop();for(c=0,u=this.cleanups.length;c<u;c++)this.cleanups[c]();if(this.scopes)for(c=0,u=this.scopes.length;c<u;c++)this.scopes[c].stop(!0);if(this.parent&&!n){const g=this.parent.scopes.pop();g&&g!==this&&(this.parent.scopes[this.index]=g,g.index=this.index)}this.active=!1}}}function Nn(s){return new zn(s)}function oc(s,n=Tt){n&&n.active&&n.effects.push(s)}function ld(){return Tt}function cd(s){Tt&&Tt.cleanups.push(s)}const Dn=s=>{const n=new Set(s);return n.w=0,n.n=0,n},lc=s=>(s.w&Pi)>0,cc=s=>(s.n&Pi)>0,hd=({deps:s})=>{if(s.length)for(let n=0;n<s.length;n++)s[n].w|=Pi},ud=s=>{const{deps:n}=s;if(n.length){let c=0;for(let u=0;u<n.length;u++){const g=n[u];lc(g)&&!cc(g)?g.delete(s):n[c++]=g,g.w&=~Pi,g.n&=~Pi}n.length=c}},sn=new WeakMap;let Rs=0,Pi=1;const an=30;let Wt;const Wi=Symbol(""),rn=Symbol("");class na{constructor(n,c=null,u){this.fn=n,this.scheduler=c,this.active=!0,this.deps=[],this.parent=void 0,oc(this,u)}run(){if(!this.active)return this.fn();let n=Wt,c=ki;for(;n;){if(n===this)return;n=n.parent}try{return this.parent=Wt,Wt=this,ki=!0,Pi=1<<++Rs,Rs<=an?hd(this):Lo(this),this.fn()}finally{Rs<=an&&ud(this),Pi=1<<--Rs,Wt=this.parent,ki=c,this.parent=void 0,this.deferStop&&this.stop()}}stop(){Wt===this?this.deferStop=!0:this.active&&(Lo(this),this.onStop&&this.onStop(),this.active=!1)}}function Lo(s){const{deps:n}=s;if(n.length){for(let c=0;c<n.length;c++)n[c].delete(s);n.length=0}}function dd(s,n){s.effect&&(s=s.effect.fn);const c=new na(s);n&&(tt(c,n),n.scope&&oc(c,n.scope)),(!n||!n.lazy)&&c.run();const u=c.run.bind(c);return u.effect=c,u}function fd(s){s.effect.stop()}let ki=!0;const hc=[];function Zi(){hc.push(ki),ki=!1}function Ki(){const s=hc.pop();ki=s===void 0?!0:s}function Ft(s,n,c){if(ki&&Wt){let u=sn.get(s);u||sn.set(s,u=new Map);let g=u.get(c);g||u.set(c,g=Dn()),uc(g)}}function uc(s,n){let c=!1;Rs<=an?cc(s)||(s.n|=Pi,c=!lc(s)):c=!s.has(Wt),c&&(s.add(Wt),Wt.deps.push(s))}function oi(s,n,c,u,g,m){const w=sn.get(s);if(!w)return;let k=[];if(n==="clear")k=[...w.values()];else if(c==="length"&&ke(s))w.forEach((P,I)=>{(I==="length"||I>=u)&&k.push(P)});else switch(c!==void 0&&k.push(w.get(c)),n){case"add":ke(s)?Fn(c)&&k.push(w.get("length")):(k.push(w.get(Wi)),us(s)&&k.push(w.get(rn)));break;case"delete":ke(s)||(k.push(w.get(Wi)),us(s)&&k.push(w.get(rn)));break;case"set":us(s)&&k.push(w.get(Wi));break}if(k.length===1)k[0]&&nn(k[0]);else{const P=[];for(const I of k)I&&P.push(...I);nn(Dn(P))}}function nn(s,n){const c=ke(s)?s:[...s];for(const u of c)u.computed&&Mo(u);for(const u of c)u.computed||Mo(u)}function Mo(s,n){(s!==Wt||s.allowRecurse)&&(s.scheduler?s.scheduler():s.run())}const gd=Za("__proto__,__v_isRef,__isVue"),dc=new Set(Object.getOwnPropertyNames(Symbol).filter(s=>s!=="arguments"&&s!=="caller").map(s=>Symbol[s]).filter($s)),pd=Qa(),xd=Qa(!1,!0),md=Qa(!0),bd=Qa(!0,!0),_o=vd();function vd(){const s={};return["includes","indexOf","lastIndexOf"].forEach(n=>{s[n]=function(...c){const u=Ie(this);for(let m=0,w=this.length;m<w;m++)Ft(u,"get",m+"");const g=u[n](...c);return g===-1||g===!1?u[n](...c.map(Ie)):g}}),["push","pop","shift","unshift","splice"].forEach(n=>{s[n]=function(...c){Zi();const u=Ie(this)[n].apply(this,c);return Ki(),u}}),s}function Qa(s=!1,n=!1){return function(u,g,m){if(g==="__v_isReactive")return!s;if(g==="__v_isReadonly")return s;if(g==="__v_isShallow")return n;if(g==="__v_raw"&&m===(s?n?vc:bc:n?mc:xc).get(u))return u;const w=ke(u);if(!s&&w&&Ne(_o,g))return Reflect.get(_o,g,m);const k=Reflect.get(u,g,m);return($s(g)?dc.has(g):gd(g))||(s||Ft(u,"get",g),n)?k:Qe(k)?w&&Fn(g)?k:k.value:it(k)?s?Hn(k):Ii(k):k}}const yd=fc(),wd=fc(!0);function fc(s=!1){return function(c,u,g,m){let w=c[u];if(ps(w)&&Qe(w)&&!Qe(g))return!1;if(!s&&!ps(g)&&(Na(g)||(g=Ie(g),w=Ie(w)),!ke(c)&&Qe(w)&&!Qe(g)))return w.value=g,!0;const k=ke(c)&&Fn(u)?Number(u)<c.length:Ne(c,u),P=Reflect.set(c,u,g,m);return c===Ie(m)&&(k?gs(g,w)&&oi(c,"set",u,g):oi(c,"add",u,g)),P}}function kd(s,n){const c=Ne(s,n);s[n];const u=Reflect.deleteProperty(s,n);return u&&c&&oi(s,"delete",n,void 0),u}function Ad(s,n){const c=Reflect.has(s,n);return(!$s(n)||!dc.has(n))&&Ft(s,"has",n),c}function Sd(s){return Ft(s,"iterate",ke(s)?"length":Wi),Reflect.ownKeys(s)}const gc={get:pd,set:yd,deleteProperty:kd,has:Ad,ownKeys:Sd},pc={get:md,set(s,n){return!0},deleteProperty(s,n){return!0}},Cd=tt({},gc,{get:xd,set:wd}),Ed=tt({},pc,{get:bd}),Xn=s=>s,er=s=>Reflect.getPrototypeOf(s);function pa(s,n,c=!1,u=!1){s=s.__v_raw;const g=Ie(s),m=Ie(n);c||(n!==m&&Ft(g,"get",n),Ft(g,"get",m));const{has:w}=er(g),k=u?Xn:c?Bn:qs;if(w.call(g,n))return k(s.get(n));if(w.call(g,m))return k(s.get(m));s!==g&&s.get(n)}function xa(s,n=!1){const c=this.__v_raw,u=Ie(c),g=Ie(s);return n||(s!==g&&Ft(u,"has",s),Ft(u,"has",g)),s===g?c.has(s):c.has(s)||c.has(g)}function ma(s,n=!1){return s=s.__v_raw,!n&&Ft(Ie(s),"iterate",Wi),Reflect.get(s,"size",s)}function Io(s){s=Ie(s);const n=Ie(this);return er(n).has.call(n,s)||(n.add(s),oi(n,"add",s,s)),this}function Ro(s,n){n=Ie(n);const c=Ie(this),{has:u,get:g}=er(c);let m=u.call(c,s);m||(s=Ie(s),m=u.call(c,s));const w=g.call(c,s);return c.set(s,n),m?gs(n,w)&&oi(c,"set",s,n):oi(c,"add",s,n),this}function Oo(s){const n=Ie(this),{has:c,get:u}=er(n);let g=c.call(n,s);g||(s=Ie(s),g=c.call(n,s)),u&&u.call(n,s);const m=n.delete(s);return g&&oi(n,"delete",s,void 0),m}function Fo(){const s=Ie(this),n=s.size!==0,c=s.clear();return n&&oi(s,"clear",void 0,void 0),c}function ba(s,n){return function(u,g){const m=this,w=m.__v_raw,k=Ie(w),P=n?Xn:s?Bn:qs;return!s&&Ft(k,"iterate",Wi),w.forEach((I,O)=>u.call(g,P(I),P(O),m))}}function va(s,n,c){return function(...u){const g=this.__v_raw,m=Ie(g),w=us(m),k=s==="entries"||s===Symbol.iterator&&w,P=s==="keys"&&w,I=g[s](...u),O=c?Xn:n?Bn:qs;return!n&&Ft(m,"iterate",P?rn:Wi),{next(){const{value:N,done:z}=I.next();return z?{value:N,done:z}:{value:k?[O(N[0]),O(N[1])]:O(N),done:z}},[Symbol.iterator](){return this}}}}function di(s){return function(...n){return s==="delete"?!1:this}}function Pd(){const s={get(m){return pa(this,m)},get size(){return ma(this)},has:xa,add:Io,set:Ro,delete:Oo,clear:Fo,forEach:ba(!1,!1)},n={get(m){return pa(this,m,!1,!0)},get size(){return ma(this)},has:xa,add:Io,set:Ro,delete:Oo,clear:Fo,forEach:ba(!1,!0)},c={get(m){return pa(this,m,!0)},get size(){return ma(this,!0)},has(m){return xa.call(this,m,!0)},add:di("add"),set:di("set"),delete:di("delete"),clear:di("clear"),forEach:ba(!0,!1)},u={get(m){return pa(this,m,!0,!0)},get size(){return ma(this,!0)},has(m){return xa.call(this,m,!0)},add:di("add"),set:di("set"),delete:di("delete"),clear:di("clear"),forEach:ba(!0,!0)};return["keys","values","entries",Symbol.iterator].forEach(m=>{s[m]=va(m,!1,!1),c[m]=va(m,!0,!1),n[m]=va(m,!1,!0),u[m]=va(m,!0,!0)}),[s,c,n,u]}const[Td,Ld,Md,_d]=Pd();function tr(s,n){const c=n?s?_d:Md:s?Ld:Td;return(u,g,m)=>g==="__v_isReactive"?!s:g==="__v_isReadonly"?s:g==="__v_raw"?u:Reflect.get(Ne(c,g)&&g in u?c:u,g,m)}const Id={get:tr(!1,!1)},Rd={get:tr(!1,!0)},Od={get:tr(!0,!1)},Fd={get:tr(!0,!0)},xc=new WeakMap,mc=new WeakMap,bc=new WeakMap,vc=new WeakMap;function zd(s){switch(s){case"Object":case"Array":return 1;case"Map":case"Set":case"WeakMap":case"WeakSet":return 2;default:return 0}}function Nd(s){return s.__v_skip||!Object.isExtensible(s)?0:zd(ad(s))}function Ii(s){return ps(s)?s:ir(s,!1,gc,Id,xc)}function yc(s){return ir(s,!1,Cd,Rd,mc)}function Hn(s){return ir(s,!0,pc,Od,bc)}function Dd(s){return ir(s,!0,Ed,Fd,vc)}function ir(s,n,c,u,g){if(!it(s)||s.__v_raw&&!(n&&s.__v_isReactive))return s;const m=g.get(s);if(m)return m;const w=Nd(s);if(w===0)return s;const k=new Proxy(s,w===2?u:c);return g.set(s,k),k}function Kt(s){return ps(s)?Kt(s.__v_raw):!!(s&&s.__v_isReactive)}function ps(s){return!!(s&&s.__v_isReadonly)}function Na(s){return!!(s&&s.__v_isShallow)}function Yn(s){return Kt(s)||ps(s)}function Ie(s){const n=s&&s.__v_raw;return n?Ie(n):s}function Lt(s){return za(s,"__v_skip",!0),s}const qs=s=>it(s)?Ii(s):s,Bn=s=>it(s)?Hn(s):s;function Wn(s){ki&&Wt&&(s=Ie(s),uc(s.dep||(s.dep=Dn())))}function sr(s,n){s=Ie(s),s.dep&&nn(s.dep)}function Qe(s){return!!(s&&s.__v_isRef===!0)}function Ct(s){return kc(s,!1)}function wc(s){return kc(s,!0)}function kc(s,n){return Qe(s)?s:new Xd(s,n)}class Xd{constructor(n,c){this.__v_isShallow=c,this.dep=void 0,this.__v_isRef=!0,this._rawValue=c?n:Ie(n),this._value=c?n:qs(n)}get value(){return Wn(this),this._value}set value(n){n=this.__v_isShallow?n:Ie(n),gs(n,this._rawValue)&&(this._rawValue=n,this._value=this.__v_isShallow?n:qs(n),sr(this))}}function Hd(s){sr(s)}function Ge(s){return Qe(s)?s.value:s}const Yd={get:(s,n,c)=>Ge(Reflect.get(s,n,c)),set:(s,n,c,u)=>{const g=s[n];return Qe(g)&&!Qe(c)?(g.value=c,!0):Reflect.set(s,n,c,u)}};function Vn(s){return Kt(s)?s:new Proxy(s,Yd)}class Bd{constructor(n){this.dep=void 0,this.__v_isRef=!0;const{get:c,set:u}=n(()=>Wn(this),()=>sr(this));this._get=c,this._set=u}get value(){return this._get()}set value(n){this._set(n)}}function Wd(s){return new Bd(s)}function on(s){const n=ke(s)?new Array(s.length):{};for(const c in s)n[c]=Ds(s,c);return n}class Vd{constructor(n,c,u){this._object=n,this._key=c,this._defaultValue=u,this.__v_isRef=!0}get value(){const n=this._object[this._key];return n===void 0?this._defaultValue:n}set value(n){this._object[this._key]=n}}function Ds(s,n,c){const u=s[n];return Qe(u)?u:new Vd(s,n,c)}class jd{constructor(n,c,u,g){this._setter=c,this.dep=void 0,this.__v_isRef=!0,this._dirty=!0,this.effect=new na(n,()=>{this._dirty||(this._dirty=!0,sr(this))}),this.effect.computed=this,this.effect.active=this._cacheable=!g,this.__v_isReadonly=u}get value(){const n=Ie(this);return Wn(n),(n._dirty||!n._cacheable)&&(n._dirty=!1,n._value=n.effect.run()),n._value}set value(n){this._setter(n)}}function Gd(s,n,c=!1){let u,g;const m=_e(s);return m?(u=s,g=Vt):(u=s.get,g=s.set),new jd(u,g,m||!g,c)}const Xs=[];function Ac(s,...n){Zi();const c=Xs.length?Xs[Xs.length-1].component:null,u=c&&c.appContext.config.warnHandler,g=Ud();if(u)Jt(u,c,11,[s+n.join(""),c&&c.proxy,g.map(({vnode:m})=>`at <${vh(c,m.type)}>`).join(`
...
yourself
youth
zone`,$a={checkTestEnd:Mm,countTypos:Im,calcWpm:_m};function Mm(s,n,c){return!(c-1!==s.currWord.idx||s.currLatter.idx!==s.currWord.str.length-1||!n)}function _m(s,n,c){const g=n/5/(c/60)-s/c/60;return Math.round(g)}function Im(s){return s.latters.reduce((n,c)=>(c.isCorrect===!1&&n++,n),0)}const Dt={generateNewTest:Fm,retest:zm,countAllTypos:Bm,calcWordWpm:Ym,calcTestWpm:Hm,saveTestToLocalStorage:Xm,localOption:Rm,saveLocalOption:Om};function Rm(){const s=localStorage.getItem("testOptions");return s?JSON.parse(s):(localStorage.setItem("testOptions",JSON.stringify({mode:"time",level:15})),{mode:"time",level:15})}function Om(s){localStorage.setItem("testOptions",JSON.stringify(s))}function Fm(s="english"){const n=Nm().map(u=>({word:u,isCorrect:null,wpm:0,typeCount:0,time:0,latters:u.split("").map(g=>({latter:g,isCorrect:null}))}));return{currLatter:{idx:0,str:n[0].latters[0].latter},currWord:{idx:0,str:n[0].word},time:0,typoCount:0,sumType:0,acc:0,realAcc:0,wpm:0,txt:n}}function zm(s){const n={...s};return n.currLatter={idx:0,str:n.txt[0].latters[0].latter},n.currWord={idx:0,str:n.txt[0].word},n.typoCount=0,n.sumType=0,n.txt=Dm(s.txt),n}function Nm(s="english"){return Lm.split(`
`).sort(()=>Math.random()-.5).slice(0,100)}function Dm(s){return s.map(n=>({word:n.word,typeCount:0,wpm:0,time:0,isCorrect:null,latters:n.word.split("").map(c=>({latter:c,isCorrect:null}))}))}function Xm(s){window.localStorage.setItem("test",JSON.stringify(s))}function Hm(s){const n=s.txt.map(({wpm:c})=>c).slice(0,s.currWord.idx).reduce((c,u)=>c+=u,0);return Math.round(n/s.currWord.idx)}function Ym(s){return s.txt.map((c,u)=>{let g=0;for(let m=0;m<u;m++)g+=$a.countTypos(s.txt[m]);return u<s.currWord.idx&&(c.wpm=$a.calcWpm(g,c.typeCount,c.time)),c})}function Bm(s){return s.txt.reduce((n,c)=>(n+=$a.countTypos(c),n),0)}async function Il(s,n){if(n===null)return null;const c=s.getBoundingClientRect(),u=n.getBoundingClientRect();return Ii({top:s.offsetTop-Math.round(s.clientHeight/5),bottom:c.bottom-u.bottom,right:c.right-u.right,left:c.left-u.left,leftEnd:c.left-u.left+c.width})}const Is=ua({id:"caret",state:()=>({caretPos:null,isLatterEnd:!1,currLineIdx:1,relativeTop:0,caretCurrWordIdx:0}),getters:{getCaretPos:({caretPos:s})=>s,getIslatterEnd:({isLatterEnd:s})=>s,getRelativeTop:({relativeTop:s})=>s,getCurrLineIdx:({currLineIdx:s})=>s},actions:{async updatedCaretPos(s,n){const c=fu();if(this.caretPos===null){this.caretPos=await Il(s,n);return}const{top:u,left:g,leftEnd:m,bottom:w}=await Il(s,n);u===this.caretPos.top?(this.caretPos.left=g,this.caretPos.leftEnd=m):(this.currLineIdx++,this.currLineIdx>=3&&(c.cutWordsToRender(),this.caretCurrWordIdx=0),this.caretPos.top=u,this.caretPos.left=g,this.caretPos.leftEnd=m,this.caretPos.bottom=w,this.relativeTop+=u)},setLatterEnd(s){this.isLatterEnd=s},resetCaret(){this.relativeTop=0,this.caretPos=null}}}),fu=ua({id:"test",state:()=>({test:Dt.generateNewTest(),isActive:!1,AFKtimeout:null,testTimeInterval:null,isNewTest:!1,wordsToCut:0}),getters:{getTest:({test:s})=>s,getIsNewTest:({isNewTest:s})=>s,getWordFromTxt:({test:s})=>s==null?void 0:s.txt[s.currWord.idx],getLatterFromTxt:({test:s})=>s==null?void 0:s.txt[s.currWord.idx].latters[s.currLatter.idx],getIsActiveTest:({isActive:s})=>s},actions:{cutWordsToRender(){this.wordsToCut=this.test.currWord.idx},loadTest(){this.test=Dt.generateNewTest()},setNewTest(){this.isNewTest=!0},activateTest(){this.isActive=!0,this.handleTime(!0)},newTest(){this.test=Dt.generateNewTest(),this.test.time=0,this.isNewTest=!1,this.handleTime(!1),this.$router.push("/test")},reloadTest(){this.test.time=0,this.handleTime(!1),this.test=Dt.retest(this.test)},setAFK(){this.isActive=!1,this.handleTime(!1)},handleTime(s){s?(this.isActive=!0,this.testTimeInterval=setInterval(()=>this.test.time+=.25,250)):(clearInterval(this.testTimeInterval),this.testTimeInterval=null)},finishTest(){console.log("finished Test !!"),this.handleTime(!1),this.test.txt=Dt.calcWordWpm(this.test),this.test.realAcc=Math.round(100-this.test.typoCount*100/this.test.sumType),this.test.acc=Math.round(100-Dt.countAllTypos(this.test)*100/this.test.sumType),this.test.wpm=Dt.calcTestWpm(this.test),Dt.saveTestToLocalStorage(this.test),this.$router.push("/testResult")},handleType(s){var m;if(this.test===null)return;const n=gu(),c=Is(),{currLatter:u,currWord:g}=this.test;if(this.test.txt[g.idx].latters[u.idx],this.isActive||this.handleTime(!0),n.getTestMode==="words"&&$a.checkTestEnd(this.test,c.getIslatterEnd,n.getTestLevel)){this.handleTime(!1),this.finishTest();return}this.test.sumType++,this.AFKtimeout!==null&&clearTimeout(this.AFKtimeout),this.AFKtimeout=setTimeout(()=>{this.setAFK()},3e3),s===((m=this.test)==null?void 0:m.currLatter.str)?u.str==="space"?this.setNextWord(!0):this.setLatterNewStatus(!0):(this.test.typoCount++,u.str==="space"?this.setNextWord(!1):this.setLatterNewStatus(!1))},finishWord(){const{currWord:s}=this.test;this.test.txt[s.idx].time=this.test.time,this.test.txt[s.idx].typeCount=this.test.sumType,this.test.txt[s.idx].latters.every(n=>n.isCorrect)?this.test.txt[s.idx].isCorrect=!0:this.test.txt[s.idx].isCorrect=!1},setNextWord(s){this.finishWord();const{currLatter:n,currWord:c}=this.test;Is().setLatterEnd(!1),c.idx++,c.str=this.test.txt[c.idx].word,n.idx=0,n.str=c.str[0]},setPrevWord(){const{currLatter:s,currWord:n}=this.test;Is().setLatterEnd(!0),n.idx--;const u=this.test.txt[n.idx];s.idx=u.latters.length-1,n.str=u.word,s.str=n.str[n.str.length-1]},setLatterNewStatus(s){const{currLatter:n,currWord:c}=this.test,u=Is();this.test.txt[c.idx].latters[n.idx].isCorrect=!!s,n.idx===c.str.length-1?(n.str="space",u.setLatterEnd(!0)):(n.idx++,n.str=c.str[n.idx])},hendleSpicialKeys(s){switch(s){case"Backspace":this.hendleBackspace();break;case"Escape":this.setAFK()}},hendleBackspace(){console.log("backspace");const{currWord:s,currLatter:n}=this.test,c=Is();n.idx===0&&s.idx===0||s.idx>1&&this.test.txt.slice(0,s.idx).every(g=>g.isCorrect)&&n.idx===0||(n.idx===0?this.setPrevWord():n.idx===s.str.length-1&&c.$state.isLatterEnd?(c.setLatterEnd(!1),n.str=s.str[s.str.length-1],this.test.txt[s.idx].latters[n.idx].isCorrect=null):(n.idx--,this.test.txt[s.idx].latters[n.idx].isCorrect=null,n.str=s.str[n.idx]))}}}),gu=ua("testPtions",()=>{const s=fu(),n=Tm(),c=Ct(Dt.localOption().mode),u=Ct(Dt.localOption().level),g=Ue(()=>c.value),m=Ue(()=>u.value),w=Ue(()=>u.value===15&&c.value==="words");function k(I){c.value=I,Dt.saveLocalOption({mode:c.value,level:u.value}),s.setNewTest(),n.push("/test")}function P(I){u.value=I,Dt.saveLocalOption({mode:c.value,level:u.value}),s.setNewTest(),n.push("/test")}return{getTestLevel:m,getTestMode:g,setTestMode:k,setTestLevel:P,getIsOnMinWords:w}});var pu={exports:{}},ho={exports:{}},xu=function(n,c){return function(){for(var g=new Array(arguments.length),m=0;m<g.length;m++)g[m]=arguments[m];return n.apply(c,g)}},Wm=xu,uo=Object.prototype.toString,fo=function(s){return function(n){var c=uo.call(n);return s[c]||(s[c]=c.slice(8,-1).toLowerCase())}}(Object.create(null));function Qi(s){return s=s.toLowerCase(),function(c){return fo(c)===s}}function go(s){return Array.isArray(s)}function qa(s){return typeof s>"u"}function Vm(s){return s!==null&&!qa(s)&&s.constructor!==null&&!qa(s.constructor)&&typeof s.constructor.isBuffer=="function"&&s.constructor.isBuffer(s)}var mu=Qi("ArrayBuffer");function jm(s){var n;return typeof ArrayBuffer<"u"&&ArrayBuffer.isView?n=ArrayBuffer.isView(s):n=s&&s.buffer&&mu(s.buffer),n}function Gm(s){return typeof s=="string"}function Um(s){return typeof s=="number"}function bu(s){return s!==null&&typeof s=="object"}function Oa(s){if(fo(s)!=="object")return!1;var n=Object.getPrototypeOf(s);return n===null||n===Object.prototype}var $m=Qi("Date"),qm=Qi("File"),Zm=Qi("Blob"),Km=Qi("FileList");function po(s){return uo.call(s)==="[object Function]"}function Jm(s){return bu(s)&&po(s.pipe)}function Qm(s){var n="[object FormData]";return s&&(typeof FormData=="function"&&s instanceof FormData||uo.call(s)===n||po(s.toString)&&s.toString()===n)}var eb=Qi("URLSearchParams");function tb(s){return s.trim?s.trim():s.replace(/^\s+|\s+$/g,"")}function ib(){return typeof navigator<"u"&&(navigator.product==="ReactNative"||navigator.product==="NativeScript"||navigator.product==="NS")?!1:typeof window<"u"&&typeof document<"u"}function xo(s,n){if(!(s===null||typeof s>"u"))if(typeof s!="object"&&(s=[s]),go(s))for(var c=0,u=s.length;c<u;c++)n.call(null,s[c],c,s);else for(var g in s)Object.prototype.hasOwnProperty.call(s,g)&&n.call(null,s[g],g,s)}function _n(){var s={};function n(g,m){Oa(s[m])&&Oa(g)?s[m]=_n(s[m],g):Oa(g)?s[m]=_n({},g):go(g)?s[m]=g.slice():s[m]=g}for(var c=0,u=arguments.length;c<u;c++)xo(arguments[c],n);return s}function sb(s,n,c){return xo(n,function(g,m){c&&typeof g=="function"?s[m]=Wm(g,c):s[m]=g}),s}function ab(s){return s.charCodeAt(0)===65279&&(s=s.slice(1)),s}function rb(s,n,c,u){s.prototype=Object.create(n.prototype,u),s.prototype.constructor=s,c&&Object.assign(s.prototype,c)}function nb(s,n,c){var u,g,m,w={};n=n||{};do{for(u=Object.getOwnPropertyNames(s),g=u.length;g-- >0;)m=u[g],w[m]||(n[m]=s[m],w[m]=!0);s=Object.getPrototypeOf(s)}while(s&&(!c||c(s,n))&&s!==Object.prototype);return n}function ob(s,n,c){s=String(s),(c===void 0||c>s.length)&&(c=s.length),c-=n.length;var u=s.indexOf(n,c);return u!==-1&&u===c}function lb(s){if(!s)return null;var n=s.length;if(qa(n))return null;for(var c=new Array(n);n-- >0;)c[n]=s[n];return c}var cb=function(s){return function(n){return s&&n instanceof s}}(typeof Uint8Array<"u"&&Object.getPrototypeOf(Uint8Array)),dt={isArray:go,isArrayBuffer:mu,isBuffer:Vm,isFormData:Qm,isArrayBufferView:jm,isString:Gm,isNumber:Um,isObject:bu,isPlainObject:Oa,isUndefined:qa,isDate:$m,isFile:qm,isBlob:Zm,isFunction:po,isStream:Jm,isURLSearchParams:eb,isStandardBrowserEnv:ib,forEach:xo,merge:_n,extend:sb,trim:tb,stripBOM:ab,inherits:rb,toFlatObject:nb,kindOf:fo,kindOfTest:Qi,endsWith:ob,toArray:lb,isTypedArray:cb,isFileList:Km},ss=dt;function Rl(s){return encodeURIComponent(s).replace(/%3A/gi,":").replace(/%24/g,"$").replace(/%2C/gi,",").replace(/%20/g,"+").replace(/%5B/gi,"[").replace(/%5D/gi,"]")}var vu=function(n,c,u){if(!c)return n;var g;if(u)g=u(c);else if(ss.isURLSearchParams(c))g=c.toString();else{var m=[];ss.forEach(c,function(P,I){P===null||typeof P>"u"||(ss.isArray(P)?I=I+"[]":P=[P],ss.forEach(P,function(N){ss.isDate(N)?N=N.toISOString():ss.isObject(N)&&(N=JSON.stringify(N)),m.push(Rl(I)+"="+Rl(N))}))}),g=m.join("&")}if(g){var w=n.indexOf("#");w!==-1&&(n=n.slice(0,w)),n+=(n.indexOf("?")===-1?"?":"&")+g}return n},hb=dt;function vr(){this.handlers=[]}vr.prototype.use=function(n,c,u){return this.handlers.push({fulfilled:n,rejected:c,synchronous:u?u.synchronous:!1,runWhen:u?u.runWhen:null}),this.handlers.length-1};vr.prototype.eject=function(n){this.handlers[n]&&(this.handlers[n]=null)};vr.prototype.forEach=function(n){hb.forEach(this.handlers,function(u){u!==null&&n(u)})};var ub=vr,db=dt,fb=function(n,c){db.forEach(n,function(g,m){m!==c&&m.toUpperCase()===c.toUpperCase()&&(n[c]=g,delete n[m])})},yu=dt;function As(s,n,c,u,g){Error.call(this),this.message=s,this.name="AxiosError",n&&(this.code=n),c&&(this.config=c),u&&(this.request=u),g&&(this.response=g)}yu.inherits(As,Error,{toJSON:function(){return{message:this.message,name:this.name,description:this.description,number:this.number,fileName:this.fileName,lineNumber:this.lineNumber,columnNumber:this.columnNumber,stack:this.stack,config:this.config,code:this.code,status:this.response&&this.response.status?this.response.status:null}}});var wu=As.prototype,ku={};["ERR_BAD_OPTION_VALUE","ERR_BAD_OPTION","ECONNABORTED","ETIMEDOUT","ERR_NETWORK","ERR_FR_TOO_MANY_REDIRECTS","ERR_DEPRECATED","ERR_BAD_RESPONSE","ERR_BAD_REQUEST","ERR_CANCELED"].forEach(function(s){ku[s]={value:s}});Object.defineProperties(As,ku);Object.defineProperty(wu,"isAxiosError",{value:!0});As.from=function(s,n,c,u,g,m){var w=Object.create(wu);return yu.toFlatObject(s,w,function(P){return P!==Error.prototype}),As.call(w,s.message,n,c,u,g),w.name=s.name,m&&Object.assign(w,m),w};var Cs=As,Au={silentJSONParsing:!0,forcedJSONParsing:!0,clarifyTimeoutError:!1},Ht=dt;function gb(s,n){n=n||new FormData;var c=[];function u(m){return m===null?"":Ht.isDate(m)?m.toISOString():Ht.isArrayBuffer(m)||Ht.isTypedArray(m)?typeof Blob=="function"?new Blob([m]):Buffer.from(m):m}function g(m,w){if(Ht.isPlainObject(m)||Ht.isArray(m)){if(c.indexOf(m)!==-1)throw Error("Circular reference detected in "+w);c.push(m),Ht.forEach(m,function(P,I){if(!Ht.isUndefined(P)){var O=w?w+"."+I:I,N;if(P&&!w&&typeof P=="object"){if(Ht.endsWith(I,"{}"))P=JSON.stringify(P);else if(Ht.endsWith(I,"[]")&&(N=Ht.toArray(P))){N.forEach(function(z){!Ht.isUndefined(z)&&n.append(O,u(z))});return}}g(P,O)}}),c.pop()}else n.append(w,u(m))}return g(s),n}var Su=gb,Hr,Ol;function pb(){if(Ol)return Hr;Ol=1;var s=Cs;return Hr=function(c,u,g){var m=g.config.validateStatus;!g.status||!m||m(g.status)?c(g):u(new s("Request failed with status code "+g.status,[s.ERR_BAD_REQUEST,s.ERR_BAD_RESPONSE][Math.floor(g.status/100)-4],g.config,g.request,g))},Hr}var Yr,Fl;function xb(){if(Fl)return Yr;Fl=1;var s=dt;return Yr=s.isStandardBrowserEnv()?function(){return{write:function(u,g,m,w,k,P){var I=[];I.push(u+"="+encodeURIComponent(g)),s.isNumber(m)&&I.push("expires="+new Date(m).toGMTString()),s.isString(w)&&I.push("path="+w),s.isString(k)&&I.push("domain="+k),P===!0&&I.push("secure"),document.cookie=I.join("; ")},read:function(u){var g=document.cookie.match(new RegExp("(^|;\\s*)("+u+")=([^;]*)"));return g?decodeURIComponent(g[3]):null},remove:function(u){this.write(u,"",Date.now()-864e5)}}}():function(){return{write:function(){},read:function(){return null},remove:function(){}}}(),Yr}var mb=function(n){return/^([a-z][a-z\d+\-.]*:)?\/\//i.test(n)},bb=function(n,c){return c?n.replace(/\/+$/,"")+"/"+c.replace(/^\/+/,""):n},vb=mb,yb=bb,Cu=function(n,c){return n&&!vb(c)?yb(n,c):c},Br,zl;function wb(){if(zl)return Br;zl=1;var s=dt,n=["age","authorization","content-length","content-type","etag","expires","from","host","if-modified-since","if-unmodified-since","last-modified","location","max-forwards","proxy-authorization","referer","retry-after","user-agent"];return Br=function(u){var g={},m,w,k;return u&&s.forEach(u.split(`
`),function(I){if(k=I.indexOf(":"),m=s.trim(I.substr(0,k)).toLowerCase(),w=s.trim(I.substr(k+1)),m){if(g[m]&&n.indexOf(m)>=0)return;m==="set-cookie"?g[m]=(g[m]?g[m]:[]).concat([w]):g[m]=g[m]?g[m]+", "+w:w}}),g},Br}var Wr,Nl;function kb(){if(Nl)return Wr;Nl=1;var s=dt;return Wr=s.isStandardBrowserEnv()?function(){var c=/(msie|trident)/i.test(navigator.userAgent),u=document.createElement("a"),g;function m(w){var k=w;return c&&(u.setAttribute("href",k),k=u.href),u.setAttribute("href",k),{href:u.href,protocol:u.protocol?u.protocol.replace(/:$/,""):"",host:u.host,search:u.search?u.search.replace(/^\?/,""):"",hash:u.hash?u.hash.replace(/^#/,""):"",hostname:u.hostname,port:u.port,pathname:u.pathname.charAt(0)==="/"?u.pathname:"/"+u.pathname}}return g=m(window.location.href),function(k){var P=s.isString(k)?m(k):k;return P.protocol===g.protocol&&P.host===g.host}}():function(){return function(){return!0}}(),Wr}var Vr,Dl;function yr(){if(Dl)return Vr;Dl=1;var s=Cs,n=dt;function c(u){s.call(this,u==null?"canceled":u,s.ERR_CANCELED),this.name="CanceledError"}return n.inherits(c,s,{__CANCEL__:!0}),Vr=c,Vr}var jr,Xl;function Ab(){return Xl||(Xl=1,jr=function(n){var c=/^([-+\w]{1,25})(:?\/\/|:)/.exec(n);return c&&c[1]||""}),jr}var Gr,Hl;function Yl(){if(Hl)return Gr;Hl=1;var s=dt,n=pb(),c=xb(),u=vu,g=Cu,m=wb(),w=kb(),k=Au,P=Cs,I=yr(),O=Ab();return Gr=function(z){return new Promise(function(q,K){var J=z.data,V=z.headers,T=z.responseType,G;function Z(){z.cancelToken&&z.cancelToken.unsubscribe(G),z.signal&&z.signal.removeEventListener("abort",G)}s.isFormData(J)&&s.isStandardBrowserEnv()&&delete V["Content-Type"];var H=new XMLHttpRequest;if(z.auth){var ce=z.auth.username||"",Q=z.auth.password?unescape(encodeURIComponent(z.auth.password)):"";V.Authorization="Basic "+btoa(ce+":"+Q)}var ie=g(z.baseURL,z.url);H.open(z.method.toUpperCase(),u(ie,z.params,z.paramsSerializer),!0),H.timeout=z.timeout;function ne(){if(!!H){var se="getAllResponseHeaders"in H?m(H.getAllResponseHeaders()):null,ye=!T||T==="text"||T==="json"?H.responseText:H.response,ge={data:ye,status:H.status,statusText:H.statusText,headers:se,config:z,request:H};n(function(Le){q(Le),Z()},function(Le){K(Le),Z()},ge),H=null}}if("onloadend"in H?H.onloadend=ne:H.onreadystatechange=function(){!H||H.readyState!==4||H.status===0&&!(H.responseURL&&H.responseURL.indexOf("file:")===0)||setTimeout(ne)},H.onabort=function(){!H||(K(new P("Request aborted",P.ECONNABORTED,z,H)),H=null)},H.onerror=function(){K(new P("Network Error",P.ERR_NETWORK,z,H,H)),H=null},H.ontimeout=function(){var ye=z.timeout?"timeout of "+z.timeout+"ms exceeded":"timeout exceeded",ge=z.transitional||k;z.timeoutErrorMessage&&(ye=z.timeoutErrorMessage),K(new P(ye,ge.clarifyTimeoutError?P.ETIMEDOUT:P.ECONNABORTED,z,H)),H=null},s.isStandardBrowserEnv()){var ee=(z.withCredentials||w(ie))&&z.xsrfCookieName?c.read(z.xsrfCookieName):void 0;ee&&(V[z.xsrfHeaderName]=ee)}"setRequestHeader"in H&&s.forEach(V,function(ye,ge){typeof J>"u"&&ge.toLowerCase()==="content-type"?delete V[ge]:H.setRequestHeader(ge,ye)}),s.isUndefined(z.withCredentials)||(H.withCredentials=!!z.withCredentials),T&&T!=="json"&&(H.responseType=z.responseType),typeof z.onDownloadProgress=="function"&&H.addEventListener("progress",z.onDownloadProgress),typeof z.onUploadProgress=="function"&&H.upload&&H.upload.addEventListener("progress",z.onUploadProgress),(z.cancelToken||z.signal)&&(G=function(se){!H||(K(!se||se&&se.type?new I:se),H.abort(),H=null)},z.cancelToken&&z.cancelToken.subscribe(G),z.signal&&(z.signal.aborted?G():z.signal.addEventListener("abort",G))),J||(J=null);var le=O(ie);if(le&&["http","https","file"].indexOf(le)===-1){K(new P("Unsupported protocol "+le+":",P.ERR_BAD_REQUEST,z));return}H.send(J)})},Gr}var Ur,Bl;function Sb(){return Bl||(Bl=1,Ur=null),Ur}var lt=dt,Wl=fb,Vl=Cs,Cb=Au,Eb=Su,Pb={"Content-Type":"application/x-www-form-urlencoded"};function jl(s,n){!lt.isUndefined(s)&&lt.isUndefined(s["Content-Type"])&&(s["Content-Type"]=n)}function Tb(){var s;return(typeof XMLHttpRequest<"u"||typeof process<"u"&&Object.prototype.toString.call(process)==="[object process]")&&(s=Yl()),s}function Lb(s,n,c){if(lt.isString(s))try{return(n||JSON.parse)(s),lt.trim(s)}catch(u){if(u.name!=="SyntaxError")throw u}return(c||JSON.stringify)(s)}var wr={transitional:Cb,adapter:Tb(),transformRequest:[function(n,c){if(Wl(c,"Accept"),Wl(c,"Content-Type"),lt.isFormData(n)||lt.isArrayBuffer(n)||lt.isBuffer(n)||lt.isStream(n)||lt.isFile(n)||lt.isBlob(n))return n;if(lt.isArrayBufferView(n))return n.buffer;if(lt.isURLSearchParams(n))return jl(c,"application/x-www-form-urlencoded;charset=utf-8"),n.toString();var u=lt.isObject(n),g=c&&c["Content-Type"],m;if((m=lt.isFileList(n))||u&&g==="multipart/form-data"){var w=this.env&&this.env.FormData;return Eb(m?{"files[]":n}:n,w&&new w)}else if(u||g==="application/json")return jl(c,"application/json"),Lb(n);return n}],transformResponse:[function(n){var c=this.transitional||wr.transitional,u=c&&c.silentJSONParsing,g=c&&c.forcedJSONParsing,m=!u&&this.responseType==="json";if(m||g&&lt.isString(n)&&n.length)try{return JSON.parse(n)}catch(w){if(m)throw w.name==="SyntaxError"?Vl.from(w,Vl.ERR_BAD_RESPONSE,this,null,this.response):w}return n}],timeout:0,xsrfCookieName:"XSRF-TOKEN",xsrfHeaderName:"X-XSRF-TOKEN",maxContentLength:-1,maxBodyLength:-1,env:{FormData:Sb()},validateStatus:function(n){return n>=200&&n<300},headers:{common:{Accept:"application/json, text/plain, */*"}}};lt.forEach(["delete","get","head"],function(n){wr.headers[n]={}});lt.forEach(["post","put","patch"],function(n){wr.headers[n]=lt.merge(Pb)});var mo=wr,Mb=dt,_b=mo,Ib=function(n,c,u){var g=this||_b;return Mb.forEach(u,function(w){n=w.call(g,n,c)}),n},$r,Gl;function Eu(){return Gl||(Gl=1,$r=function(n){return!!(n&&n.__CANCEL__)}),$r}var Ul=dt,qr=Ib,Rb=Eu(),Ob=mo,Fb=yr();function Zr(s){if(s.cancelToken&&s.cancelToken.throwIfRequested(),s.signal&&s.signal.aborted)throw new Fb}var zb=function(n){Zr(n),n.headers=n.headers||{},n.data=qr.call(n,n.data,n.headers,n.transformRequest),n.headers=Ul.merge(n.headers.common||{},n.headers[n.method]||{},n.headers),Ul.forEach(["delete","get","head","post","put","patch","common"],function(g){delete n.headers[g]});var c=n.adapter||Ob.adapter;return c(n).then(function(g){return Zr(n),g.data=qr.call(n,g.data,g.headers,n.transformResponse),g},function(g){return Rb(g)||(Zr(n),g&&g.response&&(g.response.data=qr.call(n,g.response.data,g.response.headers,n.transformResponse))),Promise.reject(g)})},Pt=dt,Pu=function(n,c){c=c||{};var u={};function g(O,N){return Pt.isPlainObject(O)&&Pt.isPlainObject(N)?Pt.merge(O,N):Pt.isPlainObject(N)?Pt.merge({},N):Pt.isArray(N)?N.slice():N}function m(O){if(Pt.isUndefined(c[O])){if(!Pt.isUndefined(n[O]))return g(void 0,n[O])}else return g(n[O],c[O])}function w(O){if(!Pt.isUndefined(c[O]))return g(void 0,c[O])}function k(O){if(Pt.isUndefined(c[O])){if(!Pt.isUndefined(n[O]))return g(void 0,n[O])}else return g(void 0,c[O])}function P(O){if(O in c)return g(n[O],c[O]);if(O in n)return g(void 0,n[O])}var I={url:w,method:w,data:w,baseURL:k,transformRequest:k,transformResponse:k,paramsSerializer:k,timeout:k,timeoutMessage:k,withCredentials:k,adapter:k,responseType:k,xsrfCookieName:k,xsrfHeaderName:k,onUploadProgress:k,onDownloadProgress:k,decompress:k,maxContentLength:k,maxBodyLength:k,beforeRedirect:k,transport:k,httpAgent:k,httpsAgent:k,cancelToken:k,socketPath:k,responseEncoding:k,validateStatus:P};return Pt.forEach(Object.keys(n).concat(Object.keys(c)),function(N){var z=I[N]||m,W=z(N);Pt.isUndefined(W)&&z!==P||(u[N]=W)}),u},Kr,$l;function Tu(){return $l||($l=1,Kr={version:"0.27.2"}),Kr}var Nb=Tu().version,yi=Cs,bo={};["object","boolean","number","function","string","symbol"].forEach(function(s,n){bo[s]=function(u){return typeof u===s||"a"+(n<1?"n ":" ")+s}});var ql={};bo.transitional=function(n,c,u){function g(m,w){return"[Axios v"+Nb+"] Transitional option '"+m+"'"+w+(u?". "+u:"")}return function(m,w,k){if(n===!1)throw new yi(g(w," has been removed"+(c?" in "+c:"")),yi.ERR_DEPRECATED);return c&&!ql[w]&&(ql[w]=!0,console.warn(g(w," has been deprecated since v"+c+" and will be removed in the near future"))),n?n(m,w,k):!0}};function Db(s,n,c){if(typeof s!="object")throw new yi("options must be an object",yi.ERR_BAD_OPTION_VALUE);for(var u=Object.keys(s),g=u.length;g-- >0;){var m=u[g],w=n[m];if(w){var k=s[m],P=k===void 0||w(k,m,s);if(P!==!0)throw new yi("option "+m+" must be "+P,yi.ERR_BAD_OPTION_VALUE);continue}if(c!==!0)throw new yi("Unknown option "+m,yi.ERR_BAD_OPTION)}}var Xb={assertOptions:Db,validators:bo},Lu=dt,Hb=vu,Zl=ub,Kl=zb,kr=Pu,Yb=Cu,Mu=Xb,as=Mu.validators;function Ss(s){this.defaults=s,this.interceptors={request:new Zl,response:new Zl}}Ss.prototype.request=function(n,c){typeof n=="string"?(c=c||{},c.url=n):c=n||{},c=kr(this.defaults,c),c.method?c.method=c.method.toLowerCase():this.defaults.method?c.method=this.defaults.method.toLowerCase():c.method="get";var u=c.transitional;u!==void 0&&Mu.assertOptions(u,{silentJSONParsing:as.transitional(as.boolean),forcedJSONParsing:as.transitional(as.boolean),clarifyTimeoutError:as.transitional(as.boolean)},!1);var g=[],m=!0;this.interceptors.request.forEach(function(W){typeof W.runWhen=="function"&&W.runWhen(c)===!1||(m=m&&W.synchronous,g.unshift(W.fulfilled,W.rejected))});var w=[];this.interceptors.response.forEach(function(W){w.push(W.fulfilled,W.rejected)});var k;if(!m){var P=[Kl,void 0];for(Array.prototype.unshift.apply(P,g),P=P.concat(w),k=Promise.resolve(c);P.length;)k=k.then(P.shift(),P.shift());return k}for(var I=c;g.length;){var O=g.shift(),N=g.shift();try{I=O(I)}catch(z){N(z);break}}try{k=Kl(I)}catch(z){return Promise.reject(z)}for(;w.length;)k=k.then(w.shift(),w.shift());return k};Ss.prototype.getUri=function(n){n=kr(this.defaults,n);var c=Yb(n.baseURL,n.url);return Hb(c,n.params,n.paramsSerializer)};Lu.forEach(["delete","get","head","options"],function(n){Ss.prototype[n]=function(c,u){return this.request(kr(u||{},{method:n,url:c,data:(u||{}).data}))}});Lu.forEach(["post","put","patch"],function(n){function c(u){return function(m,w,k){return this.request(kr(k||{},{method:n,headers:u?{"Content-Type":"multipart/form-data"}:{},url:m,data:w}))}}Ss.prototype[n]=c(),Ss.prototype[n+"Form"]=c(!0)});var Bb=Ss,Jr,Jl;function Wb(){if(Jl)return Jr;Jl=1;var s=yr();function n(c){if(typeof c!="function")throw new TypeError("executor must be a function.");var u;this.promise=new Promise(function(w){u=w});var g=this;this.promise.then(function(m){if(!!g._listeners){var w,k=g._listeners.length;for(w=0;w<k;w++)g._listeners[w](m);g._listeners=null}}),this.promise.then=function(m){var w,k=new Promise(function(P){g.subscribe(P),w=P}).then(m);return k.cancel=function(){g.unsubscribe(w)},k},c(function(w){g.reason||(g.reason=new s(w),u(g.reason))})}return n.prototype.throwIfRequested=function(){if(this.reason)throw this.reason},n.prototype.subscribe=function(u){if(this.reason){u(this.reason);return}this._listeners?this._listeners.push(u):this._listeners=[u]},n.prototype.unsubscribe=function(u){if(!!this._listeners){var g=this._listeners.indexOf(u);g!==-1&&this._listeners.splice(g,1)}},n.source=function(){var u,g=new n(function(w){u=w});return{token:g,cancel:u}},Jr=n,Jr}var Qr,Ql;function Vb(){return Ql||(Ql=1,Qr=function(n){return function(u){return n.apply(null,u)}}),Qr}var en,ec;function jb(){if(ec)return en;ec=1;var s=dt;return en=function(c){return s.isObject(c)&&c.isAxiosError===!0},en}var tc=dt,Gb=xu,Fa=Bb,Ub=Pu,$b=mo;function _u(s){var n=new Fa(s),c=Gb(Fa.prototype.request,n);return tc.extend(c,Fa.prototype,n),tc.extend(c,n),c.create=function(g){return _u(Ub(s,g))},c}var Et=_u($b);Et.Axios=Fa;Et.CanceledError=yr();Et.CancelToken=Wb();Et.isCancel=Eu();Et.VERSION=Tu().version;Et.toFormData=Su;Et.AxiosError=Cs;Et.Cancel=Et.CanceledError;Et.all=function(n){return Promise.all(n)};Et.spread=Vb();Et.isAxiosError=jb();ho.exports=Et;ho.exports.default=Et;(function(s){s.exports=ho.exports})(pu);const Es=eu(pu.exports);Es.defaults.withCredentials=!0;const da="/api/user",Pa={logout:qb,login:Zb,signup:Kb,loginWithGoogle:Jb,getLoggedInUser:Qb};async function qb(){return Es.post(`${da}/logout`).then(({data:s})=>s)}async function Zb(s){return Es.post(`${da}/signin`,s,{withCredentials:!0}).then(({data:n})=>n)}async function Kb(s){return Es.post(`${da}/signup`,s,{withCredentials:!0}).then(({data:n})=>n)}async function Jb(){return Es.get(`${da}/google/login`,{withCredentials:!0}).then(({data:s})=>s)}async function Qb(){try{const{data:s}=await Es.get(`${da}/current_user`,{withCredentials:!0});return s||null}catch(s){console.log("cant get current user",s)}}const Iu=ua("user",()=>{const s=Ct(null),n=Ue(()=>s.value);async function c(){s.value=await Pa.getLoggedInUser()}async function u(){window.open("http://localhost:3000/api/user/google/login")}async function g(k){s.value=await Pa.login(k)}async function m(k){await Pa.signup(k),document.location.reload()}async function w(){await Pa.logout()}return{user:s,getLoggedInUser:n,login:g,setLoggedInUser:c,loginWithGoogle:u,logout:w,signup:m}}),Ru=ua("theme",()=>{const s=Ct(c()),n=Ue(()=>s.value);function c(){const g=localStorage.getItem("AppTheme");return console.log(g),g||localStorage.setItem("AppTheme","dark"),g}function u(g){localStorage.setItem("AppTheme",g),s.value=g}return{isDark:s,getAppTheme:n,setTheme:u}}),ev="modulepreload",tv=function(s){return"/"+s},ic={},Ta=function(n,c,u){return!c||c.length===0?n():Promise.all(c.map(g=>{if(g=tv(g),g in ic)return;ic[g]=!0;const m=g.endsWith(".css"),w=m?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${g}"]${w}`))return;const k=document.createElement("link");if(k.rel=m?"stylesheet":ev,m||(k.as="script",k.crossOrigin=""),k.href=g,document.head.appendChild(k),m)return new Promise((P,I)=>{k.addEventListener("load",P),k.addEventListener("error",()=>I(new Error(`Unable to preload CSS for ${g}`)))})})).then(()=>n())},vo=Em({history:Yx("/"),routes:[{path:"/",name:"Home",component:()=>Ta(()=>import("./Home.cd0de348.js"),["assets/Home.cd0de348.js","assets/Home.b7d65467.css"])},{path:"/test",name:"Test",component:()=>Ta(()=>import("./Test.e21a3154.js"),["assets/Test.e21a3154.js","assets/Test.a00cd2ef.css"])},{path:"/testResult",name:"test result",component:()=>Ta(()=>import("./TestResult.58cb0e29.js"),["assets/TestResult.58cb0e29.js","assets/TestResult.029019c6.css"])},{path:"/profile",name:"profile",component:()=>Ta(()=>import("./Profile.6943471e.js"),["assets/Profile.6943471e.js","assets/Profile.6c0f8b18.css"])}]}),iv={class:"header-contianer flex"},sv={class:"logo-and-nav flex"},av={class:"nav flex"},rv={key:0,class:"username"},nv={key:0,class:"test-options flex"},ov={class:"time-or-number-option test-option flex"},lv={class:"numbers-options test-option flex"},cv=["onClick"],hv=dr("Logout "),uv=li({__name:"Header",setup(s){const n=gu(),c=Iu(),u=Ru(),g=Ue(()=>u.getAppTheme),m=Ue(()=>c.getLoggedInUser),w=du(),k=Ue(()=>n.getTestMode),P=Ue(()=>n.getTestLevel);function I(K){typeof K=="string"?n.setTestMode(K):n.setTestLevel(K)}function O(){c.logout(),document.location.reload()}const N=Ue(()=>!!(w.name==="profile"&&c.getLoggedInUser));function z(K){vo.push(K)}const W=Ue(()=>({hidden:w.name==="Home"})),q=Ue(()=>{var J,V;return((J=m.value)==null?void 0:J.username[0].toUpperCase())+((V=m.value)==null?void 0:V.username.split(" ").slice(0,1).join().slice(1))});return(K,J)=>(Ke(),at("header",{class:qt([Ge(W),"app-header"])},[De("div",iv,[De("nav",sv,[Ge(g)==="light"?(Ke(),Ti(Ge(Gp),{key:0,onClick:J[0]||(J[0]=V=>z("/")),class:"logo"})):(Ke(),Ti(Ge(Kp),{key:1,onClick:J[1]||(J[1]=V=>z("/")),class:"logo"})),De("div",av,[Fe(Ge(Ax),{onClick:J[2]||(J[2]=V=>z("/test")),class:"nav-svg keyboard"}),Fe(Ge(ox),{onClick:J[3]||(J[3]=V=>z("/leaderboard")),class:"nav-svg"}),Fe(Ge(mx),{onClick:J[4]||(J[4]=V=>z("/settings")),class:"nav-svg"}),De("div",{onClick:J[5]||(J[5]=V=>z("/profile")),class:"user-nav-link flex align-center"},[Fe(Ge(dx),{class:"nav-svg"}),Ge(m)?(Ke(),at("span",rv,tn(Ge(q)),1)):dh("",!0)])])]),Ge(N)?(Ke(),at("button",{key:1,onClick:O,class:"logout-btn flex"},[hv,Fe(Ge(Jp),{class:"logout-svg"})])):(Ke(),at("div",nv,[De("div",ov,[De("h2",{class:qt(["txt-light",{"active-option":Ge(k)==="time"}]),onClick:J[6]||(J[6]=V=>I("time"))},"time",2),De("h2",{class:qt(["txt-light",{"active-option":Ge(k)==="words"}]),onClick:J[7]||(J[7]=V=>I("words"))},"words",2)]),De("div",lv,[(Ke(),at(st,null,qc(4,V=>De("h2",{key:V,onClick:T=>I(V*15),class:qt(["txt-light",{"active-option":Ge(P)===V*15}])},tn(V*15),11,cv)),64))])]))])],2))}});function dv(s,n){return Ke(),at("svg",{xmlns:"http://www.w3.org/2000/svg",fill:"none",viewBox:"0 0 24 24","stroke-width":"1.5",stroke:"currentColor","aria-hidden":"true"},[De("path",{"stroke-linecap":"round","stroke-linejoin":"round",d:"M21.752 15.002A9.718 9.718 0 0118 15.75c-5.385 0-9.75-4.365-9.75-9.75 0-1.33.266-2.597.748-3.752A9.753 9.753 0 003 11.25C3 16.635 7.365 21 12.75 21a9.753 9.753 0 009.002-5.998z"})])}function fv(s,n){return Ke(),at("svg",{xmlns:"http://www.w3.org/2000/svg",fill:"none",viewBox:"0 0 24 24","stroke-width":"1.5",stroke:"currentColor","aria-hidden":"true"},[De("path",{"stroke-linecap":"round","stroke-linejoin":"round",d:"M12 3v2.25m6.364.386l-1.591 1.591M21 12h-2.25m-.386 6.364l-1.591-1.591M12 18.75V21m-4.773-4.227l-1.591 1.591M5.25 12H3m4.227-4.773L5.636 5.636M15.75 12a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0z"})])}const gv=["checked"],pv={for:"switch"},xv=li({__name:"CustomToggleSwitch",setup(s){const n=Ru(),c=Ue(()=>n.getAppTheme);Ct(document.querySelector("body"));function u(){const g=c.value==="dark"?"light":"dark";n.setTheme(g)}return Rc(()=>{var g,m,w,k;console.log(c.value),c.value=="dark"?((g=document.querySelector("body"))==null||g.classList.remove("dark"),(m=document.querySelector("body"))==null||m.classList.add("light")):((w=document.querySelector("body"))==null||w.classList.remove("light"),(k=document.querySelector("body"))==null||k.classList.add("dark"))}),(g,m)=>(Ke(),at(st,null,[De("input",{onChange:u,type:"checkbox",id:"switch",checked:Ge(c)==="dark"},null,40,gv),De("label",pv,[Ge(c)!=="dark"?(Ke(),Ti(Ge(dv),{key:0,class:"moon-svg"})):(Ke(),Ti(Ge(fv),{key:1,class:"sun-svg"}))])],64))}});const mv=(s,n)=>{const c=s.__vccOpts||s;for(const[u,g]of n)c[u]=g;return c},bv=mv(xv,[["__scopeId","data-v-d3ec2b67"]]),vv=De("div",{class:"set-goal"},null,-1),yv={class:"main-footer flex"},wv={class:"footer-links flex"},kv=De("h2",{class:"txt-light"},"Linkedin",-1),Av=[kv],Sv=De("h2",{class:"txt-light"},"code",-1),Cv=li({__name:"Footer",setup(s){const n=du(),c=Ue(()=>({hidden:n.name==="Home"}));function u(){window.open("https://github.com/YoavDn/typester")}function g(){window.open("https://www.linkedin.com/in/yoav-mendelson/")}return(m,w)=>(Ke(),at("section",{class:qt(["botton",Ge(c)])},[vv,De("footer",yv,[De("div",wv,[De("div",{onClick:g,class:"footer-link flex"},Av),De("div",{onClick:u,class:"footer-link flex align-center"},[Fe(Ge(Qp),{class:"code-svg"}),Sv])]),Fe(bv)])],2))}});const Ev={class:"main-app"},Pv=li({__name:"App",setup(s){return Ct(0),Iu().setLoggedInUser(),(c,u)=>{const g=Gc("RouterView");return Ke(),at("main",Ev,[Fe(uv),Fe(g,null,{default:Js(({Component:m})=>[Fe(xr,{name:"fade",mode:"out-in"},{default:Js(()=>[(Ke(),Ti($c(m)))]),_:2},1024)]),_:1}),Fe(Cv)])}}});const Ou=Op(),Ar=Yh(Pv);console.log("production");Ou.use(({store:s})=>{s.$router=Lt(vo)});Ar.use(Ou);Ar.use(vo);Ar.use(Yp);Ar.mount("#app");export{ja as A,Ti as B,io as C,Iu as D,st as F,Yp as V,mv as _,at as a,De as b,Ue as c,li as d,Ge as e,Tm as f,Fe as g,fu as h,Is as i,ia as j,gu as k,Ct as l,ha as m,qt as n,Ke as o,ca as p,dh as q,qc as r,ip as s,tn as t,Ru as u,Ii as v,Rc as w,Gc as x,dr as y,Af as z};
