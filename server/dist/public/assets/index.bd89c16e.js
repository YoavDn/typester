...
`).sort(()=>Math.random()-.5).slice(0,100)}function qx(s){return s.map(r=>({word:r.word,typeCount:0,wpm:0,wpmRaw:0,time:0,isCorrect:null,latters:r.word.split("").map(u=>({latter:u,isCorrect:null}))}))}function Zx(s){window.localStorage.setItem("test",JSON.stringify(s))}function Kx(s){const r=s.txt.map(({wpm:m})=>m).slice(0,s.currWord.idx).reduce((m,w)=>m+=w,0),u=s.txt.map(({wpmRaw:m})=>m).slice(0,s.currWord.idx).reduce((m,w)=>m+=w,0),h=Math.round(r/s.currWord.idx),g=Math.round(u/s.currWord.idx);return[h,g]}function Jx(s){return s.txt.map((u,h)=>{let g=0,m=0;for(let w=0;w<h;w++)g+=hs.countTypos(s.txt[w]),m+=hs.countCorrectChars(s.txt[w]);return h<s.currWord.idx&&(u.wpm=hs.calcWpm(m,h,u.time),u.wpmRaw=hs.calcWpmRaw(u.typeCount,h,u.time)),u})}function Qx(s){return s.txt.reduce((r,u)=>(r+=hs.countTypos(u),r),0)}var mh={exports:{}},ho={exports:{}},bh=function(r,u){return function(){for(var g=new Array(arguments.length),m=0;m<g.length;m++)g[m]=arguments[m];return r.apply(u,g)}},em=bh,fo=Object.prototype.toString,go=function(s){return function(r){var u=fo.call(r);return s[u]||(s[u]=u.slice(8,-1).toLowerCase())}}(Object.create(null));function es(s){return s=s.toLowerCase(),function(u){return go(u)===s}}function po(s){return Array.isArray(s)}function Za(s){return typeof s>"u"}function tm(s){return s!==null&&!Za(s)&&s.constructor!==null&&!Za(s.constructor)&&typeof s.constructor.isBuffer=="function"&&s.constructor.isBuffer(s)}var vh=es("ArrayBuffer");function im(s){var r;return typeof ArrayBuffer<"u"&&ArrayBuffer.isView?r=ArrayBuffer.isView(s):r=s&&s.buffer&&vh(s.buffer),r}function sm(s){return typeof s=="string"}function am(s){return typeof s=="number"}function yh(s){return s!==null&&typeof s=="object"}function Oa(s){if(go(s)!=="object")return!1;var r=Object.getPrototypeOf(s);return r===null||r===Object.prototype}var nm=es("Date"),rm=es("File"),om=es("Blob"),lm=es("FileList");function xo(s){return fo.call(s)==="[object Function]"}function um(s){return yh(s)&&xo(s.pipe)}function cm(s){var r="[object FormData]";return s&&(typeof FormData=="function"&&s instanceof FormData||fo.call(s)===r||xo(s.toString)&&s.toString()===r)}var hm=es("URLSearchParams");function dm(s){return s.trim?s.trim():s.replace(/^\s+|\s+$/g,"")}function fm(){return typeof navigator<"u"&&(navigator.product==="ReactNative"||navigator.product==="NativeScript"||navigator.product==="NS")?!1:typeof window<"u"&&typeof document<"u"}function mo(s,r){if(!(s===null||typeof s>"u"))if(typeof s!="object"&&(s=[s]),po(s))for(var u=0,h=s.length;u<h;u++)r.call(null,s[u],u,s);else for(var g in s)Object.prototype.hasOwnProperty.call(s,g)&&r.call(null,s[g],g,s)}function _r(){var s={};function r(g,m){Oa(s[m])&&Oa(g)?s[m]=_r(s[m],g):Oa(g)?s[m]=_r({},g):po(g)?s[m]=g.slice():s[m]=g}for(var u=0,h=arguments.length;u<h;u++)mo(arguments[u],r);return s}function gm(s,r,u){return mo(r,function(g,m){u&&typeof g=="function"?s[m]=em(g,u):s[m]=g}),s}function pm(s){return s.charCodeAt(0)===65279&&(s=s.slice(1)),s}function xm(s,r,u,h){s.prototype=Object.create(r.prototype,h),s.prototype.constructor=s,u&&Object.assign(s.prototype,u)}function mm(s,r,u){var h,g,m,w={};r=r||{};do{for(h=Object.getOwnPropertyNames(s),g=h.length;g-- >0;)m=h[g],w[m]||(r[m]=s[m],w[m]=!0);s=Object.getPrototypeOf(s)}while(s&&(!u||u(s,r))&&s!==Object.prototype);return r}function bm(s,r,u){s=String(s),(u===void 0||u>s.length)&&(u=s.length),u-=r.length;var h=s.indexOf(r,u);return h!==-1&&h===u}function vm(s){if(!s)return null;var r=s.length;if(Za(r))return null;for(var u=new Array(r);r-- >0;)u[r]=s[r];return u}var ym=function(s){return function(r){return s&&r instanceof s}}(typeof Uint8Array<"u"&&Object.getPrototypeOf(Uint8Array)),dt={isArray:po,isArrayBuffer:vh,isBuffer:tm,isFormData:cm,isArrayBufferView:im,isString:sm,isNumber:am,isObject:yh,isPlainObject:Oa,isUndefined:Za,isDate:nm,isFile:rm,isBlob:om,isFunction:xo,isStream:um,isURLSearchParams:hm,isStandardBrowserEnv:fm,forEach:mo,merge:_r,extend:gm,trim:dm,stripBOM:pm,inherits:xm,toFlatObject:mm,kindOf:go,kindOfTest:es,endsWith:bm,toArray:vm,isTypedArray:ym,isFileList:lm},as=dt;function Ol(s){return encodeURIComponent(s).replace(/%3A/gi,":").replace(/%24/g,"$").replace(/%2C/gi,",").replace(/%20/g,"+").replace(/%5B/gi,"[").replace(/%5D/gi,"]")}var wh=function(r,u,h){if(!u)return r;var g;if(h)g=h(u);else if(as.isURLSearchParams(u))g=u.toString();else{var m=[];as.forEach(u,function(S,_){S===null||typeof S>"u"||(as.isArray(S)?_=_+"[]":S=[S],as.forEach(S,function(z){as.isDate(z)?z=z.toISOString():as.isObject(z)&&(z=JSON.stringify(z)),m.push(Ol(_)+"="+Ol(z))}))}),g=m.join("&")}if(g){var w=r.indexOf("#");w!==-1&&(r=r.slice(0,w)),r+=(r.indexOf("?")===-1?"?":"&")+g}return r},wm=dt;function wn(){this.handlers=[]}wn.prototype.use=function(r,u,h){return this.handlers.push({fulfilled:r,rejected:u,synchronous:h?h.synchronous:!1,runWhen:h?h.runWhen:null}),this.handlers.length-1};wn.prototype.eject=function(r){this.handlers[r]&&(this.handlers[r]=null)};wn.prototype.forEach=function(r){wm.forEach(this.handlers,function(h){h!==null&&r(h)})};var Dm=wn,Em=dt,Cm=function(r,u){Em.forEach(r,function(g,m){m!==u&&m.toUpperCase()===u.toUpperCase()&&(r[u]=g,delete r[m])})},Dh=dt;function As(s,r,u,h,g){Error.call(this),this.message=s,this.name="AxiosError",r&&(this.code=r),u&&(this.config=u),h&&(this.request=h),g&&(this.response=g)}Dh.inherits(As,Error,{toJSON:function(){return{message:this.message,name:this.name,description:this.description,number:this.number,fileName:this.fileName,lineNumber:this.lineNumber,columnNumber:this.columnNumber,stack:this.stack,config:this.config,code:this.code,status:this.response&&this.response.status?this.response.status:null}}});var Eh=As.prototype,Ch={};["ERR_BAD_OPTION_VALUE","ERR_BAD_OPTION","ECONNABORTED","ETIMEDOUT","ERR_NETWORK","ERR_FR_TOO_MANY_REDIRECTS","ERR_DEPRECATED","ERR_BAD_RESPONSE","ERR_BAD_REQUEST","ERR_CANCELED"].forEach(function(s){Ch[s]={value:s}});Object.defineProperties(As,Ch);Object.defineProperty(Eh,"isAxiosError",{value:!0});As.from=function(s,r,u,h,g,m){var w=Object.create(Eh);return Dh.toFlatObject(s,w,function(S){return S!==Error.prototype}),As.call(w,s.message,r,u,h,g),w.name=s.name,m&&Object.assign(w,m),w};var Ss=As,Ah={silentJSONParsing:!0,forcedJSONParsing:!0,clarifyTimeoutError:!1},Ht=dt;function Am(s,r){r=r||new FormData;var u=[];function h(m){return m===null?"":Ht.isDate(m)?m.toISOString():Ht.isArrayBuffer(m)||Ht.isTypedArray(m)?typeof Blob=="function"?new Blob([m]):Buffer.from(m):m}function g(m,w){if(Ht.isPlainObject(m)||Ht.isArray(m)){if(u.indexOf(m)!==-1)throw Error("Circular reference detected in "+w);u.push(m),Ht.forEach(m,function(S,_){if(!Ht.isUndefined(S)){var F=w?w+"."+_:_,z;if(S&&!w&&typeof S=="object"){if(Ht.endsWith(_,"{}"))S=JSON.stringify(S);else if(Ht.endsWith(_,"[]")&&(z=Ht.toArray(S))){z.forEach(function(O){!Ht.isUndefined(O)&&r.append(F,h(O))});return}}g(S,F)}}),u.pop()}else r.append(w,h(m))}return g(s),r}var kh=Am,Yn,zl;function km(){if(zl)return Yn;zl=1;var s=Ss;return Yn=function(u,h,g){var m=g.config.validateStatus;!g.status||!m||m(g.status)?u(g):h(new s("Request failed with status code "+g.status,[s.ERR_BAD_REQUEST,s.ERR_BAD_RESPONSE][Math.floor(g.status/100)-4],g.config,g.request,g))},Yn}var Wn,Bl;function Sm(){if(Bl)return Wn;Bl=1;var s=dt;return Wn=s.isStandardBrowserEnv()?function(){return{write:function(h,g,m,w,D,S){var _=[];_.push(h+"="+encodeURIComponent(g)),s.isNumber(m)&&_.push("expires="+new Date(m).toGMTString()),s.isString(w)&&_.push("path="+w),s.isString(D)&&_.push("domain="+D),S===!0&&_.push("secure"),document.cookie=_.join("; ")},read:function(h){var g=document.cookie.match(new RegExp("(^|;\\s*)("+h+")=([^;]*)"));return g?decodeURIComponent(g[3]):null},remove:function(h){this.write(h,"",Date.now()-864e5)}}}():function(){return{write:function(){},read:function(){return null},remove:function(){}}}(),Wn}var Pm=function(r){return/^([a-z][a-z\d+\-.]*:)?\/\//i.test(r)},Tm=function(r,u){return u?r.replace(/\/+$/,"")+"/"+u.replace(/^\/+/,""):r},Lm=Pm,Mm=Tm,Sh=function(r,u){return r&&!Lm(u)?Mm(r,u):u},Vn,Nl;function _m(){if(Nl)return Vn;Nl=1;var s=dt,r=["age","authorization","content-length","content-type","etag","expires","from","host","if-modified-since","if-unmodified-since","last-modified","location","max-forwards","proxy-authorization","referer","retry-after","user-agent"];return Vn=function(h){var g={},m,w,D;return h&&s.forEach(h.split(`
`),function(_){if(D=_.indexOf(":"),m=s.trim(_.substr(0,D)).toLowerCase(),w=s.trim(_.substr(D+1)),m){if(g[m]&&r.indexOf(m)>=0)return;m==="set-cookie"?g[m]=(g[m]?g[m]:[]).concat([w]):g[m]=g[m]?g[m]+", "+w:w}}),g},Vn}var jn,Hl;function Im(){if(Hl)return jn;Hl=1;var s=dt;return jn=s.isStandardBrowserEnv()?function(){var u=/(msie|trident)/i.test(navigator.userAgent),h=document.createElement("a"),g;function m(w){var D=w;return u&&(h.setAttribute("href",D),D=h.href),h.setAttribute("href",D),{href:h.href,protocol:h.protocol?h.protocol.replace(/:$/,""):"",host:h.host,search:h.search?h.search.replace(/^\?/,""):"",hash:h.hash?h.hash.replace(/^#/,""):"",hostname:h.hostname,port:h.port,pathname:h.pathname.charAt(0)==="/"?h.pathname:"/"+h.pathname}}return g=m(window.location.href),function(D){var S=s.isString(D)?m(D):D;return S.protocol===g.protocol&&S.host===g.host}}():function(){return function(){return!0}}(),jn}var Gn,Xl;function Dn(){if(Xl)return Gn;Xl=1;var s=Ss,r=dt;function u(h){s.call(this,h==null?"canceled":h,s.ERR_CANCELED),this.name="CanceledError"}return r.inherits(u,s,{__CANCEL__:!0}),Gn=u,Gn}var Un,Yl;function Fm(){return Yl||(Yl=1,Un=function(r){var u=/^([-+\w]{1,25})(:?\/\/|:)/.exec(r);return u&&u[1]||""}),Un}var $n,Wl;function Vl(){if(Wl)return $n;Wl=1;var s=dt,r=km(),u=Sm(),h=wh,g=Sh,m=_m(),w=Im(),D=Ah,S=Ss,_=Dn(),F=Fm();return $n=function(O){return new Promise(function(q,K){var ee=O.data,V=O.headers,P=O.responseType,j;function Z(){O.cancelToken&&O.cancelToken.unsubscribe(j),O.signal&&O.signal.removeEventListener("abort",j)}s.isFormData(ee)&&s.isStandardBrowserEnv()&&delete V["Content-Type"];var H=new XMLHttpRequest;if(O.auth){var ue=O.auth.username||"",J=O.auth.password?unescape(encodeURIComponent(O.auth.password)):"";V.Authorization="Basic "+btoa(ue+":"+J)}var ie=g(O.baseURL,O.url);H.open(O.method.toUpperCase(),h(ie,O.params,O.paramsSerializer),!0),H.timeout=O.timeout;function re(){if(!!H){var se="getAllResponseHeaders"in H?m(H.getAllResponseHeaders()):null,ye=!P||P==="text"||P==="json"?H.responseText:H.response,ge={data:ye,status:H.status,statusText:H.statusText,headers:se,config:O,request:H};r(function(Te){q(Te),Z()},function(Te){K(Te),Z()},ge),H=null}}if("onloadend"in H?H.onloadend=re:H.onreadystatechange=function(){!H||H.readyState!==4||H.status===0&&!(H.responseURL&&H.responseURL.indexOf("file:")===0)||setTimeout(re)},H.onabort=function(){!H||(K(new S("Request aborted",S.ECONNABORTED,O,H)),H=null)},H.onerror=function(){K(new S("Network Error",S.ERR_NETWORK,O,H,H)),H=null},H.ontimeout=function(){var ye=O.timeout?"timeout of "+O.timeout+"ms exceeded":"timeout exceeded",ge=O.transitional||D;O.timeoutErrorMessage&&(ye=O.timeoutErrorMessage),K(new S(ye,ge.clarifyTimeoutError?S.ETIMEDOUT:S.ECONNABORTED,O,H)),H=null},s.isStandardBrowserEnv()){var Q=(O.withCredentials||w(ie))&&O.xsrfCookieName?u.read(O.xsrfCookieName):void 0;Q&&(V[O.xsrfHeaderName]=Q)}"setRequestHeader"in H&&s.forEach(V,function(ye,ge){typeof ee>"u"&&ge.toLowerCase()==="content-type"?delete V[ge]:H.setRequestHeader(ge,ye)}),s.isUndefined(O.withCredentials)||(H.withCredentials=!!O.withCredentials),P&&P!=="json"&&(H.responseType=O.responseType),typeof O.onDownloadProgress=="function"&&H.addEventListener("progress",O.onDownloadProgress),typeof O.onUploadProgress=="function"&&H.upload&&H.upload.addEventListener("progress",O.onUploadProgress),(O.cancelToken||O.signal)&&(j=function(se){!H||(K(!se||se&&se.type?new _:se),H.abort(),H=null)},O.cancelToken&&O.cancelToken.subscribe(j),O.signal&&(O.signal.aborted?j():O.signal.addEventListener("abort",j))),ee||(ee=null);var le=F(ie);if(le&&["http","https","file"].indexOf(le)===-1){K(new S("Unsupported protocol "+le+":",S.ERR_BAD_REQUEST,O));return}H.send(ee)})},$n}var qn,jl;function Rm(){return jl||(jl=1,qn=null),qn}var lt=dt,Gl=Cm,Ul=Ss,Om=Ah,zm=kh,Bm={"Content-Type":"application/x-www-form-urlencoded"};function $l(s,r){!lt.isUndefined(s)&&lt.isUndefined(s["Content-Type"])&&(s["Content-Type"]=r)}function Nm(){var s;return(typeof XMLHttpRequest<"u"||typeof process<"u"&&Object.prototype.toString.call(process)==="[object process]")&&(s=Vl()),s}function Hm(s,r,u){if(lt.isString(s))try{return(r||JSON.parse)(s),lt.trim(s)}catch(h){if(h.name!=="SyntaxError")throw h}return(u||JSON.stringify)(s)}var En={transitional:Om,adapter:Nm(),transformRequest:[function(r,u){if(Gl(u,"Accept"),Gl(u,"Content-Type"),lt.isFormData(r)||lt.isArrayBuffer(r)||lt.isBuffer(r)||lt.isStream(r)||lt.isFile(r)||lt.isBlob(r))return r;if(lt.isArrayBufferView(r))return r.buffer;if(lt.isURLSearchParams(r))return $l(u,"application/x-www-form-urlencoded;charset=utf-8"),r.toString();var h=lt.isObject(r),g=u&&u["Content-Type"],m;if((m=lt.isFileList(r))||h&&g==="multipart/form-data"){var w=this.env&&this.env.FormData;return zm(m?{"files[]":r}:r,w&&new w)}else if(h||g==="application/json")return $l(u,"application/json"),Hm(r);return r}],transformResponse:[function(r){var u=this.transitional||En.transitional,h=u&&u.silentJSONParsing,g=u&&u.forcedJSONParsing,m=!h&&this.responseType==="json";if(m||g&&lt.isString(r)&&r.length)try{return JSON.parse(r)}catch(w){if(m)throw w.name==="SyntaxError"?Ul.from(w,Ul.ERR_BAD_RESPONSE,this,null,this.response):w}return r}],timeout:0,xsrfCookieName:"XSRF-TOKEN",xsrfHeaderName:"X-XSRF-TOKEN",maxContentLength:-1,maxBodyLength:-1,env:{FormData:Rm()},validateStatus:function(r){return r>=200&&r<300},headers:{common:{Accept:"application/json, text/plain, */*"}}};lt.forEach(["delete","get","head"],function(r){En.headers[r]={}});lt.forEach(["post","put","patch"],function(r){En.headers[r]=lt.merge(Bm)});var bo=En,Xm=dt,Ym=bo,Wm=function(r,u,h){var g=this||Ym;return Xm.forEach(h,function(w){r=w.call(g,r,u)}),r},Zn,ql;function Ph(){return ql||(ql=1,Zn=function(r){return!!(r&&r.__CANCEL__)}),Zn}var Zl=dt,Kn=Wm,Vm=Ph(),jm=bo,Gm=Dn();function Jn(s){if(s.cancelToken&&s.cancelToken.throwIfRequested(),s.signal&&s.signal.aborted)throw new Gm}var Um=function(r){Jn(r),r.headers=r.headers||{},r.data=Kn.call(r,r.data,r.headers,r.transformRequest),r.headers=Zl.merge(r.headers.common||{},r.headers[r.method]||{},r.headers),Zl.forEach(["delete","get","head","post","put","patch","common"],function(g){delete r.headers[g]});var u=r.adapter||jm.adapter;return u(r).then(function(g){return Jn(r),g.data=Kn.call(r,g.data,g.headers,r.transformResponse),g},function(g){return Vm(g)||(Jn(r),g&&g.response&&(g.response.data=Kn.call(r,g.response.data,g.response.headers,r.transformResponse))),Promise.reject(g)})},Pt=dt,Th=function(r,u){u=u||{};var h={};function g(F,z){return Pt.isPlainObject(F)&&Pt.isPlainObject(z)?Pt.merge(F,z):Pt.isPlainObject(z)?Pt.merge({},z):Pt.isArray(z)?z.slice():z}function m(F){if(Pt.isUndefined(u[F])){if(!Pt.isUndefined(r[F]))return g(void 0,r[F])}else return g(r[F],u[F])}function w(F){if(!Pt.isUndefined(u[F]))return g(void 0,u[F])}function D(F){if(Pt.isUndefined(u[F])){if(!Pt.isUndefined(r[F]))return g(void 0,r[F])}else return g(void 0,u[F])}function S(F){if(F in u)return g(r[F],u[F]);if(F in r)return g(void 0,r[F])}var _={url:w,method:w,data:w,baseURL:D,transformRequest:D,transformResponse:D,paramsSerializer:D,timeout:D,timeoutMessage:D,withCredentials:D,adapter:D,responseType:D,xsrfCookieName:D,xsrfHeaderName:D,onUploadProgress:D,onDownloadProgress:D,decompress:D,maxContentLength:D,maxBodyLength:D,beforeRedirect:D,transport:D,httpAgent:D,httpsAgent:D,cancelToken:D,socketPath:D,responseEncoding:D,validateStatus:S};return Pt.forEach(Object.keys(r).concat(Object.keys(u)),function(z){var O=_[z]||m,Y=O(z);Pt.isUndefined(Y)&&O!==S||(h[z]=Y)}),h},Qn,Kl;function Lh(){return Kl||(Kl=1,Qn={version:"0.27.2"}),Qn}var $m=Lh().version,wi=Ss,vo={};["object","boolean","number","function","string","symbol"].forEach(function(s,r){vo[s]=function(h){return typeof h===s||"a"+(r<1?"n ":" ")+s}});var Jl={};vo.transitional=function(r,u,h){function g(m,w){return"[Axios v"+$m+"] Transitional option '"+m+"'"+w+(h?". "+h:"")}return function(m,w,D){if(r===!1)throw new wi(g(w," has been removed"+(u?" in "+u:"")),wi.ERR_DEPRECATED);return u&&!Jl[w]&&(Jl[w]=!0,console.warn(g(w," has been deprecated since v"+u+" and will be removed in the near future"))),r?r(m,w,D):!0}};function qm(s,r,u){if(typeof s!="object")throw new wi("options must be an object",wi.ERR_BAD_OPTION_VALUE);for(var h=Object.keys(s),g=h.length;g-- >0;){var m=h[g],w=r[m];if(w){var D=s[m],S=D===void 0||w(D,m,s);if(S!==!0)throw new wi("option "+m+" must be "+S,wi.ERR_BAD_OPTION_VALUE);continue}if(u!==!0)throw new wi("Unknown option "+m,wi.ERR_BAD_OPTION)}}var Zm={assertOptions:qm,validators:vo},Mh=dt,Km=wh,Ql=Dm,eu=Um,Cn=Th,Jm=Sh,_h=Zm,ns=_h.validators;function ks(s){this.defaults=s,this.interceptors={request:new Ql,response:new Ql}}ks.prototype.request=function(r,u){typeof r=="string"?(u=u||{},u.url=r):u=r||{},u=Cn(this.defaults,u),u.method?u.method=u.method.toLowerCase():this.defaults.method?u.method=this.defaults.method.toLowerCase():u.method="get";var h=u.transitional;h!==void 0&&_h.assertOptions(h,{silentJSONParsing:ns.transitional(ns.boolean),forcedJSONParsing:ns.transitional(ns.boolean),clarifyTimeoutError:ns.transitional(ns.boolean)},!1);var g=[],m=!0;this.interceptors.request.forEach(function(Y){typeof Y.runWhen=="function"&&Y.runWhen(u)===!1||(m=m&&Y.synchronous,g.unshift(Y.fulfilled,Y.rejected))});var w=[];this.interceptors.response.forEach(function(Y){w.push(Y.fulfilled,Y.rejected)});var D;if(!m){var S=[eu,void 0];for(Array.prototype.unshift.apply(S,g),S=S.concat(w),D=Promise.resolve(u);S.length;)D=D.then(S.shift(),S.shift());return D}for(var _=u;g.length;){var F=g.shift(),z=g.shift();try{_=F(_)}catch(O){z(O);break}}try{D=eu(_)}catch(O){return Promise.reject(O)}for(;w.length;)D=D.then(w.shift(),w.shift());return D};ks.prototype.getUri=function(r){r=Cn(this.defaults,r);var u=Jm(r.baseURL,r.url);return Km(u,r.params,r.paramsSerializer)};Mh.forEach(["delete","get","head","options"],function(r){ks.prototype[r]=function(u,h){return this.request(Cn(h||{},{method:r,url:u,data:(h||{}).data}))}});Mh.forEach(["post","put","patch"],function(r){function u(h){return function(m,w,D){return this.request(Cn(D||{},{method:r,headers:h?{"Content-Type":"multipart/form-data"}:{},url:m,data:w}))}}ks.prototype[r]=u(),ks.prototype[r+"Form"]=u(!0)});var Qm=ks,er,tu;function eb(){if(tu)return er;tu=1;var s=Dn();function r(u){if(typeof u!="function")throw new TypeError("executor must be a function.");var h;this.promise=new Promise(function(w){h=w});var g=this;this.promise.then(function(m){if(!!g._listeners){var w,D=g._listeners.length;for(w=0;w<D;w++)g._listeners[w](m);g._listeners=null}}),this.promise.then=function(m){var w,D=new Promise(function(S){g.subscribe(S),w=S}).then(m);return D.cancel=function(){g.unsubscribe(w)},D},u(function(w){g.reason||(g.reason=new s(w),h(g.reason))})}return r.prototype.throwIfRequested=function(){if(this.reason)throw this.reason},r.prototype.subscribe=function(h){if(this.reason){h(this.reason);return}this._listeners?this._listeners.push(h):this._listeners=[h]},r.prototype.unsubscribe=function(h){if(!!this._listeners){var g=this._listeners.indexOf(h);g!==-1&&this._listeners.splice(g,1)}},r.source=function(){var h,g=new r(function(w){h=w});return{token:g,cancel:h}},er=r,er}var tr,iu;function tb(){return iu||(iu=1,tr=function(r){return function(h){return r.apply(null,h)}}),tr}var ir,su;function ib(){if(su)return ir;su=1;var s=dt;return ir=function(u){return s.isObject(u)&&u.isAxiosError===!0},ir}var au=dt,sb=bh,za=Qm,ab=Th,nb=bo;function Ih(s){var r=new za(s),u=sb(za.prototype.request,r);return au.extend(u,za.prototype,r),au.extend(u,r),u.create=function(g){return Ih(ab(s,g))},u}var St=Ih(nb);St.Axios=za;St.CanceledError=Dn();St.CancelToken=eb();St.isCancel=Ph();St.VERSION=Lh().version;St.toFormData=kh;St.AxiosError=Ss;St.Cancel=St.CanceledError;St.all=function(r){return Promise.all(r)};St.spread=tb();St.isAxiosError=ib();ho.exports=St;ho.exports.default=St;(function(s){s.exports=ho.exports})(mh);const Ii=ah(mh.exports),Fh="/api/test",Rh={saveTest:rb,getUserTests:ob};async function rb(s,r){return Ii.post(`${Fh}/save`,{test:s,uid:r}).then(({data:u})=>u)}async function ob(s){return Ii.get(`${Fh}/${s}`).then(({data:r})=>r)}async function nu(s,r){if(r===null)return null;const u=s.getBoundingClientRect(),h=r.getBoundingClientRect();return li({top:s.offsetTop-Math.round(s.clientHeight/5),bottom:u.bottom-h.bottom,right:u.right-h.right,left:u.left-h.left,leftEnd:u.left-h.left+u.width})}const Is=ga({id:"caret",state:()=>({caretPos:null,isLatterEnd:!1,currLineIdx:1,relativeTop:0,caretCurrWordIdx:0}),getters:{getCaretPos:({caretPos:s})=>s,getIslatterEnd:({isLatterEnd:s})=>s,getRelativeTop:({relativeTop:s})=>s,getCurrLineIdx:({currLineIdx:s})=>s},actions:{async updatedCaretPos(s,r){const u=wo();if(this.caretPos===null){this.caretPos=await nu(s,r);return}const{top:h,left:g,leftEnd:m,bottom:w}=await nu(s,r);h===this.caretPos.top?(this.caretPos.left=g,this.caretPos.leftEnd=m):(this.currLineIdx++,this.currLineIdx>=3&&(u.cutWordsToRender(),this.caretCurrWordIdx=0),this.caretPos.top=h,this.caretPos.left=g,this.caretPos.leftEnd=m,this.caretPos.bottom=w,this.relativeTop+=h)},setLatterEnd(s){this.isLatterEnd=s},resetCaret(){this.relativeTop=0,this.caretPos=null}}});Ii.defaults.withCredentials=!0;const pa="/api/user",La={logout:lb,login:ub,signup:cb,loginWithGoogle:hb,getLoggedInUser:db};async function lb(){return Ii.post(`${pa}/logout`).then(({data:s})=>s)}async function ub(s){return Ii.post(`${pa}/signin`,s,{withCredentials:!0}).then(({data:r})=>r)}async function cb(s){return Ii.post(`${pa}/signup`,s,{withCredentials:!0}).then(({data:r})=>r)}async function hb(){return Ii.get(`${pa}/google/login`,{withCredentials:!0}).then(({data:s})=>s)}async function db(){try{const{data:s}=await Ii.get(`${pa}/current_user`,{withCredentials:!0});return s||null}catch(s){console.log("cant get current user",s)}}const yo=ga("user",()=>{const s=kt(null),r=kt(null),u=Xe(()=>s.value),h=Xe(()=>r.value);async function g(){!s.value||(r.value=await Rh.getUserTests(s.value.id))}async function m(){s.value=await La.getLoggedInUser(),g()}async function w(){window.open("/api/user/google/login")}async function D(F){s.value=await La.login(F)}async function S(F){await La.signup(F),document.location.reload()}async function _(){await La.logout()}return{user:s,userTests:r,getLoggedInUser:u,login:D,setLoggedInUser:m,loginWithGoogle:w,logout:_,signup:S,getUserTests:h}}),wo=ga({id:"test",state:()=>({test:Ct.generateNewTest(Ct.localSettings().lang),isActive:!1,AFKtimeout:null,testTimeInterval:null,isNewTest:!1,wordsToCut:0}),getters:{getTest:({test:s})=>s,getIsNewTest:({isNewTest:s})=>s,getWordFromTxt:({test:s})=>s==null?void 0:s.txt[s.currWord.idx],getLatterFromTxt:({test:s})=>s==null?void 0:s.txt[s.currWord.idx].latters[s.currLatter.idx],getIsActiveTest:({isActive:s})=>s},actions:{cutWordsToRender(){this.wordsToCut=this.test.currWord.idx},loadTest(){const r=Bs().getTestSettings;this.test=Ct.generateNewTest(r.lang)},setNewTest(){this.isNewTest=!0},activateTest(){this.isActive=!0,this.handleTime(!0)},newTest(){const r=Bs().getTestSettings;this.test=Ct.generateNewTest(r.lang),this.test.time=0,this.isNewTest=!1,this.handleTime(!1),this.$router.push("/test")},reloadTest(){this.test.time=0,this.handleTime(!1),this.test=Ct.retest(this.test)},setAFK(){this.isActive=!1,this.handleTime(!1)},handleTime(s){s?(this.isActive=!0,this.testTimeInterval=setInterval(()=>this.test.time+=.25,250)):(clearInterval(this.testTimeInterval),this.testTimeInterval=null)},finishTest(){const s=yo();this.handleTime(!1),this.test.txt=Ct.calcWordWpm(this.test),this.test.realAcc=Math.round(100-this.test.typoCount*100/this.test.sumType),this.test.acc=Math.round(100-Ct.countAllTypos(this.test)*100/this.test.sumType);const[r,u]=Ct.calcTestWpm(this.test);this.test.wpm=r,this.test.wpmRaw=u,Ct.saveTestToLocalStorage(this.test),this.$router.push("/testResult"),s.getLoggedInUser&&this.test.acc>90&&this.test.passed&&Rh.saveTest(this.test,s.getLoggedInUser.id)},handleType(s){var w;if(this.test===null)return;const r=Bs(),u=Is(),{currLatter:h,currWord:g}=this.test;this.test.txt[g.idx].latters[h.idx];const m=r.getTestSettings.difficulty;if(this.isActive||this.handleTime(!0),r.getTestMode==="words"&&hs.checkTestEnd(this.test,u.getIslatterEnd,r.getTestLevel)){this.handleTime(!1),this.finishTest();return}if(this.test.sumType++,this.AFKtimeout!==null&&clearTimeout(this.AFKtimeout),this.AFKtimeout=setTimeout(()=>{this.setAFK()},3e3),s===((w=this.test)==null?void 0:w.currLatter.str))h.str===" "?this.setNextWord(!0):this.setLatterNewStatus(!0);else{if(m==="expert"){this.test.passed=!1,this.finishTest();return}this.test.typoCount++,h.str===" "?this.setNextWord(!1):this.setLatterNewStatus(!1)}},finishWord(){const r=Bs().testSettings,{currWord:u}=this.test;if(this.test.txt[u.idx].time=this.test.time,this.test.txt[u.idx].typeCount=this.test.sumType,this.test.txt[u.idx].latters.every(h=>h.isCorrect))this.test.txt[u.idx].isCorrect=!0;else if(this.test.txt[u.idx].isCorrect=!1,r.difficulty==="hard"){this.test.passed=!1,this.finishTest();return}},setNextWord(s){this.finishWord();const{currLatter:r,currWord:u}=this.test;Is().setLatterEnd(!1),u.idx++,u.str=this.test.txt[u.idx].word,r.idx=0,r.str=u.str[0]},setPrevWord(){const{currLatter:s,currWord:r}=this.test;Is().setLatterEnd(!0),r.idx--;const h=this.test.txt[r.idx];s.idx=h.latters.length-1,r.str=h.word,s.str=r.str[r.str.length-1]},setLatterNewStatus(s){const{currLatter:r,currWord:u}=this.test,h=Is();this.test.txt[u.idx].latters[r.idx].isCorrect=!!s,r.idx===u.str.length-1?(r.str=" ",h.setLatterEnd(!0)):(r.idx++,r.str=u.str[r.idx])},hendleSpicialKeys(s){switch(s){case"Backspace":this.hendleBackspace();break;case"Escape":this.setAFK()}},hendleBackspace(){const{currWord:s,currLatter:r}=this.test,u=Is();r.idx===0&&s.idx===0||s.idx>1&&this.test.txt.slice(0,s.idx).every(g=>g.isCorrect)&&r.idx===0||(r.idx===0?this.setPrevWord():r.idx===s.str.length-1&&u.$state.isLatterEnd?(u.setLatterEnd(!1),r.str=s.str[s.str.length-1],this.test.txt[s.idx].latters[r.idx].isCorrect=null):(r.idx--,this.test.txt[s.idx].latters[r.idx].isCorrect=null,r.str=s.str[r.idx]))}}}),Bs=ga("testPtions",()=>{const s=wo(),r=Lx(),u=kt(Ct.localTestMode().mode),h=kt(Ct.localTestMode().level),g=li(Ct.localSettings()),m=Xe(()=>g),w=Xe(()=>g.lang==="hebrew"),D=Xe(()=>u.value),S=Xe(()=>h.value),_=Xe(()=>h.value===15&&u.value==="words");function F(Y){u.value=Y,Ct.saveLocalTestMode({mode:u.value,level:h.value}),s.setNewTest(),r.push("/test")}function z(Y){h.value=Y,Ct.saveLocalTestMode({mode:u.value,level:h.value}),s.setNewTest(),r.push("/test")}function O(Y){g.lang=Y.lang,g.difficulty=Y.difficulty,g.smoothCaret=Y.smoothCaret,localStorage.setItem("testSettings",JSON.stringify(Y))}return{getTestLevel:S,setNewSettings:O,getRtl:w,getTestSettings:m,testSettings:g,getTestMode:D,setTestMode:F,setTestLevel:z,getIsOnMinWords:_}}),Do=ga("theme",()=>{const s=kt(u()),r=Xe(()=>s.value);function u(){var m;const g=localStorage.getItem("AppTheme");return g?((m=document.querySelector("body"))==null||m.classList.add(g),g):(localStorage.setItem("AppTheme","light"),"light")}function h(g){s.value=g,localStorage.setItem("AppTheme",g)}return{appTheme:s,getAppTheme:r,setTheme:h,localTheme:u}}),fb="modulepreload",gb=function(s){return"/"+s},ru={},Fs=function(r,u,h){return!u||u.length===0?r():Promise.all(u.map(g=>{if(g=gb(g),g in ru)return;ru[g]=!0;const m=g.endsWith(".css"),w=m?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${g}"]${w}`))return;const D=document.createElement("link");if(D.rel=m?"stylesheet":fb,m||(D.as="script",D.crossOrigin=""),D.href=g,document.head.appendChild(D),m)return new Promise((S,_)=>{D.addEventListener("load",S),D.addEventListener("error",()=>_(new Error(`Unable to preload CSS for ${g}`)))})})).then(()=>r())},Eo=Px({history:Wp("/"),routes:[{path:"/",name:"Home",component:()=>Fs(()=>import("./Home.28c252e7.js"),["assets/Home.28c252e7.js","assets/Home.23bab709.css"])},{path:"/test",name:"Test",component:()=>Fs(()=>import("./Test.346591da.js"),["assets/Test.346591da.js","assets/Test.5eeb4c66.css"])},{path:"/testResult",name:"test result",component:()=>Fs(()=>import("./TestResult.f6cfb258.js"),["assets/TestResult.f6cfb258.js","assets/TestResult.d1b06334.css"])},{path:"/profile",name:"profile",component:()=>Fs(()=>import("./Profile.eb74c809.js"),["assets/Profile.eb74c809.js","assets/Profile.197972a8.css"])},{path:"/settings",name:"settings",component:()=>Fs(()=>import("./Settings.3472f9bf.js"),["assets/Settings.3472f9bf.js","assets/Settings.7396486f.css"])}]}),pb={class:"header-contianer flex"},xb={class:"logo-and-nav flex"},mb={class:"nav flex"},bb={key:0,class:"username"},vb={key:0,class:"test-options flex"},yb={class:"time-or-number-option test-option flex"},wb={class:"numbers-options test-option flex"},Db=["onClick"],Eb=gn("Logout "),Cb=ui({__name:"Header",setup(s){const r=Bs(),u=yo(),h=Do(),g=wo(),m=Xe(()=>h.getAppTheme),w=Xe(()=>u.getLoggedInUser),D=xh(),S=Xe(()=>r.getTestMode),_=Xe(()=>r.getTestLevel);function F(ee){typeof ee=="string"?r.setTestMode(ee):r.setTestLevel(ee)}function z(){u.logout(),document.location.reload()}const O=Xe(()=>!!(D.name==="profile"&&u.getLoggedInUser));function Y(ee){ee==="/test"&&g.setNewTest(),Eo.push(ee)}const q=Xe(()=>({hidden:D.name==="Home"})),K=Xe(()=>{var V,P;return((V=w.value)==null?void 0:V.username[0].toUpperCase())+((P=w.value)==null?void 0:P.username.split(" ").slice(0,1).join().slice(1))});return(ee,V)=>(Ke(),at("header",{class:qt([Ue(q),"app-header"])},[Be("div",pb,[Be("nav",xb,[Ue(m)==="light"?(Ke(),Ti(Ue($g),{key:0,onClick:V[0]||(V[0]=P=>Y("/")),class:"logo"})):(Ke(),Ti(Ue(Qg),{key:1,onClick:V[1]||(V[1]=P=>Y("/")),class:"logo"})),Be("div",mb,[Re(Ue(Ap),{onClick:V[2]||(V[2]=P=>Y("/test")),class:"nav-svg keyboard"}),Re(Ue(up),{onClick:V[3]||(V[3]=P=>Y("/leaderboard")),class:"nav-svg"}),Re(Ue(vp),{onClick:V[4]||(V[4]=P=>Y("/settings")),class:"nav-svg"}),Be("div",{onClick:V[5]||(V[5]=P=>Y("/profile")),class:"user-nav-link flex align-center"},[Re(Ue(gp),{class:"nav-svg"}),Ue(w)?(Ke(),at("span",bb,sr(Ue(K)),1)):xc("",!0)])])]),Ue(O)?(Ke(),at("button",{key:1,onClick:z,class:"logout-btn flex"},[Eb,Re(Ue(ep),{class:"logout-svg"})])):(Ke(),at("div",vb,[Be("div",yb,[Be("h2",{class:qt(["txt-light",{"active-option":Ue(S)==="time"}]),onClick:V[6]||(V[6]=P=>F("time"))},"time",2),Be("h2",{class:qt(["txt-light",{"active-option":Ue(S)==="words"}]),onClick:V[7]||(V[7]=P=>F("words"))},"words",2)]),Be("div",wb,[(Ke(),at(st,null,Qu(4,P=>Be("h2",{key:P,onClick:j=>F(P*15),class:qt(["txt-light",{"active-option":Ue(_)===P*15}])},sr(P*15),11,Db)),64))])]))])],2))}});function Ab(s,r){return Ke(),at("svg",{xmlns:"http://www.w3.org/2000/svg",fill:"none",viewBox:"0 0 24 24","stroke-width":"1.5",stroke:"currentColor","aria-hidden":"true"},[Be("path",{"stroke-linecap":"round","stroke-linejoin":"round",d:"M21.752 15.002A9.718 9.718 0 0118 15.75c-5.385 0-9.75-4.365-9.75-9.75 0-1.33.266-2.597.748-3.752A9.753 9.753 0 003 11.25C3 16.635 7.365 21 12.75 21a9.753 9.753 0 009.002-5.998z"})])}function kb(s,r){return Ke(),at("svg",{xmlns:"http://www.w3.org/2000/svg",fill:"none",viewBox:"0 0 24 24","stroke-width":"1.5",stroke:"currentColor","aria-hidden":"true"},[Be("path",{"stroke-linecap":"round","stroke-linejoin":"round",d:"M12 3v2.25m6.364.386l-1.591 1.591M21 12h-2.25m-.386 6.364l-1.591-1.591M12 18.75V21m-4.773-4.227l-1.591 1.591M5.25 12H3m4.227-4.773L5.636 5.636M15.75 12a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0z"})])}const Sb=["checked"],Pb={for:"switch"},Tb=ui({__name:"CustomToggleSwitch",setup(s){const r=Do(),u=Xe(()=>r.getAppTheme);kt(document.querySelector("body"));function h(){const g=u.value==="dark"?"light":"dark";r.setTheme(g)}return zu(()=>{var g,m,w,D;console.log(u.value),u.value=="dark"?((g=document.querySelector("body"))==null||g.classList.remove("dark"),(m=document.querySelector("body"))==null||m.classList.add("light")):((w=document.querySelector("body"))==null||w.classList.remove("light"),(D=document.querySelector("body"))==null||D.classList.add("dark"))}),(g,m)=>(Ke(),at(st,null,[Be("input",{onChange:h,type:"checkbox",id:"switch",checked:Ue(u)==="dark"},null,40,Sb),Be("label",Pb,[Ue(u)!=="dark"?(Ke(),Ti(Ue(Ab),{key:0,class:"moon-svg"})):(Ke(),Ti(Ue(kb),{key:1,class:"sun-svg"}))])],64))}});const Lb=(s,r)=>{const u=s.__vccOpts||s;for(const[h,g]of r)u[h]=g;return u},Mb=Lb(Tb,[["__scopeId","data-v-6e1df817"]]),_b=Be("div",{class:"set-goal"},null,-1),Ib={class:"main-footer flex"},Fb={class:"footer-links flex"},Rb=Be("h2",{class:"txt-light"},"Linkedin",-1),Ob=[Rb],zb=Be("h2",{class:"txt-light"},"code",-1),Bb=ui({__name:"Footer",setup(s){const r=xh(),u=Xe(()=>({hidden:r.name==="Home"}));function h(){window.open("https://github.com/YoavDn/typester")}function g(){window.open("https://www.linkedin.com/in/yoav-mendelson/")}return(m,w)=>(Ke(),at("section",{class:qt(["botton",Ue(u)])},[_b,Be("footer",Ib,[Be("div",Fb,[Be("div",{onClick:g,class:"footer-link flex"},Ob),Be("div",{onClick:h,class:"footer-link flex align-center"},[Re(Ue(tp),{class:"code-svg"}),zb])]),Re(Mb)])],2))}});const Nb={class:"main-app"},Hb=ui({__name:"App",setup(s){const r=yo(),u=Do();return r.setLoggedInUser(),u.localTheme(),(h,g)=>{const m=Zu("RouterView");return Ke(),at("main",Nb,[Re(Cb),Re(m,null,{default:ta(({Component:w})=>[Re(bn,{name:"fade",mode:"out-in"},{default:ta(()=>[(Ke(),Ti(Ju(w)))]),_:2},1024)]),_:1}),Re(Bb)])}}});const Oh=Og(),An=jc(Hb);console.log("production");Oh.use(({store:s})=>{s.$router=Lt(Eo)});An.use(Oh);An.use(Eo);An.use(Wg);An.mount("#app");export{Ti as A,ta as B,Af as C,Ua as D,nf as E,st as F,rf as G,Wg as V,Lb as _,at as a,Be as b,Xe as c,ui as d,Ue as e,Lx as f,Re as g,Bs as h,wo as i,Is as j,na as k,kt as l,fa as m,qt as n,Ke as o,da as p,xc as q,Qu as r,ag as s,sr as t,Do as u,li as v,zu as w,Zu as x,gn as y,yo as z};
